...
var oV = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	addVoicings: VC,
	complex: Zs,
...
//#endregion
//#region node_modules/drawing-drum-machine/src/feedProcessor.ts
var worker = new Worker(new URL("../../drawing-drum-machine/src/workers/imageProcessing.js", import.meta.url), { type: "module" });
/**
* The video feed processor Class
* @constructor
* @param HTMLVideoElement The video HTML Element to process
*/
var FeedProcessor = class FeedProcessor {
	...
	async capture() {
		return new Promise((resolve, reject) => {
			...
			if (this.ctx) {
				...
				resolve(data);
			} else reject("Canvas ctx is null");
		});
	}
	/**
	...
	*/
	videoToFrameScale() {
		...
		return {
			scaledWidth: this.frame.width * ratioX,
			scaledHeight: this.frame.height * ratioY
		};
	}
	/**
	...
	*/
	async process(data, channels) {
		return new Promise((resolve, reject) => {
			...
			} else reject("Web workers are not compatible with this navigator");
		});
	}
	/**
	...
	*/
	seq(channels) {
		return this.capture().then((data) => this.process(data, channels));
	}
	get pixel() {
		return new Promise((resolve, reject) => {
			const handler = (e) => {
				if (e.target == this.video) if (this.ctx) {
					const rect = this.video.getBoundingClientRect();
					const x = e.clientX - rect.left;
					const y = e.clientY - rect.top;
					this.draw();
					resolve(this.ctx.getImageData(x, y, 1, 1).data);
				} else reject("Frame context is null");
				else resolve(-1);
...
//#endregion
//#region node_modules/drawing-drum-machine/src/utils.ts
function UUID() {
	return crypto.randomUUID();
}
//#endregion
//#region node_modules/drawing-drum-machine/src/channels.ts
var Channels = class Channels extends HTMLElement {
	static instance = void 0;
	elements;
	editors = [];
	editorsNode;
	...
	*/
	connectedCallback() {
		if (Channels.instance === void 0) Channels.instance = this;
		else {
			this.remove();
...
//#endregion
//#region node_modules/drawing-drum-machine/src/ddm.ts
/**
* Base class for drawing drum machine
*/
var DDM = class extends HTMLElement {
	cpm = 120;
	audioContext;
	constructor() {
		super();
	...
	connectedCallback() {
		...
		*/
		lV({ prebake: () => {
			if (samplesAttribute) samplesAttribute.replace(" ", "").split(";").forEach((s) => O2(s));
	...
	*/
	getSamples() {
		return this.getAttribute("samples");
	}
	/**
	* 
	...
	*/
	...
	codesToStruct(seq, codes) {
		return codes.map((el, index) => {
			if (el === "") return `n("${seq[index]}").hush()`;
			else return `n("${seq[index]}").${el}`;
		});
	}
	start(strudel, step) {
	...
	calcCurrentStep(scheduler) {
		...
		return Math.floor(absoluteCycle % 1 * 16);
	}
	set tempo(value) {
		this.cpm = value;
	}
...
//#endregion
//#region node_modules/drawing-drum-machine/src/index.ts
var src_default = DDM;
//#endregion
export { src_default as default };

//# sourceMappingURL=drawing-drum-machine.js.map