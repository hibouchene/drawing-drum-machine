//#region node_modules/@strudel/web/dist/index.mjs
var fu = "strudel.log";
var m9 = 1e3, cc, lc;
...
function gt(e, t, n = {}) {
	...
	cc === e && s - lc < m9 || (cc = e, lc = s, console.log(`%c${e}`, "background-color: black;color:white;border-radius:15px"), typeof document < "u" && typeof CustomEvent < "u" && document.dispatchEvent(new CustomEvent("strudel.log", { detail: {
		message: e,
		type: t,
		data: n
	} })));
...
var le = BigInt(0), Fe = BigInt(1), bi = BigInt(2), Ra = BigInt(5), Lt = BigInt(10), f9 = 2e3, Q = {
	s: Fe,
	n: le,
	d: Fe
};
...
var ft = function(e, t) {
	...
	if (e != null) if (t !== void 0) {
		...
		if ("d" in e && "n" in e) n = BigInt(e.n), s = BigInt(e.d), "s" in e && (n *= BigInt(e.s));
		else if (0 in e) n = BigInt(e[0]), 1 in e && (s = BigInt(e[1]));
		else if (typeof e == "bigint") n = e;
		else throw Yn();
		i = n * s;
	} else if (typeof e == "number") {
		if (isNaN(e)) throw Yn();
		if (e < 0 && (i = -Fe, e = -e), e % 1 === 0) n = BigInt(e);
		else if (e > 0) {
			...
			for (e >= 1 && (r = 10 ** Math.floor(1 + Math.log10(e)), e /= r); u <= l && c <= l;) {
				...
				if (e === p) {
					...
					break;
				} else e > p ? (a += o, u += c) : (o += a, c += u), u > l ? (n = o, s = c) : (n = a, s = u);
			}
		...
		if (p === null) throw Yn();
		if (p[r] === "-" ? (i = -Fe, r++) : p[r] === "+" && r++, p.length === r + 1 ? u = wn(p[r++], i) : p[r + 1] === "." || p[r] === "." ? (p[r] !== "." && (a = wn(p[r++], i)), r++, (r + 1 === p.length || p[r + 1] === "(" && p[r + 3] === ")" || p[r + 1] === "'" && p[r + 3] === "'") && (u = wn(p[r], i), c = Lt ** BigInt(p[r].length), r++), (p[r] === "(" && p[r + 2] === ")" || p[r] === "'" && p[r + 2] === "'") && (o = wn(p[r + 1], i), l = Lt ** BigInt(p[r + 1].length) - Fe, r += 3)) : p[r + 1] === "/" || p[r + 1] === ":" ? (u = wn(p[r], i), c = wn(p[r + 2], Fe), r += 3) : p[r + 3] === "/" && p[r + 1] === " " && (a = wn(p[r], i), u = wn(p[r + 2], i), c = wn(p[r + 4], Fe), r += 5), p.length <= r) s = c * l, i = n = o + s * a + l * u;
		else throw Yn();
	} else if (typeof e == "bigint") n = e, i = e, s = Fe;
	else throw Yn();
	if (s === le) throw yu();
...
function y9(e, t, n) {
	let s = Fe;
	for (; t > le; e = e * e % n, t >>= Fe) t & Fe && (s = s * e % n);
	return s;
}
function g9(e, t) {
	for (; t % bi === le; t /= bi);
	...
	if (t === Fe) return le;
	let n = Lt % t, s = 1;
	for (; n !== Fe; s++) if (n = n * Lt % t, s > f9) return le;
	return BigInt(s);
}
function b9(e, t, n) {
	let s = Fe, i = y9(Lt, n, t);
	for (let r = 0; r < 300; r++) {
		if (s === i) return BigInt(r);
		s = s * Lt % t, i = i * Lt % t;
	}
	return 0;
}
...
function Qe(e, t) {
	if (ft(e, t), this instanceof Qe) e = ss(Q.d, Q.n), this.s = Q.s, this.n = Q.n / e, this.d = Q.d / e;
	else return st(Q.s * Q.n, Q.d);
}
var yu = function() {
...
Qe.prototype = {
	...
	**/
	add: function(e, t) {
		return ft(e, t), st(this.s * this.n * Q.d + Q.s * this.d * Q.n, this.d * Q.d);
	},
	/**
	...
	**/
	mul: function(e, t) {
		return ft(e, t), st(this.s * Q.s * this.n * Q.n, this.d * Q.d);
	},
	/**
	...
	**/
	div: function(e, t) {
		return ft(e, t), st(this.s * Q.s * this.n * Q.d, this.d * Q.n);
	},
	/**
	...
	**/
	mod: function(e, t) {
		if (e === void 0) return st(this.s * this.n % this.d, Fe);
		if (ft(e, t), le === Q.n * this.d) throw yu();
		return st(this.s * (Q.d * this.n) % (Q.n * this.d), Q.d * this.d);
	},
	/**
	...
	*/
	pow: function(e, t) {
		if (ft(e, t), Q.d === Fe) return Q.s < le ? st((this.s * this.d) ** Q.n, this.n ** Q.n) : st((this.s * this.n) ** Q.n, this.d ** Q.n);
		...
		for (let a in n) if (a !== "1") {
			...
			if (n[a] *= Q.n, n[a] % Q.d === le) n[a] /= Q.d;
			else return null;
			i *= BigInt(a) ** n[a];
		}
		for (let a in s) if (a !== "1") {
			if (s[a] *= Q.n, s[a] % Q.d === le) s[a] /= Q.d;
			else return null;
			r *= BigInt(a) ** s[a];
		}
	...
	*/
	log: function(e, t) {
		...
		for (const c in i) s[c] = (s[c] || le) - i[c];
		for (const c in a) r[c] = (r[c] || le) - a[c];
		for (const c in s) c !== "1" && (n[c] = !0);
		for (const c in r) c !== "1" && (n[c] = !0);
		let u = null, o = null;
		for (const c in n) {
			...
			let m = p, g = l;
			const y = ss(m, g);
			if (m /= y, g /= y, u === null && o === null) u = m, o = g;
			else if (m * o !== u * g) return null;
		}
	...
	**/
	ceil: function(e) {
		return e = Lt ** BigInt(e || 0), st(en(this.s * e * this.n / this.d) + (e * this.n % this.d > le && this.s >= le ? Fe : le), e);
	},
	/**
	...
	**/
	round: function(e) {
		return e = Lt ** BigInt(e || 0), st(en(this.s * e * this.n / this.d) + this.s * ((this.s >= le ? Fe : le) + bi * (e * this.n % this.d) > this.d ? Fe : le), e);
	},
	/**
	...
	**/
	toString: function(e) {
		...
		if (r += en(t / n), t %= n, t *= Lt, t && (r += "."), s) {
			for (let a = i; a--;) r += en(t / n), t %= n, t *= Lt;
			r += "(";
			for (let a = s; a--;) r += en(t / n), t %= n, t *= Lt;
			r += ")";
		} else for (let a = e; t && a--;) r += en(t / n), t %= n, t *= Lt;
		return r;
	},
	/**
	...
	*/
	...
	simplify: function(e) {
		const t = BigInt(1 / (e || .001) | 0), n = this.abs(), s = n.toContinued();
		for (let i = 1; i < s.length; i++) {
			let r = st(s[i - 1], Fe);
			for (let u = i - 2; u >= 0; u--) r = r.inverse().add(s[u]);
			let a = r.sub(n);
			if (a.n * t < a.d) return r.mul(this.s);
		}
		return this;
	}
};
var M9 = (e) => /^[a-gA-G][#bsf]*[0-9]*$/.test(e), fs = (e) => /^[a-gA-G][#bsf]*-?[0-9]*$/.test(e), kl = (e) => {
	...
	s: 1,
	f: -1
}, gu = (e) => e?.split("").reduce((t, n) => t + x9[n], 0) || 0, yn = (e, t = 3) => {
	const [n, s, i = t] = kl(e);
	if (!n) throw new Error("not a note: \"" + e + "\"");
	const r = C9[n.toLowerCase()], a = gu(s);
	return (Number(i) + 1) * 12 + r + a;
}, ds = (e) => Math.pow(2, (e - 69) / 12) * 440, bu = (e) => 12 * Math.log(e / 440) / Math.LN2 + 69, G9 = (e, t) => {
	if (typeof e != "object") throw new Error("valueToMidi: expected object value");
	let { freq: n, note: s } = e;
	if (typeof n == "number") return bu(n);
	if (typeof s == "string") return yn(s);
	if (typeof s == "number") return s;
	if (!t) throw new Error("valueToMidi: expected freq or note to be set");
	return t;
}, v9 = (e, t) => (e - t) * 1e3, zl = (e) => ds(typeof e == "number" ? e : yn(e)), P9 = [
	"C",
	"Db",
	"D",
	"Eb",
	...
	return P9[e % 12] + t;
}, Ut = (e, t) => (e % t + t) % t, Nl = (e) => e.reduce((t, n) => t + n) / e.length;
function Wl(e, t = 0) {
	return isNaN(Number(e)) ? (gt(`"${e}" is not a number, falling back to ${t}`, "warning"), t) : e;
}
var F9 = (e, t) => Ut(Math.round(Wl(e ?? 0, 0)), t), X9 = (e) => {
	let { value: t, context: n } = e, s = t;
	if (typeof s == "object" && !Array.isArray(s) && (s = s.note || s.n || s.value, s === void 0)) throw new Error(`cannot find a playable note for ${JSON.stringify(t)}`);
	if (typeof s == "number" && n.type !== "frequency") s = ds(e.value);
	else if (typeof s == "number" && n.type === "frequency") s = e.value;
	else if (typeof s != "string" || !fs(s)) throw new Error("not a note: " + JSON.stringify(s));
	return s;
}, Tl = (e) => {
	let { value: t, context: n } = e;
	if (typeof t == "object") return t.freq ? t.freq : zl(t.note || t.n || t.value);
	if (typeof t == "number" && n.type !== "frequency") t = ds(e.value);
	else if (typeof t == "string" && fs(t)) t = ds(yn(e.value));
	else if (typeof t != "number") throw new Error("not a note or frequency: " + t);
	return t;
}, Il = (e, t) => e.slice(t).concat(e.slice(0, t)), _l = (...e) => e.reduce((t, n) => (...s) => t(n(...s)), (t) => t), D9 = (...e) => _l(...e.reverse()), ys = (e) => e.filter((t) => t != null), En = (e) => [].concat(...e), Ds = (e) => e, S9 = (e, t) => e, wi = (e, t) => Array.from({ length: t - e + 1 }, (n, s) => s + e);
function Xe(e, t, n = e.length) {
	const s = function i(...r) {
		if (r.length >= n) return e.apply(this, r);
		{
			const a = function(...u) {
...
var w9 = (e) => Cu(e, Yl), xu = function(e, t) {
	return [t.slice(0, e), t.slice(e)];
}, gr = (e, t, n) => t.map((s, i) => e(s, n[i])), Hl = function(e) {
	const t = [];
	for (let n = 0; n < e.length - 1; ++n) t.push([e[n], e[n + 1]]);
	return t;
}, br = (e, t, n) => Math.min(Math.max(e, t), n), Z9 = [
	"Do",
	"Reb",
	"Re",
	"Mib",
	...
	return (t === "solfeggio" ? Z9 : t === "indian" ? E9 : t === "german" ? L9 : t === "byzantine" ? R9 : t === "japanese" ? B9 : V9)[e % 12] + (Math.floor(e / 12) - 1);
};
function z9(e) {
	var t = {};
...
function Ul(e) {
	const t = new Uint8Array(atob(e).split("").map((s) => s.charCodeAt(0)));
...
var Jl = class {
	constructor({ getTargetClockTime: t = _9, weight: n = 16, offsetDelta: s = .005, checkAfterTime: i = 2, resetAfterTime: r = 8 }) {
	...
	calculateOffset(t) {
		...
		if (s > this.resetAfterTime && this.reset(), this.offsetTime ??= i, this.prevOffsetTimes.push(i), this.prevOffsetTimes.length > this.weight && this.prevOffsetTimes.shift(), this.timeAtPrevOffsetSample == null || s > this.checkAfterTime) {
...
var U = (e) => Qe(e), Y9 = (...e) => {
	if (e = ys(e), e.length !== 0) return e.reduce((t, n) => t.gcd(n), U(1));
}, rn = (...e) => {
	if (e = ys(e), e.length === 0) return;
	const t = e.pop();
	return e.reduce((n, s) => n === void 0 || s === void 0 ? void 0 : n.lcm(s), t);
}, H9 = (e) => e instanceof Qe;
U._original = Qe;
var ct = class ct {
	constructor(t, n) {
	...
	get spanCycles() {
		...
		if (n.equals(s)) return [new ct(n, s)];
		for (; s.gt(n);) {
			if (n.sam().equals(i)) {
				t.push(new ct(n, this.end));
				break;
			}
			const r = n.nextSam();
			t.push(new ct(n, r)), n = r;
		}
		return t;
	}
	get duration() {
	...
	cycleArc() {
		const t = this.begin.cyclePos();
		return new ct(t, t.add(this.duration));
	}
	withTime(t) {
		return new ct(t(this.begin), t(this.end));
	}
	withEnd(t) {
		return new ct(this.begin, t(this.end));
	}
	withCycle(t) {
		const n = this.begin.sam();
		return new ct(n.add(t(this.begin.sub(n))), n.add(t(this.end.sub(n))));
	}
	intersection(t) {
		const n = this.begin.max(t.begin), s = this.end.min(t.end);
		if (!n.gt(s) && !(n.equals(s) && (n.equals(this.end) && this.begin.lt(this.end) || n.equals(t.end) && t.begin.lt(t.end)))) return new ct(n, s);
	}
	intersection_e(t) {
		const n = this.intersection(t);
		if (n == null) throw "TimeSpans do not intersect";
		return n;
	}
	midpoint() {
...
var et = class et {
	...
	withSpan(t) {
		return new et(this.whole ? t(this.whole) : void 0, t(this.part), this.value, this.context);
	}
	withValue(t) {
		return new et(this.whole, this.part, t(this.value), this.context);
	}
	hasOnset() {
	...
	resolveState(t) {
		if (this.stateful && this.hasOnset()) {
			...
			return [s, new et(this.whole, this.part, i, this.context, !1)];
		}
		return [t, this];
	}
	spanEquals(t) {
	...
	equals(t) {
		return this.spanEquals(t) && this.part.equals(t.part) && this.value === t.value;
	}
	show(t = !1) {
		...
		var s = "";
		if (this.whole == null) s = "~" + this.part.show;
		else {
	...
	combineContext(t) {
		...
		return {
			...n.context,
			...t.context,
			locations: (n.context.locations || []).concat(t.context.locations || [])
		};
	}
	setContext(t) {
		return new et(this.whole, this.part, this.value, t);
	}
	ensureObjectValue() {
		if (typeof this.value != "object") throw new Error(`expected hap.value to be an object, but got "${this.value}". Hint: append .note() or .s() to the end`, "error");
	}
};
var Es = class Es {
	constructor(t, n = {}) {
	...
	setSpan(t) {
		return new Es(t, this.controls);
	}
	withSpan(t) {
		return this.setSpan(t(this.span));
	}
	setControls(t) {
		return new Es(this.span, {
			...this.controls,
			...t
		});
	}
...
function K9(e, t, n) {
	if (t?.value !== void 0 && Object.keys(t).length === 1) return gt("[warn]: Can't do arithmetic on control pattern."), e;
...
function $l(e, t = 60) {
	let n = 0, s = U(0), i = [""], r = "";
	for (; i[0].length < t;) {
		const a = e.queryArc(n, n + 1), o = Y9(...a.filter((l) => l.hasOnset()).map((l) => l.duration)), c = o.inverse();
		i = i.map((l) => l + "|"), r += "|";
		for (let l = 0; l < c; l++) {
			...
			y > 0 && (i = i.concat(Array(y).fill(r))), i = i.map((x, v) => {
				const E = g[v];
				if (E) return x + (E.whole.begin.eq(p) ? "" + E.value : "-");
				return x + ".";
			}), r += ".", s = s.add(o);
		}
		n++;
...
function j9(e, t = {}) {
	const { wrapExpression: n = !0, wrapAsync: s = !0 } = t;
	n && (e = `{${e}}`), s && (e = `(async ()=>${e})()`);
...
var e0 = async (e, t, n) => {
	...
	return {
		mode: "javascript",
		pattern: await j9(e, { wrapExpression: !!t }),
		meta: s
	};
};
var Va, Tt = !0;
...
var _ = class yt {
	...
	appWhole(t, n) {
		const s = this, i = function(r) {
			const a = s.query(r), u = n.query(r), o = function(c, l) {
				...
				if (p != null) return new et(t(c.whole, l.whole), p, c.value(l.value), l.combineContext(c));
			};
			return En(a.map((c) => ys(u.map((l) => o(c, l)))));
		};
		return new yt(i);
	}
	/**
	...
	*/
	appBoth(t) {
		const n = this, s = function(r, a) {
			if (!(r == null || a == null)) return r.intersection_e(a);
		}, i = n.appWhole(s, t);
		...
		const n = this, s = function(r) {
			...
			for (const u of n.query(r)) {
				...
				for (const c of o) {
					...
					if (p) {
						const y = new et(l, p, u.value(c.value), c.combineContext(u));
						a.push(y);
					}
				}
			}
	...
	*/
		...
		const n = this, s = function(r) {
			...
			for (const u of t.query(r)) {
				...
				for (const c of o) {
					...
					if (p) {
						const y = new et(l, p, c.value(u.value), u.combineContext(c));
						a.push(y);
					}
				}
			}
	...
	bindWhole(t, n) {
		const s = this, i = function(r) {
			const a = function(o, c) {
				return new et(t(o.whole, c.whole), c.part, c.value, Object.assign({}, o.context, c.context, { locations: (o.context.locations || []).concat(c.context.locations || []) }));
			}, u = function(o) {
	...
	bind(t) {
		const n = function(s, i) {
			if (!(s == null || i == null)) return s.intersection_e(i);
		};
	...
	resetJoin(t = !1) {
		const n = this;
		return new yt((s) => n.discreteOnly().query(s).map((i) => i.value.late(t ? i.whole.begin : i.whole.begin.cyclePos()).query(s).map((r) => new et(r.whole ? r.whole.intersection(i.whole) : void 0, r.part.intersection(i.part), r.value).setContext(i.combineContext(r))).filter((r) => r.part)).flat());
	}
	restartJoin() {
	...
	squeezeJoin() {
		...
		function n(s) {
			...
			function r(u) {
				...
				function l(p, m) {
					let g;
					if (m.whole && p.whole && (g = m.whole.intersection(p.whole), !g)) return;
		...
		return this.discreteOnly().withHaps((n) => {
			...
			for (var i = 0; i < n.length; ++i) {
				for (var r = !0, a = n[i]; r;) {
					...
					for (var u = !1, o = i + 1; o < n.length; o++) {
						const l = n[o];
						if (a.whole.equals(l.whole)) {
							if (a.part.begin.eq(l.part.end)) {
								if (c === JSON.stringify(l.value)) {
									a = new et(a.whole, new ct(l.part.begin, a.part.end), a.value), n.splice(o, 1), u = !0;
									break;
								}
							} else if (l.part.begin.eq(a.part.end) && c == JSON.stringify(l.value)) {
								a = new et(a.whole, new ct(a.part.begin, l.part.end), a.value), n.splice(o, 1), u = !0;
								break;
							}
						}
					}
	...
	*/
	get showFirstCycle() {
		return this.firstCycle().map((t) => `${t.value}: ${t.whole.begin.toFraction()} - ${t.whole.end.toFraction()}`);
	}
	/**
	...
	*/
	sortHapsByPart() {
		return this.withHaps((t) => t.sort((n, s) => n.part.begin.sub(s.part.begin).or(n.part.end.sub(s.part.end)).or(n.whole.begin.sub(s.whole.begin).or(n.whole.end.sub(s.whole.end)))));
	}
	asNumber() {
		return this.fmap(Mu);
	}
	...
	* s("bd sd").log()
	*/
	log(t = (s) => `[hap] ${s.showWhole(!0)}`, n = (s) => ({ hap: s })) {
	...
	*/
	...
	unjoin(t, n = Ds) {
		return t.withHap((s) => s.withValue((i) => i ? n(this.ribbon(s.whole.begin, s.whole.duration)) : this));
	}
	/**
...
_.prototype.collect = function() {
	return this.withHaps((e) => O9(J9, e).map((t) => new et(t[0].whole, t[0].part, t, {})));
};
var Q9 = B("arpWith", (e, t) => t.collect().fmap((n) => j(e(n))).innerJoin().withHap((n) => new et(n.whole, n.part, n.value.value, n.combineContext(n.value)))), q9 = B("arp", (e, t) => t.arpWith((n) => j(e).fmap((s) => n[s % n.length])), !1);
function ji(e) {
...
(function() {
	...
	for (const [n, [s, i]] of Object.entries(e)) {
		...
		}, Object.defineProperty(_.prototype, n, { get: function() {
			const r = this, a = (...u) => r[n].in(...u);
			for (const u of t) a[u.toLowerCase()] = function(...o) {
				var c = r;
		...
		for (const r of t) _.prototype[r.toLowerCase()] = function(...a) {
...
var ex = tt, tx = tt, nx = Mr, Ws = (e) => new _(() => [], e), Ye = Ws(1), Wt = Ws(0);
function Ue(e) {
	function t(s) {
...
function n0(e) {
	let t = Ue([]);
	for (const n of e) t = t.bind((s) => n.fmap((i) => s.concat([i])));
	return t;
}
function tt(...e) {
...
function Au(e, t) {
	if (t = t.map((r) => Array.isArray(r) ? on(...r) : j(r)), t.length === 0) return Ye;
	if (t.length === 1) return t[0];
	const [n, ...s] = t.map((r) => r._steps);
	return tt(...e(Tt ? n.maximum(...s) : void 0, t));
}
function s0(...e) {
	return Au((t, n) => n.map((s) => s._steps.eq(t) ? s : Rt(s, Ws(t.sub(s._steps)))), e);
}
function i0(...e) {
	return Au((t, n) => n.map((s) => s._steps.eq(t) ? s : Rt(Ws(t.sub(s._steps)), s)), e);
}
function r0(...e) {
	return Au((t, n) => n.map((s) => {
		if (s._steps.eq(t)) return s;
...
function Qn(...e) {
	if (e = e.map((s) => Array.isArray(s) ? Ft(...s) : j(s)), e.length == 1) return e[0];
	const t = function(s) {
...
function rx(...e) {
	let t = U(0);
	for (let n of e) n.length == 2 && n.unshift(t), t = n[1];
	return tt(...e.map(([n, s, i]) => Ue(j(i)).compress(U(n).div(t), U(s).div(t)))).slow(t).innerJoin();
}
function Ft(...e) {
	let t = Qn(...e);
...
var ax = Xe((e, t) => j(t).mask(e)), ux = Xe((e, t) => j(t).struct(e)), ox = Xe((e, t) => j(t).superimpose(...e)), cx = Xe((e, t) => j(t).withValue(e)), lx = Xe((e, t) => j(t).bind(e)), dx = Xe((e, t) => j(t).innerBind(e)), hx = Xe((e, t) => j(t).outerBind(e)), px = Xe((e, t) => j(t).squeezeBind(e)), mx = Xe((e, t) => j(t).stepBind(e)), fx = Xe((e, t) => j(t).polyBind(e)), yx = Xe((e, t) => j(t).set(e)), gx = Xe((e, t) => j(t).keep(e)), bx = Xe((e, t) => j(t).keepif(e)), Mx = Xe((e, t) => j(t).add(e)), Cx = Xe((e, t) => j(t).sub(e)), xx = Xe((e, t) => j(t).mul(e)), Gx = Xe((e, t) => j(t).div(e)), vx = Xe((e, t) => j(t).mod(e)), Px = Xe((e, t) => j(t).pow(e)), Ax = Xe((e, t) => j(t).band(e)), Fx = Xe((e, t) => j(t).bor(e)), Xx = Xe((e, t) => j(t).bxor(e)), Dx = Xe((e, t) => j(t).blshift(e)), Sx = Xe((e, t) => j(t).brshift(e)), wx = Xe((e, t) => j(t).lt(e)), Zx = Xe((e, t) => j(t).gt(e)), Ex = Xe((e, t) => j(t).lte(e)), Lx = Xe((e, t) => j(t).gte(e)), Rx = Xe((e, t) => j(t).eq(e)), Bx = Xe((e, t) => j(t).eqt(e)), Vx = Xe((e, t) => j(t).ne(e)), kx = Xe((e, t) => j(t).net(e)), zx = Xe((e, t) => j(t).and(e)), Nx = Xe((e, t) => j(t).or(e)), Wx = Xe((e, t) => j(t).func(e));
function B(e, t, n = !0, s = !1, i = (r) => r.innerJoin()) {
	if (Array.isArray(e)) {
		const o = {};
		for (const c of e) o[c] = B(c, t, n, s, i);
		return o;
	}
	const r = t.length;
	var a;
	n ? a = function(...o) {
		...
		if (r === 2 && o.length !== 1) o = [on(...o)];
		else if (r !== o.length + 1) throw new Error(`.${e}() expects ${r - 1} inputs but got ${o.length}.`);
...
function Ts(e, t, n = !0, s = !1, i = (r) => r.stepJoin()) {
	return B(e, t, n, s, i);
}
var Tx = B("round", function(e) {
	return e.asNumber().fmap((t) => Math.round(t));
}), Ix = B("floor", function(e) {
	return e.asNumber().fmap((t) => Math.floor(t));
}), _x = B("ceil", function(e) {
	return e.asNumber().fmap((t) => Math.ceil(t));
}), Yx = B("toBipolar", function(e) {
	return e.fmap((t) => t * 2 - 1);
}), Hx = B("fromBipolar", function(e) {
	return e.fmap((t) => (t + 1) / 2);
}), Kx = B("range", function(e, t, n) {
	return n.mul(t - e).add(e);
}), jx = B("rangex", function(e, t, n) {
	return n._range(Math.log(e), Math.log(t)).fmap(Math.exp);
}), Ux = B("range2", function(e, t, n) {
	return n.fromBipolar()._range(e, t);
}), Ox = B("ratio", (e) => e.fmap((t) => Array.isArray(t) ? t.slice(1).reduce((n, s) => n / s, t[0]) : t)), Jx = B("compress", function(e, t, n) {
	return e = U(e), t = U(t), e.gt(t) || e.gt(1) || t.gt(1) || e.lt(0) || t.lt(0) ? Ye : n._fastGap(U(1).div(t.sub(e)))._late(e);
}), { compressSpan: Qx, compressspan: qx } = B(["compressSpan", "compressspan"], function(e, t) {
	return t._compress(e.begin, e.end);
}), { fastGap: $x, fastgap: eG } = B(["fastGap", "fastgap"], function(e, t) {
	const n = function(i) {
		const r = i.begin.sam(), a = i.begin.sub(r).mul(e).min(1), u = i.end.sub(r).mul(e).min(1);
		if (!(a >= 1)) return new ct(r.add(a), r.add(u));
	}, s = function(i) {
		const r = i.part.begin, a = i.part.end, u = r.sam(), o = r.sub(u).div(e).min(1), c = a.sub(u).div(e).min(1), l = new ct(u.add(o), u.add(c));
		return new et(i.whole ? new ct(l.begin.sub(r.sub(i.whole.begin).div(e)), l.end.add(i.whole.end.sub(a).div(e))) : void 0, l, i.value, i.context);
	};
	return t.withQuerySpanMaybe(n).withHap(s).splitQueries();
}), tG = B("focus", function(e, t, n) {
	return e = U(e), t = U(t), n._early(e.sam())._fast(U(1).div(t.sub(e)))._late(e);
}), { focusSpan: nG, focusspan: sG } = B(["focusSpan", "focusspan"], function(e, t) {
	return t._focus(e.begin, e.end);
}), iG = B("ply", function(e, t) {
	const n = t.fmap((s) => Ue(s)._fast(e)).squeezeJoin();
	return Tt && (n._steps = U(e).mulmaybe(t._steps)), n;
}), { fast: rG, density: pV } = B(["fast", "density"], function(e, t) {
	return e === 0 ? Ye : (e = U(e), t.withQueryTime((s) => s.mul(e)).withHapTime((s) => s.div(e)).setSteps(t._steps));
}, !0, !0), aG = B("hurry", function(e, t) {
	return t._fast(e).mul(Ue({ speed: e }));
}), { slow: uG, sparsity: oG } = B(["slow", "sparsity"], function(e, t) {
	return e === 0 ? Ye : t._fast(U(1).div(e));
}), cG = B("inside", function(e, t, n) {
	return t(n._slow(e))._fast(e);
}), lG = B("outside", function(e, t, n) {
	return t(n._fast(e))._slow(e);
}), dG = B("lastOf", function(e, t, n) {
	const s = Array(e - 1).fill(n);
	return s.push(t(n)), Fu(...s);
}), { firstOf: hG, every: pG } = B(["firstOf", "every"], function(e, t, n) {
	const s = Array(e - 1).fill(n);
	return s.unshift(t(n)), Fu(...s);
}), mG = B("apply", function(e, t) {
	return e(t);
}), fG = B("cpm", function(e, t) {
	return t._fast(e / 60 / 1);
}), yG = B("early", function(e, t) {
	return e = U(e), t.withQueryTime((n) => n.add(e)).withHapTime((n) => n.sub(e));
}, !0, !0), u0 = B("late", function(e, t) {
	return e = U(e), t._early(U(0).sub(e));
}, !0, !0), gG = B("zoom", function(e, t, n) {
	if (t = U(t), e = U(e), e.gte(t)) return Wt;
...
}), { zoomArc: bG, zoomarc: MG } = B(["zoomArc", "zoomarc"], function(e, t) {
	return t.zoom(e.begin, e.end);
}), CG = B("bite", (e, t, n) => t.fmap((s) => (i) => {
	const r = U(s).div(i).mod(1), a = r.add(U(1).div(i));
	return n.zoom(r, a);
}).appLeft(e).squeezeJoin(), !1), xG = B("linger", function(e, t) {
	return e == 0 ? Ye : e < 0 ? t._zoom(e.add(1), 1)._slow(e) : t._zoom(0, e)._slow(e);
}, !0, !0), { segment: GG, seg: vG } = B(["segment", "seg"], function(e, t) {
	return t.struct(Ue(!0)._fast(e)).setSteps(e);
}), PG = B("swingBy", (e, t, n) => n.inside(t, u0(a0(0, e / 2)))), AG = B("swing", (e, t) => t.swingBy(1 / 3, e)), { invert: FG, inv: XG } = B(["invert", "inv"], function(e) {
	return e.fmap((t) => !t);
}, !0, !0), DG = B("when", function(e, t, n) {
	return e ? t(n) : n;
}), SG = B("off", function(e, t, n) {
	return tt(n, t(n.late(e)));
}), wG = B("brak", function(e) {
	return e.when(Qn(!1, !0), (t) => Ft(t, Ye)._late(.25));
}), o0 = B("rev", function(e) {
	const t = function(n) {
	...
	return new _(t).splitQueries();
}, !1, !0), ZG = B("revv", function(e) {
	const t = (n) => new ct(U(0).sub(n.end), U(0).sub(n.begin));
	return e.withQuerySpan(t).withHapSpan(t);
}), EG = B("pressBy", function(e, t) {
	return t.fmap((n) => Ue(n).compress(e, 1)).squeezeJoin();
}), LG = B("press", function(e) {
	return e._pressBy(.5);
});
_.prototype.hush = function() {
	return Ye;
};
var RG = B("palindrome", function(e) {
	return e.lastOf(2, o0);
}, !0, !0), { juxBy: BG, juxby: VG } = B(["juxBy", "juxby"], function(e, t, n) {
	e /= 2;
	const s = function(a, u, o) {
		return u in a ? a[u] : o;
	}, i = n.withValue((a) => Object.assign({}, a, { pan: s(a, "pan", .5) - e })), r = t(n.withValue((a) => Object.assign({}, a, { pan: s(a, "pan", .5) + e })));
	return tt(i, r).setSteps(Tt ? rn(i._steps, r._steps) : void 0);
}), kG = B("jux", function(e, t) {
	return t._juxBy(1, e, t);
}), { echoWith: zG, echowith: NG, stutWith: WG, stutwith: TG } = B([
	"echoWith",
	"echowith",
	"stutWith",
	"stutwith"
...
}), IG = B("echo", function(e, t, n, s) {
	return s._echoWith(e, t, (i, r) => i.gain(Math.pow(n, r)));
}), _G = B("stut", function(e, t, n, s) {
	return s._echoWith(e, n, (i, r) => i.gain(Math.pow(t, r)));
}), c0 = B("applyN", function(e, t, n) {
	let s = n;
	for (let i = 0; i < e; i++) s = t(s);
	return s;
}), YG = B(["plyWith", "plywith"], function(e, t, n) {
	const s = n.fmap((i) => Mi(...wi(0, e - 1).map((r) => c0(r, t, i)))._fast(e)).squeezeJoin();
	return Tt && (s._steps = U(e).mulmaybe(n._steps)), s;
}), HG = B(["plyForEach", "plyforeach"], function(e, t, n) {
	const s = n.fmap((i) => Mi(Mi(Ue(i), ...wi(1, e - 1).map((r) => t(Ue(i), r))))._fast(e)).squeezeJoin();
	return Tt && (s._steps = U(e).mulmaybe(n._steps)), s;
}), Xu = function(e, t, n = !1) {
	return e = U(e), Qn(...wi(0, e.sub(1)).map((s) => n ? t.late(U(s).div(e)) : t.early(U(s).div(e))));
}, KG = B("iter", function(e, t) {
	return Xu(e, t, !1);
}, !0, !0), { iterBack: jG, iterback: UG } = B(["iterBack", "iterback"], function(e, t) {
	return Xu(e, t, !0);
}, !0, !0), { repeatCycles: OG } = B("repeatCycles", function(e, t) {
...
}, !0, !0), Du = function(e, t, n, s = !1, i = !1) {
	const r = Array(e - 1).fill(!1);
	r.unshift(!0);
	const a = Xu(e, on(...r), !s);
	return i || (n = n.repeatCycles(e)), n.when(a, t);
}, { chunk: JG, slowchunk: QG, slowChunk: qG } = B([
	"chunk",
	"slowchunk",
	"slowChunk"
], function(e, t, n) {
	return Du(e, t, n, !1, !1);
}, !0, !0), { chunkBack: $G, chunkback: ev } = B(["chunkBack", "chunkback"], function(e, t, n) {
	return Du(e, t, n, !0);
}, !0, !0), { fastchunk: tv, fastChunk: nv } = B(["fastchunk", "fastChunk"], function(e, t, n) {
	return Du(e, t, n, !1, !0);
}, !0, !0), { chunkinto: sv, chunkInto: iv } = B(["chunkinto", "chunkInto"], function(e, t, n) {
	return n.into(Ft(!0, ...Array(e - 1).fill(!1))._iterback(e), t);
}), { chunkbackinto: rv, chunkBackInto: av } = B(["chunkbackinto", "chunkBackInto"], function(e, t, n) {
	return n.into(Ft(!0, ...Array(e - 1).fill(!1))._iter(e)._early(1), t);
}), uv = B("bypass", function(e, t) {
	return e = !!parseInt(e), e ? Ye : t;
}, !0, !0), { ribbon: ov, rib: cv } = B(["ribbon", "rib"], (e, t, n) => n.early(e).restart(Ue(1).slow(t))), lv = B("hsla", (e, t, n, s, i) => i.color(`hsla(${e}turn,${t * 100}%,${n * 100}%,${s})`)), dv = B("hsl", (e, t, n, s) => s.color(`hsl(${e}turn,${t * 100}%,${n * 100}%)`));
_.prototype.tag = function(e) {
	return this.withContext((t) => ({
		...t,
		tags: (t.tags || []).concat([e])
	}));
};
var hv = B("filter", (e, t) => t.withHaps((n) => n.filter(e))), pv = B("filterWhen", (e, t) => t.filter((n) => e(n.whole.begin))), mv = B("within", (e, t, n, s) => tt(n(s.filterWhen((i) => i.cyclePos() >= e && i.cyclePos() <= t)), s.filterWhen((i) => i.cyclePos() < e || i.cyclePos() > t)));
_.prototype.stepJoin = function() {
	const e = this, t = Rt(...za(Na(e.queryArc(0, 1))))._steps, n = function(s) {
		return Rt(...za(Na(e.early(s.span.begin.sam()).query(s.setSpan(new ct(U(0), U(1))))))).query(s);
	};
	return new _(n, t);
};
...
function za(e) {
	const t = e.filter((r, a) => a.hasSteps).reduce((r, a) => r.add(a), U(0)), n = ys(e.map((r, a) => a._steps)).reduce((r, a) => r.add(a), U(0)), s = t.eq(0) ? void 0 : n.div(t);
	function i(r, a) {
...
function Na(e) {
	const t = En(e.map((i) => [i.part.begin, i.part.end]));
	return Hl(Kl([
		U(0),
		U(1),
		...t
	])).map((i) => [i[1].sub(i[0]), tt(...l0(new ct(...i), e).map((r) => r.value.withHap((a) => a.setContext(a.combineContext(r)))))]);
}
function l0(e, t) {
...
function d0(e, t) {
	...
	if (n != null) return new et(t.whole, n, t.value, t.context);
}
...
function p0(e, ...t) {
	...
	if (n.length == 0) return Ye;
	e == 0 && (e = n[0][1]);
	const s = [];
	for (const i of n) i[1] != 0 && (e == i[1] ? s.push(i[0]) : s.push(i[0]._fast(U(e).div(U(i[1])))));
	return tt(...s);
}
function Mr(...e) {
	if (Array.isArray(e[0])) return p0(0, ...e);
	if (e = e.filter((s) => s.hasSteps), e.length == 0) return Ye;
	const t = rn(...e.map((s) => s._steps));
	if (t.eq(U(0))) return Wt;
...
function Rt(...e) {
	...
	if (e = e.map(t), e.find((a) => a[0] === void 0)) {
		...
		if (a.length === 0) return Ft(...e.map((o) => o[1]));
		if (a.length === e.length) return Wt;
		const u = a.reduce((o, c) => o.add(c), U(0)).div(a.length);
		for (let o of e) o[0] === void 0 && (o[0] = u);
	}
	if (e.length == 1) return j(e[0][1]).withSteps((u) => e[0][0]);
	const n = e.map((a) => a[0]).reduce((a, u) => a.add(u), U(0));
	let s = U(0);
	const i = [];
	for (const [a, u] of e) {
		if (U(a).eq(0)) continue;
		const o = s.add(a);
...
function m0(...e) {
	...
	let n = [];
	for (let i = 0; i < t; ++i) n.push(...e.map((r) => r.length == 0 ? Ye : r[i % r.length]));
...
var C0 = (e, t) => t.shrinklist(e), x0 = B("shrink", function(e, t) {
	if (!t.hasSteps) return Wt;
	const n = t.shrinklist(e), s = Rt(...n);
	return s._steps = n.reduce((i, r) => i.add(r._steps), U(0)), s;
}, !0, !1, (e) => e.stepJoin()), yv = B("grow", function(e, t) {
	if (!t.hasSteps) return Wt;
	const n = t.shrinklist(U(0).sub(e));
	n.reverse();
	const s = Rt(...n);
	return s._steps = n.reduce((i, r) => i.add(r._steps), U(0)), s;
}, !0, !1, (e) => e.stepJoin()), G0 = function(e, ...t) {
	return e.tour(...t);
};
_.prototype.tour = function(...e) {
	return Rt(...[].concat(...e.map((t, n) => [
		...e.slice(0, e.length - n),
		this,
		...e.slice(e.length - n)
	]), this, ...e));
};
...
var Zv = B("chop", function(e, t) {
	const s = Array.from({ length: e }, (a, u) => u).map((a) => ({
		begin: a / e,
		end: (a + 1) / e
	})), i = function(a, u) {
...
}), Ev = B("striate", function(e, t) {
	const i = Qn(...Array.from({ length: e }, (r, a) => a).map((r) => ({
		begin: r / e,
		end: (r + 1) / e
	})));
...
}, A0 = B("slice", function(e, t, n) {
	return e.innerBind((s) => t.outerBind((i) => n.outerBind((r) => {
		r = r instanceof Object ? r : { s: r };
		return Ue({
			begin: Array.isArray(s) ? s[i] : i / s,
			end: Array.isArray(s) ? s[i + 1] : (i + 1) / s,
			_slices: s,
			...r
		});
	}))).setSteps(t._steps);
...
var Lv = B("splice", function(e, t, n) {
	const s = A0(e, t, n);
	return new _((i) => {
		const r = i.controls._cps || 1;
		return s.query(i).map((u) => u.withValue((o) => ({
			speed: r / o._slices / u.whole.duration * (o.speed || 1),
			unit: "c",
			...o
		})));
	}).setSteps(t._steps);
}, !1), { loopAt: Rv, loopat: Bv } = B(["loopAt", "loopat"], function(e, t) {
	return new _((s) => P0(e, t, s.controls._cps).query(s), t._steps ? t._steps.div(e) : void 0);
}), Vv = B("fit", (e) => e.withHaps((t, n) => t.map((s) => s.withValue((i) => {
...
})))), { loopAtCps: kv, loopatcps: zv } = B(["loopAtCps", "loopatcps"], function(e, t, n) {
	return P0(e, n, t);
}), Nv = (e) => Ue(1).withValue(() => j(e())).innerJoin();
var hc = (e) => e < .5 ? 1 : 1 - (e - .5) / .5, F0 = (e, t, n) => {
	t = j(t), e = j(e), n = j(n);
...
}, { beat: Tv } = B(["beat"], Wv((e) => e.innerJoin())), wu = (e, t, n) => {
	n = U(n);
	const s = U(1).div(e.length), i = (u) => {
		const o = [];
		for (const [c, l] of u.entries()) l && o.push([U(c).div(u.length), l]);
		return o;
	}, r = gr(([u, o], [c, l]) => {
		const p = n.mul(c - u).add(u);
		return new ct(p, p.add(s));
	}, i(e), i(t));
	function a(u) {
		const o = u.span.begin.sam(), c = u.span.cycleArc(), l = [];
		for (const p of r) {
			const m = p.intersection(c);
			m !== void 0 && l.push(new et(p.withTime((g) => g.add(o)), m.withTime((g) => g.add(o)), !0));
		}
		return l;
	}
	return new _(a).splitQueries();
}, Iv = (e, t, n) => (e = j(e), t = j(t), n = j(n), e.innerBind((s) => t.innerBind((i) => n.innerBind((r) => wu(s, i, r))))), qn = function(e) {
	const t = function(n, s) {
		const i = j(n).fmap((r) => Array.isArray(r) ? [...r, e] : [
			r,
			1,
			e
		]);
...
}, _v = qn("soft"), Yv = qn("hard"), Hv = qn("cubic"), Kv = qn("diode"), jv = qn("asym"), Uv = qn("fold"), Ov = qn("sinefold"), Jv = qn("chebyshev"), Zu = (e) => {
	let n = Ue(Xe((...s) => s, null, e.length));
	for (const s of e) n = n.appBoth(j(s));
	return n;
}, Cr = (e) => Array.isArray(e) ? Zu(e) : j(e);
_.prototype.partials = function(e) {
	return this.withValue((t) => (n) => ({
		...t,
		partials: n
	})).appLeft(Cr(e));
};
...
function Gn(e, t, ...n) {
	...
	for (let i = 1; i <= t; i++) {
		...
		} else r = r.map((o) => `${o}${i}`), a = a.map((o) => `${o}${i}`);
		const u = A(a, ...r);
		s = {
			...s,
			...u
...
var { s: D0, sound: S0 } = A([
	...
	"n",
	"gain"
], "sound"), { wt: w0, wavetablePosition: Z0 } = A("wt", "wavetablePosition"), { wtenv: E0 } = A("wtenv"), { wtattack: L0, wtatt: R0 } = A("wtattack", "wtatt"), { wtdecay: B0, wtdec: V0 } = A("wtdecay", "wtdec"), { wtsustain: k0, wtsus: z0 } = A("wtsustain", "wtsus"), { wtrelease: N0, wtrel: W0 } = A("wtrelease", "wtrel"), { wtrate: T0 } = A("wtrate"), { wtsync: I0 } = A("wtsync"), { wtdepth: _0 } = A("wtdepth"), { wtshape: Y0 } = A("wtshape"), { wtdc: H0 } = A("wtdc"), { wtskew: K0 } = A("wtskew"), { warp: j0, wavetableWarp: U0 } = A("warp", "wavetableWarp"), { warpattack: O0, warpatt: J0 } = A("warpattack", "warpatt"), { warpdecay: Q0, warpdec: q0 } = A("warpdecay", "warpdec"), { warpsustain: $0, warpsus: ed } = A("warpsustain", "warpsus"), { warprelease: td, warprel: nd } = A("warprelease", "warprel"), { warprate: sd } = A("warprate"), { warpdepth: id } = A("warpdepth"), { warpshape: rd } = A("warpshape"), { warpdc: ad } = A("warpdc"), { warpskew: ud } = A("warpskew"), { warpmode: od, wavetableWarpMode: cd } = A("warpmode", "wavetableWarpMode"), { wtphaserand: ld, wavetablePhaseRand: dd } = A("wtphaserand", "wavetablePhaseRand"), { warpenv: hd } = A("warpenv"), { warpsync: pd } = A("warpsync"), { source: md, src: fd } = A("source", "src"), { n: yd } = A("n"), { note: gd } = A(["note", "n"]), { accelerate: bd } = A("accelerate"), { velocity: Md, vel: Cd } = A("velocity", "vel"), { gain: xd } = A("gain"), { postgain: Gd } = A("postgain"), { amp: vd } = A("amp"), { attack: Pd, att: Ad } = A("attack", "att"), { fmh: Fd, fmh1: Xd, fmh2: Dd, fmh3: Sd, fmh4: wd, fmh5: Zd, fmh6: Ed, fmh7: Ld, fmh8: Rd } = Gn(["fmh", "fmi"], 8, "fmh"), { fmi: Bd, fmi1: Vd, fmi2: kd, fmi3: zd, fmi4: Nd, fmi5: Wd, fmi6: Td, fmi7: Id, fmi8: _d, fm: Yd, fm1: Hd, fm2: Kd, fm3: jd, fm4: Ud, fm5: Od, fm6: Jd, fm7: Qd, fm8: qd } = Gn(["fmi", "fmh"], 8, "fm"), { fmenv: $d, fmenv1: eh, fmenv2: th, fmenv3: nh, fmenv4: sh, fmenv5: ih, fmenv6: rh, fmenv7: ah, fmenv8: uh } = Gn("fmenv", 8), { fmattack: oh, fmattack1: ch, fmattack2: lh, fmattack3: dh, fmattack4: hh, fmattack5: ph, fmattack6: mh, fmattack7: fh, fmattack8: yh, fmatt: gh, fmatt1: bh, fmatt2: Mh, fmatt3: Ch, fmatt4: xh, fmatt5: Gh, fmatt6: vh, fmatt7: Ph, fmatt8: Ah } = Gn("fmattack", 8, "fmatt"), { fmwave: Fh, fmwave1: Xh, fmwave2: Dh, fmwave3: Sh, fmwave4: wh, fmwave5: Zh, fmwave6: Eh, fmwave7: Lh, fmwave8: Rh } = Gn("fmwave", 8), { fmdecay: Bh, fmdecay1: Vh, fmdecay2: kh, fmdecay3: zh, fmdecay4: Nh, fmdecay5: Wh, fmdecay6: Th, fmdecay7: Ih, fmdecay8: _h, fmdec: Yh, fmdec1: Hh, fmdec2: Kh, fmdec3: jh, fmdec4: Uh, fmdec5: Oh, fmdec6: Jh, fmdec7: Qh, fmdec8: qh } = Gn("fmdecay", 8, "fmdec"), { fmsustain: $h, fmsustain1: ep, fmsustain2: tp, fmsustain3: np, fmsustain4: sp, fmsustain5: ip, fmsustain6: rp, fmsustain7: ap, fmsustain8: up, fmsus: op, fmsus1: cp, fmsus2: lp, fmsus3: dp, fmsus4: hp, fmsus5: pp, fmsus6: mp, fmsus7: fp, fmsus8: yp } = Gn("fmsustain", 8, "fmsus"), { fmrelease: gp, fmrelease1: bp, fmrelease2: Mp, fmrelease3: Cp, fmrelease4: xp, fmrelease5: Gp, fmrelease6: vp, fmrelease7: Pp, fmrelease8: Ap, fmrel: Fp, fmrel1: Xp, fmrel2: Dp, fmrel3: Sp, fmrel4: wp, fmrel5: Zp, fmrel6: Ep, fmrel7: Lp, fmrel8: Rp } = Gn("fmrelease", 8, "fmrel");
for (let e = 0; e <= 8; e++) for (let t = 0; t <= 8; t++) A(`fmi${e}${t}`, `fm${e}${t}`);
var { bank: Bp } = A("bank"), { chorus: Vp } = A("chorus"), { analyze: kp } = A("analyze"), { fft: zp } = A("fft"), { decay: Np, dec: Wp } = A("decay", "dec"), { sustain: Tp, sus: Ip } = A("sustain", "sus"), { release: _p, rel: Yp } = A("release", "rel"), { hold: Hp } = A("hold"), { bandf: Kp, bpf: jp, bp: Up } = A([
	"bandf",
	"bandq",
	"bpenv"
], "bpf", "bp"), { bandq: Op, bpq: Jp } = A("bandq", "bpq"), { begin: Qp } = A("begin"), { end: qp } = A("end"), { loop: $p } = A("loop"), { loopBegin: em, loopb: tm } = A("loopBegin", "loopb"), { loopEnd: nm, loope: sm } = A("loopEnd", "loope"), { crush: im } = A("crush"), { coarse: rm } = A("coarse"), { tremolo: am, trem: um } = A([
	"tremolo",
	"tremolodepth",
	"tremoloskew",
	"tremolophase"
], "trem"), { tremolosync: om } = A([
	"tremolosync",
	"tremolodepth",
	"tremoloskew",
	"tremolophase"
], "tremsync"), { tremolodepth: cm } = A("tremolodepth", "tremdepth"), { tremoloskew: lm } = A("tremoloskew", "tremskew"), { tremolophase: dm } = A("tremolophase", "tremphase"), { tremoloshape: hm } = A("tremoloshape", "tremshape"), { drive: pm } = A("drive"), { duck: mm } = A("duckorbit", "duck"), { duckdepth: fm } = A("duckdepth"), { duckonset: ym } = A("duckonset", "duckons"), { duckattack: gm } = A("duckattack", "duckatt"), { byteBeatExpression: bm, bbexpr: Mm } = A("byteBeatExpression", "bbexpr"), { byteBeatStartTime: Cm, bbst: xm } = A("byteBeatStartTime", "bbst"), { channels: Gm, ch: vm } = A("channels", "ch"), { pw: Pm } = A([
	"pw",
	"pwrate",
	"pwsweep"
]), { pwrate: Am } = A("pwrate"), { pwsweep: Fm } = A("pwsweep"), { phaserrate: Xm, ph: Dm, phaser: Sm } = A([
	"phaserrate",
	"phaserdepth",
	"phasercenter",
	"phasersweep"
], "ph", "phaser"), { phasersweep: wm, phs: Zm } = A("phasersweep", "phs"), { phasercenter: Em, phc: Lm } = A("phasercenter", "phc"), { phaserdepth: Rm, phd: Bm, phasdp: Vm } = A("phaserdepth", "phd", "phasdp"), { channel: km } = A("channel"), { cut: zm } = A("cut"), { cutoff: Nm, ctf: Wm, lpf: Tm, lp: Im } = A([
	"cutoff",
	"resonance",
	"lpenv"
], "ctf", "lpf", "lp"), { lpenv: _m, lpe: Ym } = A("lpenv", "lpe"), { hpenv: Hm, hpe: Km } = A("hpenv", "hpe"), { bpenv: jm, bpe: Um } = A("bpenv", "bpe"), { lpattack: Om, lpa: Jm } = A("lpattack", "lpa"), { hpattack: Qm, hpa: qm } = A("hpattack", "hpa"), { bpattack: $m, bpa: ef } = A("bpattack", "bpa"), { lpdecay: tf, lpd: nf } = A("lpdecay", "lpd"), { hpdecay: sf, hpd: rf } = A("hpdecay", "hpd"), { bpdecay: af, bpd: uf } = A("bpdecay", "bpd"), { lpsustain: of, lps: cf } = A("lpsustain", "lps"), { hpsustain: lf, hps: df } = A("hpsustain", "hps"), { bpsustain: hf, bps: pf } = A("bpsustain", "bps"), { lprelease: mf, lpr: ff } = A("lprelease", "lpr"), { hprelease: yf, hpr: gf } = A("hprelease", "hpr"), { bprelease: bf, bpr: Mf } = A("bprelease", "bpr"), { ftype: Cf } = A("ftype"), { fanchor: xf } = A("fanchor"), { lprate: Gf } = A("lprate"), { lpsync: vf } = A("lpsync"), { lpdepth: Pf } = A("lpdepth"), { lpdepthfrequency: Af, lpdepthfreq: Ff } = A("lpdepthfrequency", "lpdepthfreq"), { lpshape: Xf } = A("lpshape"), { lpdc: Df } = A("lpdc"), { lpskew: Sf } = A("lpskew"), { bprate: wf } = A("bprate"), { bpsync: Zf } = A("bpsync"), { bpdepth: Ef } = A("bpdepth"), { bpdepthfrequency: Lf, bpdepthfreq: Rf } = A("bpdepthfrequency", "bpdepthfreq"), { bpshape: Bf } = A("bpshape"), { bpdc: Vf } = A("bpdc"), { bpskew: kf } = A("bpskew"), { hprate: zf } = A("hprate"), { hpsync: Nf } = A("hpsync"), { hpdepth: Wf } = A("hpdepth"), { hpdepthfrequency: Tf, hpdepthfreq: If } = A("hpdepthfrequency", "hpdepthfreq"), { hpshape: _f } = A("hpshape"), { hpdc: Yf } = A("hpdc"), { hpskew: Hf } = A("hpskew"), { vib: Kf, vibrato: jf, v: Uf } = A(["vib", "vibmod"], "vibrato", "v"), { noise: Of } = A("noise"), { vibmod: Jf, vmod: Qf } = A(["vibmod", "vib"], "vmod"), { hcutoff: qf, hpf: $f, hp: e1 } = A([
	"hcutoff",
	"hresonance",
	"hpenv"
], "hpf", "hp"), { hresonance: t1, hpq: n1 } = A("hresonance", "hpq"), { resonance: s1, lpq: i1 } = A("resonance", "lpq"), { djf: r1 } = A("djf"), { delay: a1 } = A([
	"delay",
	"delaytime",
	"delayfeedback"
]), { delayfeedback: u1, delayfb: o1, dfb: c1 } = A("delayfeedback", "delayfb", "dfb"), { delayspeed: l1 } = A("delayspeed"), { delaytime: d1, delayt: h1, dt: p1 } = A("delaytime", "delayt", "dt"), { delaysync: m1 } = A("delaysync"), { lock: f1 } = A("lock"), { detune: y1, det: g1 } = A("detune", "det"), { unison: b1 } = A("unison"), { spread: M1 } = A("spread"), { dry: C1 } = A("dry"), { fadeTime: x1, fadeOutTime: G1 } = A("fadeTime", "fadeOutTime"), { fadeInTime: v1 } = A("fadeInTime"), { freq: P1 } = A("freq"), { pattack: A1, patt: F1 } = A("pattack", "patt"), { pdecay: X1, pdec: D1 } = A("pdecay", "pdec"), { psustain: S1, psus: w1 } = A("psustain", "psus"), { prelease: Z1, prel: E1 } = A("prelease", "prel"), { penv: L1 } = A("penv"), { pcurve: R1 } = A("pcurve"), { panchor: B1 } = A("panchor"), { gate: V1, gat: k1 } = A("gate", "gat"), { leslie: z1 } = A("leslie"), { lrate: N1 } = A("lrate"), { lsize: W1 } = A("lsize"), { activeLabel: T1 } = A("activeLabel"), { label: I1 } = A(["label", "activeLabel"]), { degree: _1 } = A("degree"), { mtranspose: Y1 } = A("mtranspose"), { ctranspose: H1 } = A("ctranspose"), { harmonic: K1 } = A("harmonic"), { stepsPerOctave: j1 } = A("stepsPerOctave"), { octaveR: U1 } = A("octaveR"), { nudge: O1 } = A("nudge"), { octave: J1, oct: Q1 } = A("octave", "oct"), { orbit: q1 } = A("orbit", "o"), { bus: $1 } = A("bus"), { busgain: ey, bgain: ty } = A("busgain", "bgain"), { overgain: ny } = A("overgain"), { overshape: sy } = A("overshape"), { pan: iy } = A("pan"), { panspan: ry } = A("panspan"), { pansplay: ay } = A("pansplay"), { panwidth: uy } = A("panwidth"), { panorient: oy } = A("panorient"), { slide: cy } = A("slide"), { semitone: ly } = A("semitone"), { voice: dy } = A("voice"), { chord: hy } = A("chord"), { dictionary: py, dict: my } = A("dictionary", "dict"), { anchor: fy } = A("anchor"), { offset: yy } = A("offset"), { octaves: gy } = A("octaves"), { mode: by } = A(["mode", "anchor"]), { room: My } = A(["room", "size"]), { roomlp: Cy, rlp: xy } = A("roomlp", "rlp"), { roomdim: Gy, rdim: vy } = A("roomdim", "rdim"), { roomfade: Py, rfade: Ay } = A("roomfade", "rfade"), { ir: Fy, iresponse: Xy } = A(["ir", "i"], "iresponse"), { irspeed: Dy } = A("irspeed"), { irbegin: Sy } = A("irbegin"), { roomsize: wy, size: Zy, sz: Ey, rsize: Ly } = A("roomsize", "size", "sz", "rsize"), { shape: Ry } = A(["shape", "shapevol"]), { distort: By, dist: Vy } = A([
	"distort",
	"distortvol",
	"distorttype"
], "dist"), { distortvol: ky } = A("distortvol", "distvol"), { distorttype: zy } = A("distorttype", "disttype"), { compressor: Ny } = A([
	"compressor",
	"compressorRatio",
	"compressorKnee",
	"compressorAttack",
	"compressorRelease"
]), { compressorKnee: Wy } = A("compressorKnee"), { compressorRatio: Ty } = A("compressorRatio"), { compressorAttack: Iy } = A("compressorAttack"), { compressorRelease: _y } = A("compressorRelease"), { speed: Eu } = A("speed"), { stretch: Yy } = A("stretch"), { unit: Hy } = A("unit"), { squiz: Ky } = A("squiz"), { vowel: jy } = A("vowel"), { waveloss: Uy } = A("waveloss"), { density: tP } = A("density"), { expression: Oy } = A("expression"), { sustainpedal: Jy } = A("sustainpedal"), { fshift: Qy } = A("fshift"), { fshiftnote: qy } = A("fshiftnote"), { fshiftphase: $y } = A("fshiftphase"), { triode: eg } = A("triode"), { krush: tg } = A("krush"), { kcutoff: ng } = A("kcutoff"), { octer: sg } = A("octer"), { octersub: ig } = A("octersub"), { octersubsub: rg } = A("octersubsub"), { ring: ag } = A("ring"), { ringf: ug } = A("ringf"), { ringdf: og } = A("ringdf"), { freeze: cg } = A("freeze"), { xsdelay: lg } = A("xsdelay"), { tsdelay: dg } = A("tsdelay"), { real: hg } = A("real"), { imag: pg } = A("imag"), { enhance: mg } = A("enhance"), { comb: fg } = A("comb"), { smear: yg } = A("smear"), { scram: gg } = A("scram"), { binshift: bg } = A("binshift"), { hbrick: Mg } = A("hbrick"), { lbrick: Cg } = A("lbrick"), { frameRate: xg } = A("frameRate"), { frames: Gg } = A("frames"), { hours: vg } = A("hours"), { minutes: Pg } = A("minutes"), { seconds: Ag } = A("seconds"), { songPtr: Fg } = A("songPtr"), { uid: Xg } = A("uid"), { val: Dg } = A("val"), { cps: Sg } = A("cps"), { clip: wg, legato: Zg } = A("clip", "legato"), { duration: Eg, dur: Lg } = A("duration", "dur"), { zrand: Rg } = A("zrand"), { curve: Bg } = A("curve"), { deltaSlide: Vg } = A("deltaSlide"), { pitchJump: kg } = A("pitchJump"), { pitchJumpTime: zg } = A("pitchJumpTime"), { znoise: Ng } = A("znoise"), { zmod: Wg } = A("zmod"), { zcrush: Tg } = A("zcrush"), { zdelay: Ig } = A("zdelay"), { zzfx: _g } = A("zzfx"), { color: Yg, colour: Hg } = A(["color", "colour"]);
...
}), { midichan: Jg } = A("midichan"), { midimap: Qg } = A("midimap"), { midiport: qg } = A("midiport"), { midicmd: $g } = A("midicmd"), eb = B("control", (e, t) => {
	if (!Array.isArray(e)) throw new Error("control expects an array of [ccn, ccv]");
	const [n, s] = e;
	return t.ccn(n).ccv(s);
}), { ccn: tb } = A("ccn"), { ccv: nb } = A("ccv"), { ctlNum: sb } = A("ctlNum"), { nrpnn: ib } = A("nrpnn"), { nrpv: rb } = A("nrpv"), { progNum: ab } = A("progNum"), ub = B("sysex", (e, t) => {
	if (!Array.isArray(e)) throw new Error("sysex expects an array of [id, data]");
	const [n, s] = e;
	return t.sysexid(n).sysexdata(s);
}), { sysexid: ob } = A("sysexid"), { sysexdata: cb } = A("sysexdata"), { midibend: lb } = A("midibend"), { miditouch: db } = A("miditouch"), { polyTouch: hb } = A("polyTouch"), { oschost: pb } = A("oschost"), { oscport: mb } = A("oscport"), xi = (e) => Ci.has(e) ? Ci.get(e) : e, fb = B("as", (e, t) => (e = Array.isArray(e) ? e : [e], t.fmap((n) => {
	n = Array.isArray(n) ? n : [n];
	const s = [];
	for (let i = 0; i < e.length; ++i) n[i] !== void 0 && s.push([xi(e[i]), n[i]]);
	return Object.fromEntries(s);
}))), yb = B("scrub", (e, t) => e.outerBind((n) => {
	Array.isArray(n) || (n = [n]);
	const [s, i = 1] = n;
	return t.begin(s).mul(Eu(i)).clip(1);
}), !1), Wa = /* @__PURE__ */ new Map(), nP = (e, t, ...n) => {
	const s = Wa.get(e) ?? /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Set([t, ...n]);
	for (const r of i) s.set(String(r).toLowerCase(), t);
	Wa.set(e, s);
}, Ru = (e, t = []) => {
	for (const [n, ...s] of t) nP(e, n, ...s);
}, sP = (e, t) => {
	const n = Wa.get(e);
...
_.prototype.modulate = function(e, t, n) {
	...
	if (!s.includes(e)) return gt(`[core] Modulation type ${e} not found. Please use one of 'lfo', 'env', 'bmod'`), this;
	let i = this, r;
	i = i.fmap((a) => (u) => ({
		v: a,
		id: u
	...
	for (const [a, u] of Object.entries(t)) {
		...
		i = i.fmap(({ v: l, id: p }) => (m) => {
			...
			const g = l[e];
			return p ??= g.__ids.size, g[p] ??= { control: r }, g.__ids.add(p), m === void 0 ? {
				v: l,
				id: p
			} : (o === "control" || o === "subControl" ? g[p][o] = xi(m) : g[p][o] = m, {
				v: l,
				id: p
			});
		}).appLeft(c);
...
var Mb = (e) => Ue({}).bmod(e), { transient: Cb } = A(["transient", "transsustain"]), { FXrelease: xb, FXrel: Gb, FXr: vb, fxr: Pb } = A("FXrelease", "FXrel", "FXr", "fxr"), iP = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	FXr: vb,
	FXrel: Gb,
	FXrelease: xb,
	...
	zrand: Rg,
	zzfx: _g
}, Symbol.toStringTag, { value: "Module" })), rP = function(e, t) {
	const [n, s] = e, [i, r] = t, [a, u] = xu(s, i);
	return [[s, n - s], [gr((o, c) => o.concat(c), a, r), u]];
}, aP = function(e, t) {
	const [n, s] = e, [i, r] = t, [a, u] = xu(n, r);
	return [[n, s - n], [gr((c, l) => c.concat(l), i, a), u]];
}, Ab = function(e, t) {
	const [n, s] = e;
	...
	const s = Bu(e, t);
	return n ? Il(s, -n) : s;
}, uP = B("euclid", function(e, t, n) {
	return n.struct(Gr(e, t, 0));
}), oP = B("bjork", function(e, t) {
	Array.isArray(e) || (e = [e]);
	const [n, s = n, i = 0] = e;
	return t.struct(Gr(n, s, i));
}), { euclidrot: cP, euclidRot: lP } = B(["euclidrot", "euclidRot"], function(e, t, n, s) {
	return s.struct(Gr(e, t, n));
}), Fb = function(e, t, n, s) {
	if (e < 1) return Ye;
	const r = Gr(e, t, 0).join("").split("1").slice(1).map((a) => [a.length + 1, !0]);
	return s.struct(Su(...r)).late(U(n).div(t));
}, dP = B(["euclidLegato"], function(e, t, n) {
	return Fb(e, t, 0, n);
}), hP = B(["euclidLegatoRot"], function(e, t, n, s) {
	return Fb(e, t, n, s);
}), { euclidish: pP, eish: mP } = B(["euclidish", "eish"], function(e, t, n, s) {
	const i = wu(Bu(e, t), new Array(e).fill(1), n);
	return s.struct(i).setSteps(t);
});
function Xb(e, t, n = .05, s = .1, i = .1, r = globalThis.setInterval, a = globalThis.clearInterval, u = !0) {
	let o = 0, c = 0, l = 10 ** 4, p = .01;
	const m = (D) => n = D(n);
	i = i || s / 2;
	const g = () => {
		const D = e(), X = D + s + i;
		for (c === 0 && (c = D + p); c < X;) c = u ? Math.round(c * l) / l : c, t(c, n, o, D), c += n, o++;
	};
	let y;
	const x = () => {
		v(), g(), y = r(g, s * 1e3);
...
var Db = class {
	constructor({ interval: t, onTrigger: n, onToggle: s, onError: i, getTime: r, latency: a = .1, setInterval: u, clearInterval: o, beforeStart: c }) {
		this.started = !1, this.beforeStart = c, this.cps = .5, this.num_ticks_since_cps_change = 0, this.lastTick = 0, this.lastBegin = 0, this.lastEnd = 0, this.getTime = r, this.num_cycles_at_cps_change = 0, this.seconds_at_cps_change, this.onToggle = s, this.latency = a, this.clock = Xb(r, (l, p, m, g) => {
	...
	async start() {
		if (await this.beforeStart?.(), this.num_ticks_since_cps_change = 0, this.num_cycles_at_cps_change = 0, !this.pattern) throw new Error("Scheduler: no pattern set! call .setPattern first.");
		gt("[cyclist] start"), this.clock.start(), this.setStarted(!0);
	}
	pause() {
		gt("[cyclist] pause"), this.clock.pause(), this.setStarted(!1);
	}
	stop() {
		gt("[cyclist] stop"), this.clock.stop(), this.lastEnd = 0, this.setStarted(!1);
	}
...
}, yP = B("pick", function(e, t) {
	return vn(e, t, !1).innerJoin();
}), Eb = B("pickmod", function(e, t) {
	return vn(e, t, !0).innerJoin();
}), gP = B("pickF", function(e, t, n) {
	return n.apply(Zb(e, t));
}), bP = B("pickmodF", function(e, t, n) {
	return n.apply(Eb(e, t));
}), MP = B("pickOut", function(e, t) {
	return vn(e, t, !1).outerJoin();
}), CP = B("pickmodOut", function(e, t) {
	return vn(e, t, !0).outerJoin();
}), xP = B("pickRestart", function(e, t) {
	return vn(e, t, !1).restartJoin();
}), GP = B("pickmodRestart", function(e, t) {
	return vn(e, t, !0).restartJoin();
}), vP = B("pickReset", function(e, t) {
	return vn(e, t, !1).resetJoin();
}), PP = B("pickmodReset", function(e, t) {
	return vn(e, t, !0).resetJoin();
}), { inhabit: AP, pickSqueeze: FP } = B(["inhabit", "pickSqueeze"], function(e, t) {
	return vn(e, t, !1).squeezeJoin();
}), { inhabitmod: XP, pickmodSqueeze: DP } = B(["inhabitmod", "pickmodSqueeze"], function(e, t) {
	return vn(e, t, !0).squeezeJoin();
}), SP = (e, t) => (t = t.map(j), t.length == 0 ? Ye : e.fmap((n) => {
	const s = Ut(Math.round(n), t.length);
	return t[s];
}).squeezeJoin());
var wP = class {
	constructor({ onTrigger: t, onToggle: n, getTime: s }) {
		this.started = !1, this.cps = .5, this.getTime = s, this.time_at_last_tick_message = 0, this.collator = new Jl({ getTargetClockTime: s }), this.onToggle = n, this.latency = .1, this.cycle = 0, this.id = Math.round(Date.now() * Math.random()), this.worker = new SharedWorker(new URL(
			/* @vite-ignore */
			"" + new URL("../../@strudel/web/dist/assets/clockworker-ZDiUtESR.js", import.meta.url).href,
			import.meta.url
	...
	start() {
		gt("[cyclist] start"), this.setStarted(!0);
	}
	stop() {
		gt("[cyclist] stop"), this.collator.reset(), this.setStarted(!1);
	}
	setPattern(t, n = !1) {
...
var Ta, Lb, Rb, Bb, Vb;
function Ia() {
	if (!Ta) throw new Error("no time set! use setTime to define a time source");
	return Ta();
}
function ar(e) {
	Ta = e;
...
function _a(e, t) {
	if (t || (t = "assertion failed"), !e) throw new Error(t);
}
var Ee = class {
	constructor(t, n) {
	...
	static parseInput(t, n) {
		if (typeof t == "function") {
			if (!n) throw new Error("tried to parse function input without without passing node..");
			return t(n);
		}
		return typeof t == "object" ? t : typeof t == "number" && !isNaN(t) || typeof t == "string" ? Ot(t) : (console.log(`invalid input type "${typeof t}" for node of type "${n.type}", falling back to 0. The input was:`, t), 0);
	}
};
...
Pt.set("register", {
	...
	examples: [`let kick = register('kick', gate => gate.adsr(0,.11,0,.11)
...
Pt.set("module", {
	...
	examples: [`let kick = module('kick', gate => gate.adsr(0,.11,0,.11)
.apply(env => env.mul(env)
  .mul(158)
  .sine(env)
  .distort(.85)
...
function It(e, t, n) {
	return bt(e, (...s) => {
		const i = VP++;
		return s = s.map((r, a) => Ee.parseInput(r).asModuleInput?.(e, i, a)), t(...s).asModuleOutput?.(e, i);
	}, n);
}
Pt.set("n", {
	tags: ["math"],
...
Pt.set("select", {
	...
	examples: [`sine(220).mul(impulse(1).ad(.001,.2))
...
function kP(e) {
	const t = modules.get(e), s = t(...Array.from({ length: t.length }, (i, r) => Ls(`$INPUT${r}`)));
...
Ee.prototype.asModuleInput = function(e, t, n) {
	return this.inputOf = this.inputOf || [], this.inputOf.push([
		e,
		t,
		n
	]), this;
...
function ku(e, t = {}) {
	const { log: n = !1, lang: s = "js", fallbackType: i = "thru", constType: r = "n", getRegister: a = (y) => `r[${y}]`, getOutput: u = (y) => `o[${y}]`, getSource: o = (y) => `s[${y}]` } = t;
	...
	for (let y in c) {
		...
		let w = Pt.get(x.type);
		w || (console.warn(`unhandled node type "${c[y].type}". falling back to "${i}"`), w = Pt.get(i));
		const V = {
			vars: v,
			node: x,
			nodes: c,
		...
		w.compile && l.push(w.compile(V)), w.ugen && m.push({
			type: w.ugen,
			inputs: v
		});
	}
	const g = l.join(`
`);
	return n && (console.log("compiled code:"), console.log(g)), {
		src: g,
		ugens: m,
		registers: c.length
	};
...
function NP(e) {
	...
	function s(i) {
		if (!(typeof i != "object" || n.has(i))) {
			n.add(i);
			for (let r in i.ins) s(i.ins[r]);
			t.push(i);
		}
	}
	return s(e), t;
}
var pc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	compile: ku
...
var Yb = class {
	...
	trigger(t, ...n) {
		let s = this._events[t] || [];
		for (let i = 0; i < s.length; i++) s[i].apply(null, n);
	}
};
var WP = class extends Yb {
	...
	async getMIDIAccess(t) {
		if ("requestMIDIAccess" in t) {
			...
			for (let n of this.midiAccess.inputs.values()) n.state == "connected" && (n.onmidimessage = (s) => this.trigger("midimessage", n.id, s.data));
			this.midiAccess.onstatechange = (n) => {
				n.port.type == "input" && n.port.state == "connected" && (console.log("MIDI device connected:", n.port.name, "PORT:", n.port.id), n.port.onmidimessage = (s) => this.trigger("midimessage", n.port.id, s.data));
			};
		}
	}
	broadcast(t, n) {
		if (midi) for (let s of this.midiAccess.outputs.values()) s.send(t, n);
	}
};
function TP(e) {
	let t = e[0] & 240, n = (e[0] & 15) + 1;
	if (t == 176 && e.length == 3) return {
		type: "CC",
		channel: n,
		cc: e[1],
		value: e[2] / 127 * 2 - 1
	...
	if (t == 224 && e.length == 3) {
		...
		return {
			type: "PITCHBEND",
			channel: n,
			value: (e[2] << 7 | s) / 16383 * 2 - 1
		};
	}
	if (t == 144 && e.length == 3) return {
		type: "NOTE_ON",
		channel: n,
		note: e[1],
		velocity: e[2] / 127
	};
	if (t == 128 && e.length == 3) return {
		type: "NOTE_ON",
		channel: n,
		note: e[1],
		velocity: 0
...
function KP(e, t, n) {
	for (var s = 0; s < n.length; s++, t += 4) e.setFloat32(t, n[s], !0);
}
var mc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	Node: Ee,
	compile: ku,
	evaluate: _b,
...
var jP = (e) => `Math.sin(${e})`, UP = (e) => `Math.cos(${e})`, OP = (e) => `Math.tan(${e})`, JP = (e) => `Math.asin(${e})`, QP = (e) => `Math.acos(${e})`, qP = (e) => `Math.atan(${e})`, Hb = (e, t, n) => `${e} = ${t};${n ? ` /* ${n} */` : ""}`, zu = (e, ...t) => Hb(e.name, `nodes[${e.ugenIndex}].update(${t.join(",")})`, e.node.type), $P = (e) => `(2 ** ((${e} - 69) / 12) * 440)`, eA = (e, t) => `${e} ** ${t}`, tA = (e) => `Math.exp(${e})`, nA = (e) => `Math.log(${e})`, sA = (e, t) => `${e}%${t}`, iA = (e) => `Math.abs(${e})`, rA = (e) => `Math.round(${e})`, aA = (e) => `Math.floor(${e})`, uA = (e) => `Math.sign(${e})`, oA = (e) => `Math.ceil(${e})`, cA = (e, t) => `Math.min(${e}, ${t})`, lA = (e, t) => `Math.max(${e}, ${t})`, dA = (e, t) => `[${e}, ${t}]`, Gi = (e) => `${e}[0]`, hA = (e) => `${e}[1]`, pA = (e, t) => `(${Gi(e)} < ${Gi(t)} ? ${e} : ${t})`, mA = (e, t) => `(${Gi(e)} > ${Gi(t)} ? ${e} : ${t})`;
...
var yA = class {
	...
	async spawn(t, n) {
		this.graph = t;
		const { src: s, ugens: i, registers: r } = t.compile({ log: !1 });
	...
	sendCustomUgens() {
		if (!this.ugens.size) return;
		let t = [];
		for (let [n, s] of this.ugens) t.push({
			type: "SET_UGEN",
			className: n,
			ugen: s + ""
		});
	...
	async initAudioIn() {
		...
		const t = await navigator.mediaDevices.getUserMedia({ audio: {
			echoCancellation: !1,
			noiseSuppression: !1,
			autoGainControl: !1
		} });
	...
	initMidi() {
		console.log("init midi input..."), this.midiInited = !0, new WP().on("midimessage", (t, n) => {
			const s = TP(n);
			s && this.send(s);
		});
	}
	...
	async init() {
		if (!this.audioCtx) {
			if (_a(!this.audioCtx), this.audioCtx = this.outputNode?.context || new AudioContext({
				...
				sampleRate: 48e3
			}), await this.audioCtx.resume(), !this.audioCtx.audioWorklet) throw new Error("Audio cannot be loaded: non-secure origin? (AudioContext.audioWorklet is undefined)");
			await this.audioCtx.audioWorklet.addModule(_P), await this.audioCtx.audioWorklet.addModule(YP), this.audioWorklet = new AudioWorkletNode(this.audioCtx, "sample-generator", { outputChannelCount: [2] }), this.audioWorklet.port.onmessage = (t) => {
				const { id: n, time: s, type: i } = t.data;
				i === "SIGNAL_TRIGGER" ? this.graph.dfs((r) => {
					if (r.type === "signal" && r.id === n) {
						const a = r.callback(s, n);
						isNaN(a) ? a !== void 0 && console.warn(`expected number from "on" callback with id "${n}", got "${a}" instead.`) : window.postMessage({
				...
				if (t.data.eventType === "data" && this.recordedBuffers.push(t.data.audioBuffer), t.data.eventType === "stop") {
					...
					gA(HP(this.recordedBuffers, this.audioCtx.sampleRate, 2), "kabelsalat.wav", "audio/wav"), this.recordedBuffers = [];
				}
...
var MA = (e) => `sin(${e})`, CA = (e) => `cos(${e})`, xA = (e) => `tan(${e})`, GA = (e) => `asin(${e})`, vA = (e) => `acos(${e})`, PA = (e) => `atan(${e})`, Ha = (e, t, n) => `${e} = ${t};${n ? ` /* ${n} */` : ""}`, AA = (e, ...t) => {
	if (t.unshift(`nodes[${e.ugenIndex}]`), e.ugen === "Sequence" || e.ugen === "Pick") {
		const n = t.length - 2, s = `(float[${n}]){${t.slice(2).join(",")}}`;
		return Ha(e.name, `${e.ugen}_update(${t[0]}, ${t[1]}, ${n}, ${s})`, e.ugen);
	}
	return Ha(e.name, `${e.ugen}_update(${t.join(",")})`, e.ugen);
}, FA = (e) => `pow(2.0, ((${e} - 69.0) / 12.0)) * 440.0`, XA = (e, t) => `pow(${e}, ${t})`, DA = (e) => `exp(${e})`, SA = (e) => `log(${e})`, wA = (e, t) => `${e}>=${t}?${e}-${t}:${e}`, ZA = (e) => `fabs(${e})`, EA = (e, t) => `fmin(${e}, ${t})`, LA = (e, t) => `fmax(${e}, ${t})`, RA = (e) => `fround(${e})`, BA = (e) => `floor(${e})`, VA = (e) => `ceil(${e})`, kA = (e, t) => `((pair) {${e}, ${t}})`, vi = (e) => `${e}.a`, zA = (e) => `${e}.b`, NA = (e, t) => `(${vi(e)} < ${vi(t)} ? ${e} : ${t})`, WA = (e, t) => `(${vi(e)} > ${vi(t)} ? ${e} : ${t})`;
var T = {
	js: fA,
...
}), _A = bt("raw", (e, t) => new Ee("raw", t).withIns(Ot(e)), {
	ins: [{ name: "in" }, {
		name: "code",
...
const ${n} = (${t.value}); // raw`,
	examples: [`sine(4).range(.5,1)
.raw("(time*110%1*2-1)*$input")
.out()`]
}), YA = bt("bytebeat", (e, t) => new Ee("bytebeat", t).withIns(Ot(e)), {
	ins: [{
		name: "t",
		description: "time in samples"
	}, {
		name: "code",
	...
	examples: [`time().mul(8000).bytebeat\`
// Fractalized Past
// by: lhphr
...
}), HA = bt("floatbeat", (e, t) => new Ee("bytebeat", t).withIns(Ot(e)), {
	ins: [{
		name: "t",
		description: "time in samples"
	}, {
...
.mul(sine(220)).out()`],
	...
	compile: ({ vars: [e = 0, t = .02, n = .1, s = .2, i = .1], ...r }) => T[r.lang].defUgen(r, "time", e, t, n, s, i)
}), jA = It("ar", (e = 0, t = .02, n = .1) => e.adsr(t, 0, 1, n), {
	tags: ["envelope"],
...
}), UA = It("ad", (e = 0, t = .02, n = .1) => e.adsr(t, n, 0, n), {
	tags: ["envelope"],
...
.out()`],
	...
	compile: ({ vars: [e = 0, t = .5], ...n }) => T[n.lang].defUgen(n, e, t)
}), uF = q("slide", {
	ugen: "Slide",
	tags: ["fx"],
	internal: !0,
	description: "Slide/portamento node",
	examples: [`impulse(2).seq(55,110,220,330)
.slide(4).sine().out()`],
	ins: [{
		name: "in",
		default: 0
	...
	examples: [`impulse(2).seq(220,330,440,550)
.lag(.4).sine().out()`],
	ins: [{
		name: "in",
		default: 0
		...
		name: "rate",
		default: 1,
		description: "60 dB lag time in seconds"
	}],
	compile: ({ vars: [e = 0, t = 1], ...n }) => T[n.lang].defUgen(n, e, t)
}), cF = q("slew", {
	ugen: "Slew",
...
.sine().out()`],
	...
	examples: [`impulse(1).ad(.01,.2).mul(sine(220))
...
.range(220,880).sine().out()`],
	...
	examples: ["midigate().ar(0.01,0.2).mul(saw(midifreq())).mul(midivel()).mul(.8).out()"],
	ins: [{
		name: "channel",
		default: -1
	}],
	...
	compile: ({ vars: e, name: t, lang: n }) => T[n].def(t, T[n].pair_b(e.map(T[n].pair_make).reduce(T[n].pair_a_min)) || 0)
}), kF = q("argmax", {
	tags: ["math"],
	...
	compile: ({ vars: e, name: t, lang: n }) => T[n].def(t, T[n].pair_b(e.map(T[n].pair_make).reduce(T[n].pair_a_max)) || 0)
}), $b = q("greater", {
	tags: ["logic"],
	description: "returns 1 if input is greater then threshold",
	ins: [{ name: "in" }, { name: "threshold" }],
	examples: [`greater(sine(1),0)
...
.sine().out()`],
	...
	compile: ({ vars: [e = 0, t = -1, n = 1, s = -1, i = 1], ...r }) => T[r.lang].defUgen(r, e, t, n, s, i)
}), UF = q("thru", { compile: ({ name: e, vars: t, lang: n }) => T[n].def(e, t[0], "thru") }), OF = It("rangex", (e, t, n) => {
	let s = Ka(t), i = Ka(n).sub(s);
	return Jb(e.unipolar().mul(i).add(s));
}, {
	tags: ["math"],
	...
	ins: [{ name: "midi" }],
	examples: [`impulse(4).seq(0,3,7,12).add(60)
.midinote().sine().out()`]
}), QF = q("src", {
	internal: !0,
	...
	compile: ({ vars: [e, t = 0], name: n, lang: s, ...i }) => {
		...
		return [T[s].def(r, [r, e].join(" + "), `+ output ${t}`), T[s].def(a, r, `write source ${t}`)].join(`
`);
	}
}), t2 = q("poly"), n2 = Ot(Math.PI), $F = bt("fork", (e, t = 1) => t2(...Array.from({ length: t }, () => e.clone())), {
	ins: [{ name: "in" }, { name: "times" }],
	tags: ["multi-channel"],
	description: "split the signal into n channels",
	examples: ["dust(4).fork(2).adsr(.1).mul(sine(220)).out()"]
}), eX = It("perc", (e, t) => e.adsr(0, 0, 1, t), {
	tags: ["envelope"],
...
}), tX = It("hpf", (e, t, n = 0) => e.sub(e.lpf(t, n)), {
	ins: [
		{ name: "in" },
		{ name: "cutoff" },
		{ name: "reso" }
	...
	examples: [`sine(.25).range(0,2).round()
...
.qf(
 ...
 1, // gain (only relevant for types 5-7)
...
}), hX = bt("qlpf", (e, t, n = 10) => e.qf(0, t, n), {
...
}), pX = bt("qhpf", (e, t, n = 10) => e.qf(1, t, n), {
...
}), mX = bt("qbpf", (e, t, n = 10) => e.qf(2, t, n), {
  ...
  10 // Q
...
}), yX = bt("qapf", (e, t, n = 10) => e.qf(3, t, n), {
	...
	tags: ["fx", "filter"],
	examples: [`impulse(1).qapf(
  tri(0.5).rangex(100, 8000), // cutoff freq
  10 // Q
).out()`]
}), gX = bt("split", (e, t) => e.type !== "poly" ? t([e]) : t(e.ins), {
	...
	if ([1, 2].includes(t) || (t = 2, console.warn("mix only supports 1 or 2 channels atm.. falling back to 2")), e.type !== "poly") return e;
	if (t === 2) return Wu(...e.ins.map((s, i, r) => {
...
var MX = (e) => Wu(e), CX = Ot, xX = Ot, vX = It("mouseX", () => Nu("mouseX"), {
	...
	return s.type !== "poly" ? (s.ins.push({
		type: "n",
		value: 0,
		ins: []
	}), s) : (s.ins.forEach((i, r) => i.ins.push({
		type: "n",
		value: r,
		ins: []
	})), s);
...
var XX = class {
	constructor({ onToggle: t, onToggleRecording: n, beforeEval: s, transpiler: i, localScope: r = !1, outputNode: a = null } = {}) {
	...
	evaluate(t) {
		this.localScope || (Object.assign(globalThis, { audio: this.audio }), Object.assign(globalThis, { addUgen: this.registerUgen.bind(this) }));
		let n;
...
function DX({ defaultOutput: e, onEvalError: t, beforeEval: n, beforeStart: s, afterEval: i, getTime: r, transpiler: a, onToggle: u, editPattern: o, onUpdateState: c, sync: l = !1, setInterval: p, clearInterval: m, id: g, mondo: y = !1 }) {
	const x = new XX({ localScope: !0 }), v = {
	...
	}, H = (he) => x.evaluate(he).compile({ log: !1 });
	function z(he) {
		return he._Pattern ? he.__pure : he;
	}
	const $ = async (he, Ge = !0) => (he = o?.(he) || he, await D.setPattern(he, Ge), zb(he), he);
	ar(() => D.now());
	...
	const Ie = function(he) {
		...
		try {
			for (let Ge = 1; Ge < 10; ++Ge) Object.defineProperty(_.prototype, `d${Ge}`, {
				get() {
					return this.p(Ge);
				},
				configurable: !0
	...
	return {
		scheduler: D,
		evaluate: async (he, Ge = !0, Ce = !0) => {
			if (!he) throw new Error("no code to evaluate");
			try {
				w({
					code: he,
					pending: !0
				}), await dt(), ar(() => D.now()), await n?.({ code: he }), se = [], Ce && R(), y && (he = `mondolang\`${he}\``);
				let { pattern: Pe, meta: Se } = await e0(he, a, E);
				if (Object.keys(X).length) {
					let Le = [], pt = !1;
					for (const [ae, We] of Object.entries(X)) {
						const Mt = ae.length > 1 && ae.startsWith("S");
						if (Mt && pt === !1 && (Le = [], pt = !0), !pt || pt && Mt) {
				...
				if (se.length) for (const Le of se) Pe = Le(Pe);
				...
				gt(`[eval] error: ${Pe.message}`, "error"), console.error(Pe), w({
					evalError: Pe,
					pending: !1
				}), t?.(Pe);
			}
...
var wt = (e) => {
	...
	return new _(t);
}, Zi = wt((e) => e % 1), Tu = Zi.toBipolar(), vr = wt((e) => 1 - e % 1), Iu = vr.toBipolar(), _u = wt((e) => Math.sin(Math.PI * 2 * e)), i2 = _u.fromBipolar(), wX = i2._early(U(1).div(4)), ZX = _u._early(U(1).div(4)), r2 = wt((e) => Math.floor(e * 2 % 2)), EX = r2.toBipolar(), LX = Ft(Zi, vr), RX = Ft(Tu, Iu), BX = Ft(vr, Zi), VX = Ft(Iu, Tu), kX = wt(Ds);
var Yu = 0, Hu = 0;
...
var zX = wt(() => Yu), NX = wt(() => Yu), WX = wt(() => Hu), TX = wt(() => Hu), IX = (e) => (e |= 0, e ^= e >>> 16, e = Math.imul(e, 2246822507), e ^= e >>> 13, e = Math.imul(e, 3266489909), e ^= e >>> 16, e >>> 0), _X = (e) => Math.floor(e * 536870912), YX = (e, t = 0, n = 0) => {
...
}, yc = (e, t = 0, n = 0) => IX(YX(e, t, n)) / 4294967296, HX = (e, t, n = 0) => {
	const s = _X(e);
	if (t === 1) return yc(s, 0, n);
	const i = new Array(t);
	...
	return n << 5 ^ n;
}, KX = (e) => e - Math.trunc(e), jX = (e) => a2(Math.trunc(KX(e / 300) * 536870912)), gc = (e) => e % 536870912 / 536870912, UX = (e, t) => {
	if (t === 1) return Math.abs(gc(e));
	const n = [];
	for (let s = 0; s < t; s++) n.push(gc(e)), e = a2(e);
	return n;
}, OX = (e, t) => UX(jX(e), t);
var u2 = "legacy";
var Un = (e, t = 1, n = 0) => u2 === "legacy" ? OX(e + n, t) : HX(e, t, n), JX = (e = "legacy") => u2 = e, o2 = (e) => Zi.range(0, e).round().segment(e), QX = (e) => {
	return c2(e, j(e).log2(0).floor().add(1));
}, c2 = (e, t = 16) => {
	t = j(t);
	const n = o2(t).mul(-1).add(t.sub(1));
	return j(e).segment(t).brshift(n).band(Ue(1));
}, qX = (e) => {
	return l2(e, j(e).log2(0).floor().add(1));
}, l2 = (e, t = 16) => j(e).withValue((n) => (s) => {
	const i = [];
	for (let r = s - 1; r >= 0; r--) i.push(n >> r & 1);
	return i;
}).appLeft(j(t)), $X = (e) => wt((t) => (n) => Un(t, n).map(Math.abs)).appLeft(j(e)), d2 = (e) => wt((t, n) => {
	return Un(t.floor().add(.5), e, n.randSeed).map((a, u) => [a, u]).sort((a, u) => (a[0] > u[0]) - (a[0] < u[0])).map((a) => a[1])[t.cyclePos().mul(e).floor() % e];
})._segment(e), h2 = (e, t, n) => {
	const s = [...Array(t).keys()].map((i) => n.zoom(U(i).div(t), U(i + 1).div(t)));
	return e.fmap((i) => s[i].repeatCycles(t)._fast(t)).innerJoin();
}, eD = B("shuffle", (e, t) => h2(d2(e), e, t)), tD = B("scramble", (e, t) => h2(ju(e)._segment(e), e, t)), p2 = (e, t) => new _((n) => {
	let { randSeed: s, ...i } = n.controls;
	return s = e(s), t.query(n.setControls({
		...i,
		randSeed: s
	}));
}, t._steps), nD = B("seed", (e, t) => p2(() => e, t)), St = wt((e, t) => Un(e, 1, t.randSeed)), sD = St.toBipolar(), Ku = (e) => St.fmap((t) => t < e), iD = (e) => j(e).fmap(Ku).innerJoin(), rD = Ku(.5), ju = (e) => St.fmap((t) => Math.trunc(t * e)), aD = (e) => j(e).fmap(ju).innerJoin(), Uu = (e, t) => (t = t.map(j), t.length == 0 ? Ye : e.range(0, t.length).fmap((n) => {
	const s = Math.min(Math.max(Math.floor(n), 0), t.length - 1);
	return t[s];
})), Pr = (e, t) => Uu(e, t).outerJoin(), Ar = (e, t) => Uu(e, t).innerJoin(), m2 = (...e) => Pr(St, e), uD = (...e) => Ar(St, e), oD = m2;
...
var f2 = (...e) => Ar(St.segment(1), e), cD = f2, y2 = function(e, ...t) {
	const n = t.map((u) => j(u[0])), s = [];
	let i = Ue(0);
	for (const u of t) i = i.add(u[1]), s.push(i);
	const r = n0(s), a = function(u) {
		const o = i.mul(u);
		return r.fmap((c) => (l) => n[c.findIndex((p) => p > l, c)]).appLeft(o);
	};
	return e.bind(a);
}, lD = (...e) => y2(...e).outerJoin(), dD = (...e) => lD(St, ...e), g2 = (...e) => y2(St.segment(1), ...e).innerJoin(), hD = g2;
function pD(e, t = 0) {
...
function mD(e, t = 0) {
	const n = Math.floor(e), s = n + 1, i = Un(n, 1, t);
	return ((c, l, p) => c + p * (l - c))(i, i + Un(s, 1, t), (e - n) / (s - n)) / 2;
}
var fD = wt((e, t) => pD(e, t.randSeed)), yD = wt((e, t) => mD(e, t.randSeed)), gD = B("degradeByWith", (e, t, n) => n.fmap((s) => (i) => s).appLeft(e.filterValues((s) => s > t)), !0, !0), bD = B("degradeBy", function(e, t) {
	return t._degradeByWith(St, e);
}, !0, !0), MD = B("degrade", (e) => e._degradeBy(.5), !0, !0), CD = B("undegradeBy", function(e, t) {
	return t._degradeByWith(St.fmap((n) => 1 - n), e);
}, !0, !0), xD = B("undegrade", (e) => e._undegradeBy(.5), !0, !0), GD = B("sometimesBy", function(e, t, n) {
	return j(e).fmap((s) => tt(n._degradeBy(s), t(n._undegradeBy(1 - s)))).innerJoin();
}), vD = B("sometimes", function(e, t) {
	return t._sometimesBy(.5, e);
}), PD = B("someCyclesBy", function(e, t, n) {
	return j(e).fmap((s) => tt(n._degradeByWith(St._segment(1), s), t(n._degradeByWith(St.fmap((i) => 1 - i)._segment(1), 1 - s)))).innerJoin();
}), AD = B("someCycles", function(e, t) {
	return t._someCyclesBy(.5, e);
}), FD = B("often", function(e, t) {
	return t.sometimesBy(.75, e);
}), XD = B("rarely", function(e, t) {
	return t.sometimesBy(.25, e);
}), DD = B("almostNever", function(e, t) {
	return t.sometimesBy(.1, e);
}), SD = B("almostAlways", function(e, t) {
	return t.sometimesBy(.9, e);
}), wD = B("never", function(e, t) {
	return t;
}), ZD = B("always", function(e, t) {
	return e(t);
});
function Ou(e) {
...
var M2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	ClockCollator: Jl,
	Cyclist: Db,
	FXr: vb,
...
if (typeof DelayNode < "u") {
	class e extends DelayNode {
		constructor(n, s, i, r) {
			return super(n), s = Math.abs(s), this.delayTime.value = i, this.feedbackGain = n.createGain(), this.feedbackGain.gain.value = Math.min(Math.abs(r), .995), this.feedback = this.feedbackGain.gain, this.delayGain = n.createGain(), this.delayGain.gain.value = s, this.connect(this.feedbackGain), this.connect(this.delayGain), this.feedbackGain.connect(this), this.connect = (a) => this.delayGain.connect(a), this;
		}
		start(n) {
...
var Rs;
var C2 = () => (Rs = new AudioContext(), Rs), or = (e) => (Rs = e, Rs), ve = () => Rs || C2();
function TD() {
...
function v2(e, t) {
	...
	u = o = c = l = p = m = g = 0;
	for (let y = 0; y < s; y++) if (e === "white") r[y] = Math.random() * 2 - 1;
	else if (e === "brown") {
		let x = Math.random() * 2 - 1;
		r[y] = (a + .02 * x) / 1.02, a = r[y];
	} else if (e === "pink") {
		let x = Math.random() * 2 - 1;
		u = .99886 * u + x * .0555179, o = .99332 * o + x * .0750759, c = .969 * c + x * .153852, l = .8665 * l + x * .3104856, p = .55 * p + x * .5329522, m = -.7616 * m - x * .016898, r[y] = u + o + c + l + p + m + g + x * .5362, r[y] *= .11, g = x * .115926;
	} else if (e === "crackle") {
		const x = t * .01;
...
function ja(e = "white", t, n = .02) {
	const i = ve().createBufferSource();
	return i.buffer = v2(e, n), i.loop = !0, i.start(t), {
		node: i,
		stop: (r) => i.stop(r)
	};
}
...
var Ua = /* @__PURE__ */ new Map(), Ju = Symbol("nodePoolKey"), _D = (e) => !!e[Ju], P2 = (e) => e.context?.currentTime ?? 0, YD = (e) => {
	...
	if (e.disconnect(), e instanceof AudioScheduledSourceNode) return;
	const t = e[Ju];
	if (t == null) return;
	const n = P2(e);
	...
	return P2(e) < (e?.parameters?.get("end").value ?? 0) + .45;
}, Ei = (e, t) => {
	const n = Ua.get(e) ?? [];
	let s, i = !1;
	for (; n.length;) if (s = n.pop()?.deref(), s != null && HD(s)) {
		i = !0;
		break;
	}
	...
	s: 1,
	f: -1
}, OD = (e) => e?.split("").reduce((t, n) => t + UD[n], 0) || 0, Fr = (e, t = 3) => {
	const [n, s, i = t] = KD(e);
	if (!n) throw new Error("not a note: \"" + e + "\"");
	const r = jD[n.toLowerCase()], a = OD(s);
	return (Number(i) + 1) * 12 + r + a;
}, A2 = (e) => Math.pow(2, (e - 69) / 12) * 440, gn = (e, t, n) => Math.min(Math.max(e, t), n), JD = (e) => 12 * Math.log(e / 440) / Math.LN2 + 69, QD = (e, t) => {
	if (typeof e != "object") throw new Error("valueToMidi: expected object value");
	let { freq: n, note: s } = e;
...
var F2 = (e, t) => (e % t + t) % t, Mc = (e, t) => F2(Math.round(Ln(e, 0)), t);
function Cc(e, t) {
	return e / t;
}
function X2(e, t) {
	...
	if (Array.isArray(t)) u = Mc(s, t.length), a = t[u];
	else {
		const c = (p) => Fr(p) - i, l = Object.keys(t).filter((p) => !p.startsWith("_")).reduce((p, m, g) => !p || Math.abs(c(m)) < Math.abs(c(p)) ? m : p, null);
...
var aa = (e, t) => Object.fromEntries(Object.entries(t).map(([n, s]) => [n, e[s]])), D2 = (e) => {
	try {
...
var zt = (e, t, n, s, i, r, a, u, o, c = "exponential") => {
	...
	c === "exponential" && (r = r === 0 ? .001 : r, a = a === 0 ? .001 : a);
	const p = a - r, m = r + s * p, g = o - u, y = (x) => {
		let v;
		return t > x ? v = x * xc(r, a, 0, t) + r : v = (x - t) * xc(a, m, 0, n) + a, c === "exponential" && (v = v || .001), v;
	};
...
function Is(e, t = {}) {
	const { shape: n = 0, begin: s = 0, end: i = 0, time: r, depth: a = 1, dcoffset: u = -.5, frequency: o = 1, skew: c = .5, phaseoffset: l = 0, curve: p = 1, min: m, max: g, ...y } = t;
	return Dt(e, "lfo-processor", {
		begin: s,
		end: i,
		time: r ?? s,
		depth: a,
...
var Nt = (e, t = "linear", n) => {
	const [a, u, o, c] = e;
	if (a == null && u == null && o == null && c == null) return n ?? [
		.001,
		.001,
		1,
		.01
	...
	return [
		Math.max(a ?? 0, .001),
		Math.max(u ?? 0, .001),
		Math.min(o ?? (a != null && u == null || a == null && u == null ? 1 : .001), 1),
		Math.max(c ?? 0, .01)
	];
};
function $u(e, t, n, s, i) {
	let { defaultDepth: r = 1, depth: a, dcoffset: u, ...o } = i;
	a ??= Object.values(o).some((p) => p != null) ? r : 0;
	let c;
	return a && (c = Is(e, {
		begin: n,
		end: s,
...
function Z2(e, t, n, s, i, r) {
	let { frequency: a, anchor: u, env: o, type: c, model: l, q: p = 1, drive: m = .69, depth: g, depthfrequency: y, dcoffset: x = -.5, skew: v, shape: E, rate: w, sync: V } = s, D, X;
	l === "ladder" ? (X = Dt(e, "ladder-processor", {
		frequency: a,
		q: p,
		drive: m
	}), D = X.parameters.get("frequency")) : (X = Ei("filter", () => e.createBiquadFilter()), X.type = c, Object.entries({
		Q: p,
		frequency: a
	}).forEach(([Me, re]) => {
		X[Me].value = re;
...
function Bs(e, t, n, s) {
	if ((t.pattack ?? t.pdecay ?? t.psustain ?? t.prelease ?? t.penv) === void 0) return;
	const r = Ln(t.penv, 1, !0), a = $D[t.pcurve ?? 0];
	let [u, o, c, l] = Nt([
		t.pattack,
		t.pdecay,
		t.psustain,
	...
	const m = r * 100;
	zt(e, u, o, c, l, 0 - m * p, m - m * p, n, s, a);
}
function Vs(e, t, n) {
	const { vibmod: s = .5, vib: i } = t;
	let r;
	if (i > 0) {
...
var tS = (e, t = "sine") => {
	const n = ve();
	let s;
	return qu.includes(t) ? (s = n.createBufferSource(), s.buffer = v2(t, 2), s.loop = !0) : (s = n.createOscillator(), s.type = t, s.frequency.value = e), s.start(), s;
}, nS = (e, t, n = "sine") => {
	const i = e.value * t;
	return {
		osc: tS(i, n),
...
function Fi(e, t, n) {
	const s = ve(), i = [], r = {}, a = {};
	for (let u = 1; u <= 8; u++) for (let o = 0; o <= 8; o++) {
		let c;
		u === o + 1 ? c = `fmi${u === 1 ? "" : u}` : c = `fmi${u}${o}`;
		const l = t[c];
		if (!l) continue;
		let p = [];
		for (let [m, g] of [[!0, u], [!1, o]]) {
			if (g === 0) {
				p.push(e);
				continue;
			}
			if (!r[g]) {
				...
				if (H.some(($) => $ !== void 0)) {
					...
					zt($.gain, I, Y, ee, Me, 0, 1, n, re, de === "exp" ? "exponential" : "linear"), R.push($), z = Z.connect($);
				}
				r[g] = {
					input: Z.frequency,
					output: z,
			...
			p.push(m ? x.connect(V).connect(D) : y), k2(E, [
				...w,
				V,
				D
			]), a[`fm_${g}_gain`] = [V];
		...
		if (!p[1]) {
			lt(`[superdough] control ${c} failed to connect FM ${u} to target ${o} due to missing frequency parameter (likely because fm${o} is noise)`, "warning");
			continue;
		}
		p[0].connect(p[1]);
	}
...
var L2 = (e) => e / (1 + e), sS = (e, t) => (e % t + t) % t, iS = (e, t) => (1 + t) * e / (1 + t * Math.abs(e)), Ss = (e, t) => Math.tanh(e * (1 + t)), rS = (e, t) => gn((1 + t) * e, -1, 1), R2 = (e, t) => {
	const s = sS((1 + .5 * t) * e + 1, 4);
	return 1 - Math.abs(s - 2);
}, aS = (e, t) => Math.sin(Math.PI / 2 * R2(e, t)), uS = (e, t) => {
	const n = L2(Math.log1p(t));
	return Ss((e - n / 3 * e * e * e) / (1 - n / 3), t);
}, B2 = (e, t, n = !1) => {
	const s = 1 + 2 * t, r = .07 * L2(Math.log1p(t)), o = Ss(e + r, 2 * t) - Ss(n ? r : -e + r, 2 * t), c = 1 / Math.cosh(s * r), l = c * c;
	return Ss(o / Math.max(1e-8, (n ? 1 : 2) * s * l), t);
}, oS = (e, t) => B2(e, t, !0), cS = (e, t) => {
	...
	sinefold: aS,
	chebyshev: cS
}, ni = Object.freeze(Object.keys(eo)), lS = (e) => {
	let t = e;
	...
	return eo[ni[t % ni.length]];
}, V2 = (e, t, n) => Dt(ve(), "distort-processor", {
	distort: e,
	postgain: t
}, { processorOptions: { algorithm: n } }), Kn = (e, t = 36) => {
	...
	if (e != null) {
		if (!(e instanceof AudioNode)) throw new Error("releaseAudioNode can only release an AudioNode");
		if (e.disconnect(), e instanceof AudioScheduledSourceNode) try {
			e.stop();
		} catch {
...
to.generateReverb = function(e, t) {
	for (var n = e.audioContext || new AudioContext(), s = n.sampleRate, i = e.numChannels || 2, r = e.decayTime * 1.5, a = Math.round(e.decayTime * s), u = Math.round(r * s), o = Math.round((e.fadeInTime || 0) * s), c = Math.pow(1 / 1e3, 1 / a), l = n.createBuffer(i, u, s), p = 0; p < i; p++) {
		for (var m = l.getChannelData(p), g = 0; g < u; g++) m[g] = pS() * Math.pow(c, g);
		for (var g = 0; g < o; g++) m[g] *= g / o;
	}
...
to.generateGraph = function(e, t, n, s, i) {
	...
	for (var u = t / e.length, o = n / (i - s), c = 0; c < e.length; c++) a.fillRect(c * u, n - (e[c] - s) * o, 1, 1);
	return r;
};
...
typeof AudioContext < "u" && (BaseAudioContext.prototype.adjustLength = function(e, t, n = 1, s = 0) {
	...
	return u.generate = (o = 2, c = .1, l = 15e3, p = 1e3, m, g, y) => {
...
if (typeof GainNode < "u") {
	class e extends GainNode {
		constructor(n, s) {
			if (super(n), !vc[s]) throw new Error("vowel: unknown vowel " + s);
	...
	let t = [], n = {
		...
		listen(s) {
			return n.lc = t.push(s), () => {
				for (let r = _n + Oi; r < tn.length;) tn[r] === s ? tn.splice(r, Oi) : r += Oi;
				let i = t.indexOf(s);
		...
		notify(s, i) {
			let r = !tn.length;
			for (let a of t) tn.push(a, n.value, s, i);
			if (r) {
				for (_n = 0; _n < tn.length; _n += Oi) tn[_n](tn[_n + 1], tn[_n + 2], tn[_n + 3]);
				tn.length = 0;
			}
		},
		off() {},
...
var MS = (e, t) => {
	if (e?.parameters) {
		...
		if (s instanceof AudioParam) return s;
	}
	let n = e?.[t];
	if (n === void 0 && t === "frequency" && (n = e?.detune ?? e?.playbackRate), n instanceof AudioParam) return n;
}, Pc = bS(), CS = (e, t) => {
	const n = e.split("_")[0];
	return Pc[`${n}_${t}`] ?? Pc[n];
}, no = (e, t) => e === "frequency" && t >= 30 ? {
	min: 20 - t,
	max: 24e3 - t
} : {
	min: void 0,
	...
	for (let u = 0; u < i.length; u++) i[u] = gn((u / (i.length - 1) * 2 - 1) * n, t, n);
	const r = new WaveShaperNode(s, { curve: i }), a = je(1 / n);
	return e.connect(a).connect(r), {
		modulator: e,
		toCleanup: [r, a]
	};
}, so = (e, t, n) => {
	const s = CS(e, n);
	if (!s) return Pi(/* @__PURE__ */ new Error(`Could not find control data for target '${e}'. It may not be modulatable.`), "superdough"), {
		targetParams: [],
		paramName: e
	};
	const i = s.param, r = t[s.node] ? s.node : e, a = t[r];
	if (!a) return Pi(/* @__PURE__ */ new Error(`Could not connect to target '${r}' — it does not exist. Available targets: ${Object.keys(t).join(", ")}`), "superdough"), {
		targetParams: [],
		paramName: i
	};
	const u = [];
	...
	const { rate: s = 1, sync: i, cps: r, cycle: a, control: u = "lfo", subControl: o, fxi: c = "main", depth: l = 1, depthabs: p, ...m } = t, { targetParams: g, paramName: y } = so(u, n[c], o);
	if (!g.length) return;
	let x = g[0].value;
	x = x === 0 ? 1 : x;
	...
	let y = c[0].value;
	y = y === 0 ? 1 : y;
	const { min: x, max: v } = no(l, y), E = u ?? a * y, w = je(Math.sign(E) * Math.abs(E) / .3), V = g.connect(w), D = [];
	let X = V;
...
function T2(e, t) {
	...
	return {
		...
		midi: a,
		label: u,
		playbackRate: Math.abs(n) * Math.pow(2, s / 12)
	};
}
var I2 = async (e, t, n) => {
	...
	return e.unit === "c" && (r = r * u.duration), {
		buffer: u,
		playbackRate: r
	};
}, _2 = async (e, t, n) => {
	...
	e.loop && (a.loop = !0, a.loopStart = u * p, a.loopEnd = o * p);
	const y = p / a.playbackRate.value;
	return {
		bufferSource: a,
		offset: m,
		bufferDuration: p,
	...
	if (e = e.replace("#", "%23"), !ua[e]) {
		...
		ua[e] = fetch(e).then((a) => a.arrayBuffer()).then(async (a) => {
			const u = Date.now() - r;
			lt(`[sampler] load ${i}... done! loaded ${vS(a.byteLength)} in ${u}ms`, "loaded-sample", { url: e });
...
function Y2(e) {
	...
	for (let s = 0; s < e.numberOfChannels; s++) n.copyToChannel(e.getChannelData(s).slice().reverse(), s, s);
	return n;
}
var PS = (e) => io[e];
function H2(e) {
...
function K2(e, t = "") {
	if (!e.startsWith("github:")) throw new Error("expected \"github:\" at the start of pseudoUrl");
	let n = e.slice(7);
...
var j2 = (e, t, n = e._base || "") => Object.entries(e).forEach(([s, i]) => {
	if (typeof i == "string" && (i = [i]), typeof i != "object") throw new Error("wrong sample map format for " + s);
	n = i._base || n, n = H2(n), n.startsWith("github:") && (n = K2(n, ""));
	const r = (a) => n + a;
	Array.isArray(i) ? i = i.map(r) : i = Object.fromEntries(Object.entries(i).map(([a, u]) => [a, (typeof u == "string" ? [u] : u).map(r)])), t(s, i);
});
var U2 = {};
function AS(e, t) {
	U2[e] = t;
...
async function XS(e) {
	...
	const s = await fetch(e).then((i) => i.json()).catch((i) => {
		throw console.error(i), /* @__PURE__ */ new Error(`error loading "${e}"`);
	});
	return [s, s._base || n];
}
...
async function J2(e, t, n, s, i) {
	let { s: r, nudge: a = 0, cut: u, loop: o, clip: c = void 0, n: l = 0, speed: p = 1, duration: m } = t;
	if (p === 0) return;
	const g = ve();
	let [y, x, v, E] = Nt([
		t.attack,
	...
	if (u !== void 0) {
		const ee = Ac[u];
		ee && (ee.node.gain.setValueAtTime(1, Z), ee.node.gain.linearRampToValueAtTime(0, Z + .01)), Ac[u] = Y;
	}
	return Y;
}
function DS(e, t, n) {
...
var Xs = (e, t) => e !== void 0 && e !== t, Ja = (e) => new GainNode(e, {
	gain: 1,
	channelCount: 2,
...
var SS = class {
	...
	getDjf(t, n = 0) {
		return this.djfNode ?? (this.djfNode = Dt(this.audioContext, "djf-processor", { value: t }), this.summingNode.disconnect(), this.summingNode.connect(this.djfNode), this.djfNode.connect(this.output)), this.djfNode.parameters.get("value").setValueAtTime(t, n), this.djfNode;
	}
	getDelay(t = 0, n = .5, s) {
		return n = gn(n, 0, .98), this.delayNode ?? (this.delayNode = this.audioContext.createFeedbackDelay(1, t, n), this.delayNode.connect(this.summingNode), this.delayNode.start?.(s)), this.delayNode.delayTime.value !== t && this.delayNode.delayTime.setValueAtTime(t, s), this.delayNode.feedback.value !== n && this.delayNode.feedback.setValueAtTime(n, s), this.delayNode;
	}
	getReverb(t, n, s, i, r, a, u) {
		return this.reverbNode ?? (this.reverbNode = this.audioContext.createReverb(t, n, s, i, r, a, u), this.reverbNode.connect(this.summingNode)), (Xs(t, this.reverbNode.duration) || Xs(n, this.reverbNode.fade) || Xs(s, this.reverbNode.lp) || Xs(i, this.reverbNode.dim) || Xs(a, this.reverbNode.irspeed) || Xs(u, this.reverbNode.irbegin) || this.reverbNode.ir !== r) && this.reverbNode.generate(t, n, s, i, r, a, u), this.reverbNode;
	}
	sendReverb(t, n) {
	...
	duck(t, n = 0, s = .1, i = 1) {
		const r = n, a = Math.max(s, .002), u = this.output.gain;
		mn(this.audioContext, () => {
			const o = this.audioContext.currentTime, c = u.value;
			u.cancelScheduledValues(o), u.setValueAtTime(c, o);
			const l = Math.max(t, o), p = gn(1 - Math.sqrt(i), .01, c);
...
var wS = class {
	...
	connectToDestination = (t, n = [0, 1]) => {
		...
		t.connect(s);
		const i = new ChannelSplitterNode(this.audioContext, { numberOfOutputs: s.channelCount });
...
var q2 = class {
	...
	duck(t, n, s = 0, i = .1, r = 1) {
		const a = [t].flat(), u = [s].flat(), o = [i].flat(), c = [r].flat();
		a.forEach((l, p) => {
			const m = this.nodes[l];
			if (m == null) {
				Pi(/* @__PURE__ */ new Error(`duck target orbit ${l} does not exist`), "superdough");
				return;
			}
			const g = u[p] ?? u[0], y = Math.max(o[p] ?? o[0], .002), x = c[p] ?? c[0];
			m.duck(n, g, y, x);
		});
	}
	getOrbit(t, n) {
		return this.nodes[t] ?? (this.nodes[t] = new SS(this.audioContext), this.output.connectToDestination(this.nodes[t].output, n)), this.nodes[t];
	}
	getBus(t) {
		return this.buses[t] ?? (this.buses[t] = Ja(this.audioContext)), this.buses[t];
	}
};
...
function LS(e) {
	...
	for (; n + 8 <= t.byteLength;) {
		const s = String.fromCharCode(t.getUint8(n), t.getUint8(n + 1), t.getUint8(n + 2), t.getUint8(n + 3)), i = t.getUint32(n + 4, !0);
		if (s === "fmt ") return t.getUint32(n + 12, !0);
		n += 8 + i + (i & 1);
	}
	return null;
}
...
var oa = {}, BS = (e, t) => {
	if (e = e.replace("#", "%23"), !oa[e]) {
		...
		oa[e] = fetch(e).then((s) => s.arrayBuffer()).then(async (s) => {
			const i = Date.now() - n;
			return lt(`[wavetable] load table ${t}... done! loaded ${ES(s.byteLength)} in ${i}ms`, "loaded-table", { url: e }), await RS(s);
		});
	}
	return oa[e];
};
...
var Fc = (e, t, n, s = {}) => (t = e._base || t, Object.entries(e).forEach(([i, r]) => {
	if (i === "_base") return !1;
	if (typeof r == "string" && (r = [r]), typeof r != "object") throw new Error("wrong json format for " + i);
	let a = t;
	a.startsWith("github:") && (a = eM(a, "")), r = r.map((u) => a + u).filter((u) => u.toLowerCase().endsWith(".wav") ? !0 : (lt(`[wavetable] skipping ${u} -- wavetables must be ".wav" format`), !1)), r.length && ro(i, r, {
		baseUrl: t,
		frameLen: n
	});
}));
function ro(e, t, n) {
	sn(e, (s, i, r, a) => tM(s, i, r, t, a, n?.frameLen ?? 2048), {
		type: "wavetable",
		tables: t,
		...n
	});
...
var VS = async (e, t, n, s = {}) => {
	...
	const i = D2(e);
	if (typeof fetch == "function" && !(typeof fetch > "u")) return fetch(e).then((r) => r.json()).then((r) => Fc(r, i, t, s)).catch((r) => {
		throw console.error(r), /* @__PURE__ */ new Error(`error loading "${e}"`);
	});
};
async function tM(e, t, n, s, i, r) {
	const { s: a, n: u = 0, duration: o, clip: c } = t, l = ve(), [p, m, g, y] = Nt([
		t.attack,
		t.decay,
		t.sustain,
		t.release
	...
	if (Object.entries(L).forEach(([Ge, Ce]) => {
		const Pe = H.parameters.get(Ge);
		Pe.value = Ce !== void 0 ? Ce : Pe.defaultValue;
	}), H.port.postMessage({
		type: "initialize",
		payload: V
	}), l.currentTime > e) {
	...
	const z = [
		...
		t.warpsustain,
		t.warprelease
	], I = H.parameters, Y = I.get("position"), ee = I.get("warp");
	let Me = t.wtrate;
	...
	zt(O.gain, p, m, g, y, 0, .3, e, D, "linear"), Bs(H.parameters.get("detune"), t, e, D);
	const at = {
		node: O,
		nodes: {
			source: [H],
...
var an = yS();
function sn(e, t, n = {}) {
	e = e.toLowerCase().replace(/\s+/g, "_"), an.setKey(e, {
		onTrigger: t,
		data: n
	});
}
...
function eu(e) {
	for (const n in e) e[n.toLowerCase()] = e[n];
	const t = an.get();
	for (const n in t) {
		const [s, i] = n.split("_");
		if (!i) continue;
		const r = e[s];
		if (r) {
			if (typeof r == "string") t[`${r}_${i}`.toLowerCase()] = t[n];
			else if (Array.isArray(r)) for (const a of r) t[`${a}_${i}`.toLowerCase()] = t[n];
		}
	}
	an.set({ ...t });
}
async function zS(e) {
	eu(await (await fetch(e)).json());
}
async function NS(...e) {
	switch (e.length) {
		case 1: return typeof e[0] == "string" ? zS(e[0]) : eu(e[0]);
		case 2: return eu({ [e[0]]: e[1] });
		default: throw new Error("aliasMap expects 1 or 2 arguments, received " + e.length);
	}
}
function WS(e, t) {
	if (is(e) == null) {
...
function cM() {
	if (!Ji) {
		...
		Ji = Promise.all(t.map((n) => e.audioWorklet.addModule(n))).then(() => Ji = void 0);
	}
	return Ji;
}
async function ho(e = {}) {
	const { disableWorklets: t = !1, maxPolyphony: n, audioDeviceName: s = $a, multiChannelOrbits: i = !1 } = e;
	if (nM(n), sM(i), $2(), typeof window > "u") return;
	const r = ve();
	if (s != null && s != $a) try {
		const u = (await rM()).get(s), o = (u ?? "").length > 0;
		r.sinkId !== u && o && await r.setSinkId(u), lt(`[superdough] Audio Device set to ${s}, it might take a few seconds before audio plays on all output channels`);
	} catch {
...
function jS(e, t, n = 1, s = .5, i = 1e3, r = 2e3) {
	const a = ve(), u = Is(a, {
		frequency: n,
		depth: r * 2,
		begin: e,
...
function Dr(e = "time", t = 1) {
	...
	if (!n) throw new Error(`getAnalyzerData: ${e} not supported. use one of ${Object.keys(n).join(", ")}`);
	return n(), us[t];
}
function pM() {
	as?.reset(), vt = {}, us = {};
...
var Sr = async (e, t, n, s = .5, i = .5) => {
	const r = { main: {} }, a = ve(), u = Xr();
	let { stretch: o } = e;
	if (o != null && (t = t - .04), typeof e != "object") throw new Error(`expected hap.value to be an object, but got "${e}". Hint: append .note() or .s() to the end`, "error");
	if (e.duration = n, t < a.currentTime) {
		console.warn(`[superdough]: cannot schedule sounds in the past (target: ${t.toFixed(2)}, now: ${a.currentTime.toFixed(2)})`);
		return;
	}
	let { s: c = ut("s"), bank: l, source: p, postgain: m = ut("postgain"), duckorbit: g, duckonset: y, duckattack: x, duckdepth: v, djf: E, release: w = ut("release"), dry: V, delay: D = ut("delay"), delayfeedback: X = ut("delayfeedback"), delaysync: Z = ut("delaysync"), delaytime: L, orbit: R = ut("orbit"), bus: H, busgain: z = ut("busgain"), room: $, roomfade: I, roomlp: Y, roomdim: ee, roomsize: Me, ir: re, irspeed: de, irbegin: se, i: Ie = ut("i"), analyze: rt, fft: dt = ut("fft"), FX: O = [], FXrelease: at } = e;
	L = L ?? Cc(Z, s);
	const he = Xc(oo && R > 0 ? [R * 2 - 1, R * 2] : ut("channels")), Ge = e.channels != null ? Xc(e.channels) : he, Ce = u.getOrbit(R, Ge);
	g != null && u.duck(g, t, y, x, v), m = pn(m), D = pn(D), z = pn(z);
	const Pe = t + n, Le = Pe + Math.max(w, at ?? 0), pt = Math.round(Math.random() * 1e6);
	for (let ie = 0; ie <= si.size - uo; ie++) {
		const J = si.entries().next(), He = J.value[1].deref(), pe = J.value[0], Te = t + .25;
	...
	const ae = new OS();
	let We;
	if (p) We = p(t, e, n, s), r.main.source = [We];
	else if (is(c)) {
		const { onTrigger: ie } = is(c), He = await ie(t, e, () => mn(a, () => {
			ae.releaseNodes(), si.delete(pt);
		}, 0, Le), s);
		He && (We = He.node, si.set(pt, new WeakRef(He)), r.main = {
			...r.main,
			...He.nodes
		});
	} else throw new Error(`sound ${c} not found! Is it loaded?`);
	if (!We) return;
	if (a.currentTime > t) {
	...
	for (let [ie, J] of Object.entries(O)) {
		...
		r[He] ??= {};
		const pe = r[He];
		let { gain: Te = ut("gain"), velocity: Ct = ut("velocity"), shapevol: dn = ut("shapevol"), distorttype: Nn = ut("distorttype"), distortvol: hn = ut("distortvol"), tremolodepth: Xt = ut("tremolodepth"), phaserdepth: Fn = ut("phaserdepth"), delay: De = ut("delay"), delayfeedback: Oe = ut("delayfeedback"), delaysync: ye = ut("delaysync"), delaytime: qe, i: Ke = ut("i") } = J;
		...
		if (J.transient !== void 0) {
			const me = Dt(a, "transient-processor", {}, { processorOptions: {
				attack: J.transient,
		...
		if (J.tremolosync != null && (Wn = s * J.tremolosync), Wn !== void 0) {
			const me = Math.max(1 - Xt, 0), be = new GainNode(a, { gain: me }), $e = i / s, Je = Is(a, {
				skew: J.tremoloskew ?? (J.tremoloshape != null ? .5 : 1),
				frequency: Wn,
				depth: Xt,
				time: $e,
				dcoffset: 0,
		...
		if (J.compressor !== void 0) {
			const me = w2(a, J.compressor, J.compressorRatio, J.compressorKnee, J.compressorAttack, J.compressorRelease);
		...
		if (J.phaserrate !== void 0 && Fn > 0) {
			const { filterChain: me, lfo: be } = jS(t, Le, J.phaserrate, Fn, J.phasercenter, J.phasersweep);
			pe.phaser = [...me], pe.phaser_lfo = [be], me.forEach(($e) => ae.connect($e)), ae.audioNodes.push(be);
		}
		if (He !== "main" && De > 0 && qe > 0 && Oe > 0) {
			const me = je(1);
			Oe = gn(Oe, 0, .98);
			const be = a.createFeedbackDelay(1, qe, Oe), $e = je(De), Je = je(J.dry ?? 1), we = new GainNode(a, {
				gain: 1,
				channelCount: 2,
				channelCountMode: "explicit"
			});
		...
		if (He !== "main" && J.room > 0) {
			...
			const be = je(1), $e = a.createReverb(J.roomsize, J.roomfade, J.roomlp, J.roomdim, me, J.irspeed, J.irbegin), Je = je(J.room), we = je(J.dry ?? 1), _e = new GainNode(a, {
				gain: 1,
				channelCount: 2,
				channelCountMode: "explicit"
			});
	...
	} else Ce.connectToOutput(Mt);
	O.forEach((ie, J) => {
		const He = J === O.length - 1 ? "main" : J;
		if (ie.lfo) for (const pe of ie.lfo.__ids) {
			const Te = ie.lfo[pe];
			Te.fxi ??= He;
			const Ct = z2(pe, {
				...Te,
		...
		if (ie.env) for (const pe of ie.env.__ids) {
			const Te = ie.env[pe];
			Te.fxi ??= He;
			const Ct = N2(pe, {
				...Te,
		...
		if (ie.bmod) for (const pe of ie.bmod.__ids) {
			const Te = ie.bmod[pe];
			Te.fxi ??= He;
			const { toCleanup: Ct } = W2({
				...Te,
				begin: t,
				end: Le
			}, r, as);
	...
	[...QS].forEach((e) => {
		sn(e, (t, n, s) => {
			const [i, r, a, u] = Nt([
				...
				.6,
				.01
			]), o = je(.3), { node: l, nodes: p, stop: m, triggerRelease: g } = yM(e, t, n, () => {
				Re(o), s();
			}), { duration: y } = n, x = je(1), v = l.connect(o).connect(x), E = t + y;
		...
		const { duration: s, decay: i = .5, pdecay: r = .5, penv: a = 36, clip: u } = t, o = ve(), c = .02, l = 1.2, p = .025, m = 1, g = o.createOscillator();
		g.type = "triangle", g.frequency.value = Kn(t, 29), g.detune.setValueAtTime(a * 100, 0), g.detune.setValueAtTime(a * 100, e), g.detune.exponentialRampToValueAtTime(.001, e + r);
		const y = je(1);
		y.gain.setValueAtTime(1, e + c), y.gain.exponentialRampToValueAtTime(.001, e + c + i), g.start(e);
		const x = ja("brown", e, 2), v = je(1);
		v.gain.setValueAtTime(l, e), v.gain.exponentialRampToValueAtTime(.001, e + p);
		...
		let X = e + i + .01;
		return u != null && (X = Math.min(e + u * s, X)), w.gain.setValueAtTime(m, X - .01), w.gain.linearRampToValueAtTime(0, X), g.stop(X), x.stop(X), {
			node: V,
			nodes: { source: [g] },
			stop: (Z) => {
				g.stop(Z);
		...
		const s = ve();
		let { duration: i, n: r, unison: a = 5, spread: u = .6, detune: o } = t;
		o = o ?? r ?? .18;
		...
		Object.entries(w).forEach(([z, $]) => {
			const I = D.parameters.get(z);
			I.value = $ !== void 0 ? $ : I.defaultValue;
		...
		let R = je(1);
		R = D.connect(R), zt(R.gain, l, p, m, g, 0, .3 * X, e, y, "linear");
		let H = mn(s, () => {
		...
		let v = Dt(o, "byte-beat-processor", {
			frequency: r,
			begin: e,
			end: x
		...
		r ?? (i != null ? r = .3 : r = 0), i == null && r != null && (i = 1);
		let { duration: a, pw: u = .5 } = t;
		...
		}), V.connect(x.parameters.get("pulsewidth")));
		let D = mn(s, () => {
		...
		const s = ve(), [i, r, a, u] = Nt([
			...
			1,
			.01
		]), o = e + t.duration, c = o + u + .01, l = Xr().getBus(t.n ?? 0), p = l.connect(je(0));
...
function fM(e, t, n) {
	...
	if (!c[n]) throw new Error(`unknown wave type ${n}`);
	for (let p = 0; p < i; p++) {
...
function yM(e, t, n, s) {
	...
	let u;
	if (e === "user" && !a && (lt("[superdough] Synth 'user' was selected, but partials not specified. Defaulting to triangle. Use pat.partials to setup custom waveform"), e = "triangle"), e = e === "user" && !a ? "triangle" : e, e === "one") return u = new ConstantSourceNode(ve(), { offset: 1 }), u.start(t), {
		node: u,
		nodes: { source: u },
		stop: (p) => u?.stop(p)
	};
...
function ew(e = 1, t = .05, n = 220, s = 0, i = 0, r = .1, a = 0, u = 1, o = 0, c = 0, l = 0, p = 0, m = 0, g = 0, y = 0, x = 0, v = 0, E = 1, w = 0, V = 0) {
	...
	for (s = s * X + 9, w *= X, i *= X, r *= X, v *= X, c *= 500 * D / X ** 3, y *= D / X, l *= D / X, p *= X, m = m * X | 0, se = s + w + i + r + v | 0; I < se; H[I++] = re) ++Me % (x * 100 | 0) || (re = a ? a > 1 ? a > 2 ? a > 3 ? Math.sin((z % D) ** 3) : Math.max(Math.min(Math.tan(z), 1), -1) : 1 - (2 * z / D % 2 + 2) % 2 : 1 - 4 * Math.abs(Math.round(z / D) - z / D) : Math.sin(z), re = (m ? 1 - V + V * Math.sin(D * I / m) : 1) * Z(re) * Math.abs(re) ** u * e * 1 * (I < s ? I / s : I < s + w ? 1 - (I - s) / w * (1 - E) : I < s + w + i ? E : I < se - v ? (se - I - v) / r * E : 0), re = v ? re / 2 + (v > I ? 0 : (I < se - v ? 1 : (se - I) / v) * H[I - v | 0] / 2) : re), de = (n += o += c) * Math.cos(y * $++), z += de - de * g * (1 - (Math.sin(I) + 1) * 1e9 % 2), Y && ++Y > p && (n += l, R += l, Y = 0), m && !(++ee % m) && (n = R, o = L, Y ||= 1);
	return H;
}
var gM = (e, t) => {
	let { s: n, note: s = 36, freq: i, zrand: r = 0, attack: a = 0, decay: u = 0, sustain: o = .8, release: c = .1, curve: l = 1, slide: p = 0, deltaSlide: m = 0, pitchJump: g = 0, pitchJumpTime: y = 0, lfo: x = 0, znoise: v = 0, zmod: E = 0, zcrush: w = 0, zdelay: V = 0, tremolo: D = 0, duration: X = .2, zzfx: Z } = e;
	...
	return Y.buffer = I, Y.start(t), { node: Y };
};
function tw() {
	[
		"zzfx",
...
var mi;
function sw() {
	mi = Dt(ve(), "dough-processor", {}, { outputChannelCount: [2] }), dM(mi);
}
var er = /* @__PURE__ */ new Map(), Sc = /* @__PURE__ */ new Map();
_.prototype.supradough = function() {
	return this.onTrigger((e, t, n, s) => {
		...
		if (er.has(i) && (e.value.s = a), er.has(i) && !Sc.has(a)) {
			...
			const c = aw(o);
			Sc.set(a, c), c.then(({ channels: l, sampleRate: p }) => mi.port.postMessage({
				sample: a,
				channels: l,
				sampleRate: p
			}));
...
async function rw(e) {
	...
	const n = await fetch(e).then((s) => s.json()).catch((s) => {
		throw console.error(s), /* @__PURE__ */ new Error(`error loading "${e}"`);
	});
	return [n, n._base || t];
}
async function aw(e) {
	...
	let n = [];
	for (let s = 0; s < t.numberOfChannels; s++) n.push(t.getChannelData(s));
	return {
		channels: n,
...
async function dw(e, t, n, s, i, r, a, u = void 0) {
	...
	for (const l of c) if (l.hasOnset()) try {
		await Sr(GM(l), (l.whole.begin.valueOf() - n) / t, l.duration / t, t, (l.whole?.begin.valueOf() - n) / t);
	} catch (p) {
		Pi(p, "webaudio");
	}
...
function pw(e, t, n, s, i) {
	...
	return Qi(o, 0, "RIFF"), o.setUint32(4, 36 + e.length * r, !0), Qi(o, 8, "WAVE"), Qi(o, 12, "fmt "), o.setUint32(16, 16, !0), o.setUint16(20, t, !0), o.setUint16(22, s, !0), o.setUint32(24, n, !0), o.setUint32(28, n * a, !0), o.setUint16(32, a, !0), o.setUint16(34, i, !0), Qi(o, 36, "data"), o.setUint32(40, e.length * r, !0), t === 1 ? yw(o, 44, e) : fw(o, 44, e), u;
}
function mw(e, t) {
	for (var n = e.length + t.length, s = new Float32Array(n), i = 0, r = 0; i < n;) s[i++] = e[r], s[i++] = t[r], r++;
	return s;
}
function fw(e, t, n) {
	for (var s = 0; s < n.length; s++, t += 4) e.setFloat32(t, n[s], !0);
...
var gs = (e = "test-canvas", t) => {
	let { contextType: n = "2d", pixelated: s = !1, pixelRatio: i = window.devicePixelRatio } = {}, r = document.querySelector("#" + e);
	if (!r) {
...
_.prototype.draw = function(e, t) {
	if (typeof window > "u") return this;
...
var wc = "#22222210";
_.prototype.animate = function({ callback: e, sync: t = !1, smear: n = .5 } = {}) {
...
_.prototype.pianoroll = function(e = {}) {
	let { cycles: t = 4, playhead: n = .5, overscan: s = 0, hideNegative: i = !1, ctx: r = gs(), id: a = 1 } = e, u = -t * n, o = t * (1 - n);
	const c = (l, p) => (!i || l.whole.begin >= 0) && l.isWithinTime(p + u, p + o);
	return this.draw((l, p) => {
		FM({
			...e,
			time: p,
			ctx: r,
...
function FM({ time: e, haps: t, cycles: n = 4, playhead: s = .5, flipTime: i = 0, flipValues: r = 0, hideNegative: a = !1, inactive: u = Rn().foreground, active: o = Rn().foreground, background: c = "transparent", smear: l = 0, playheadColor: p = Rn().foreground, minMidi: m = 10, maxMidi: g = 90, autorange: y = 0, timeframe: x, fold: v = 1, vertical: E = 0, labels: w = !1, fill: V = 1, fillActive: D = !1, strokeActive: X = !0, stroke: Z, hideInactive: L = 0, colorizeInactive: R = 1, fontFamily: H, ctx: z, id: $ } = {}) {
	...
	const { min: he, max: Ge, values: Ce } = t.reduce(({ min: Se, max: Le, values: pt }, ae) => {
		const We = Zc(ae);
		return {
			min: We < Se ? We : Se,
			max: We > Le ? We : Le,
	...
	y && (m = he, g = Ge, dt = g - m + 1), at = Ce.sort((Se, Le) => typeof Se == "number" && typeof Le == "number" ? Se - Le : typeof Se == "number" ? 1 : String(Se).localeCompare(String(Le))), O = v ? de / at.length : de / dt, z.fillStyle = c, z.globalAlpha = 1, l || (z.clearRect(0, 0, I, Y), z.fillRect(0, 0, I, Y)), t.forEach((Se) => {
		...
		z.globalAlpha = Mt * ie;
		const He = ii((Se.whole.begin - (i ? Me : ee)) / Ie, ...se);
		let pe = ii(Se.duration / Ie, 0, re);
		const Te = Zc(Se), dn = ii(v ? at.indexOf(Te) / at.length : (Number(Te) - m) / dt, ...rt);
		let Nn = 0;
		const hn = ii(e / Ie, ...se);
		let Xt;
		if (E ? Xt = [
			...
			z.font = `${E ? pe : O * .75}px ${H || "monospace"}`, z.fillStyle = ae ? "black" : We, z.textBaseline = "top", z.fillText(qe, ...Xt);
		}
	}), z.globalAlpha = 1;
...
function Lc(e) {
	let { ctx: t, from: n = 0, to: s = 3, margin: i = 50, cx: r = 100, cy: a = 100, rotate: u = 0, thickness: o = i / 2, color: c = Rn().foreground, cap: l = "round", stretch: p = 1, fromOpacity: m = 1, toOpacity: g = 1 } = e;
...
function Gw(e) {
	let { stretch: t = 1, size: n = 80, thickness: s = n / 2, cap: i = "butt", inset: r = 3, playheadColor: a = "#ffffff", playheadLength: u = .02, playheadThickness: o = s, padding: c = 0, steady: l = 1, activeColor: p = Rn().foreground, inactiveColor: m = Rn().gutterForeground, colorizeInactive: g = 0, fade: y = !0, ctx: x, time: v, haps: E, drawTime: w, id: V } = e;
...
_.prototype.spiral = function(e = {}) {
	return this.onPaint((t, n, s, i) => Gw({
		ctx: t,
		time: n,
		haps: s,
		drawTime: i,
...
var vw = ds(36), Rc = (e, t, n, s) => {
	s = s * Math.PI * 2;
	return [Math.sin(s) * n + e, Math.cos(s) * n + t];
}, Bc = (e, t) => .5 - Math.log2(e / t) % 1;
function Pw({ haps: e, ctx: t, id: n, hapcircles: s = 1, circle: i = 0, edo: r = 12, root: a = vw, thickness: u = 3, hapRadius: o = 6, mode: c = "flake", margin: l = 10 } = {}) {
	...
	n && (e = e.filter((X) => X.hasTag(n))), t.strokeStyle = x, t.fillStyle = x, t.globalAlpha = 1, t.lineWidth = u, i && (t.beginPath(), t.arc(w, V, E, 0, 2 * Math.PI), t.stroke()), r && (Array.from({ length: r }, (X, Z) => {
		const [R, H] = Rc(w, V, E, Bc(a * Math.pow(2, Z / r), a));
	...
	t.lineWidth = o, e.forEach((X) => {
		...
		t.globalAlpha = Y, D.push([
			R,
			H,
			L,
			z,
			Y
		]), t.beginPath(), s && (t.moveTo(R + o, H), t.arc(R, H, o, 0, 2 * Math.PI), t.fill()), m && (t.moveTo(w, V), t.lineTo(R, H)), t.stroke();
...
_.prototype.pitchwheel = function(e = {}) {
	...
	return this.tag(n).onPaint((s, i, r) => Pw({
		...e,
		time: i,
		ctx: t,
...
function XM(e, { align: t = !0, color: n = "white", thickness: s = 3, scale: i = .25, pos: r = .75, trigger: a = 0, ctx: u = gs(), id: o = 1 } = {}) {
	...
	let y = 0;
	for (let x = m; x < p; x++) {
		const E = (r - i * (l[x] + 1 - 1)) * c.height;
		x === 0 ? u.moveTo(y, E) : u.lineTo(y, E), y += g;
	}
	u.stroke();
}
function DM(e, { color: t = "white", scale: n = .25, pos: s = .75, lean: i = .5, min: r = -150, max: a = 0, ctx: u = gs(), id: o = 1 } = {}) {
	if (!e) {
		u.beginPath();
		let y = s * l.height;
...
function Aw(e, { thickness: t = 3, speed: n = 1, min: s = -80, max: i = 0, ctx: r = gs(), id: a = 1, color: u } = {}) {
	if (r.lineWidth = t, r.strokeStyle = u, !e) return;
	...
	let g = l.width - n;
	for (let y = 0; y < p; y++) {
		r.globalAlpha = br((c[y] - s) / (i - s), 0, 1);
		const v = Math.log(y + 1) / Math.log(p) * l.height;
		r.fillRect(g, l.height - v, o, 2);
	}
	la.set(a, r.getImageData(0, 0, l.width, l.height));
}
var Fw = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	DEFAULT_MAX_POLYPHONY: 128,
	Warpmode: Qa,
	aliasBank: NS,
	get analysers() {
		return vt;
...
hs.prototype.format = function(e) {
	...
	if (this.location) {
		...
		if (n) {
			var u = this.location.end, o = da("", r.line.toString().length, " "), c = n[i.line - 1], p = (i.line === u.line ? u.column : c.length + 1) - i.column || 1;
			t += `
 --> ` + a + `
` + o + ` |
` + r.line + " | " + c + `
...
hs.buildMessage = function(e, t) {
	...
	function u(c) {
		...
		switch (l.length) {
			...
			default: return l.slice(0, -1).join(", ") + ", or " + l[l.length - 1];
		}
	}
	function o(c) {
...
`,
		...
		"	",
		"\xA0"
	], !1, !1), Fn = Ve(",", !1), De = Ve("|", !1), Oe = Dn(["\"", "'"], !1, !1), ye = ea("a letter, a number, \"-\", \"#\", \".\", \"^\", \"_\""), qe = Dn([
		"#",
		["-", "."],
		["0", "9"],
		["A", "Z"],
		...
		["ￒ", "ￗ"],
		["ￚ", "ￜ"]
	], !1, !1), Ke = Ve("[", !1), ts = Ve("]", !1), ns = Ve("{", !1), mt = Ve("}", !1), Wn = Ve("%", !1), me = Ve("<", !1), be = Ve(">", !1), $e = Dn(["@", "_"], !1, !1), Je = Ve("!", !1), we = Ve("(", !1), _e = Ve(")", !1), Bt = Ve("/", !1), Vt = Ve("*", !1), Wi = Ve("?", !1), qr = Ve(":", !1), $r = Ve("..", !1), d = Ve("^", !1), b = Ve("struct", !1), f = Ve("target", !1), M = Ve("euclid", !1), P = Ve("slow", !1), k = Ve("rotL", !1), W = Ve("rotR", !1), K = Ve("fast", !1), te = Ve("scale", !1), Ze = Ve("//", !1), ot = Dn([`
`], !0, !1), Xn = Ve("cat", !1), Tn = Ve("$", !1), Ti = Ve("setcps", !1), Ii = Ve("setbpm", !1), _t = Ve("hush", !1), kC = function() {
		...
		return (G) => {
			...
			G.options_.reps = S, G.options_.ops = G.options_.ops.filter((N) => N.type_ !== "replicate"), G.options_.ops.push({
				type_: "replicate",
				arguments_: { amount: S }
			}), G.options_.weight = S;
		};
	}, KC = function(h, G, S) {
		return (N) => N.options_.ops.push({
			type_: "bjorklund",
			arguments_: {
				pulse: h,
				step: G,
		...
		return new sa("hush");
	}, F = t.peg$currPos | 0, Ae = F, Ms = [{
		line: 1,
		column: 1
	}], qt = F, _i = t.peg$maxFailExpected || [], oe = t.peg$silentFails | 0, $s;
	if (t.startRule) {
	...
	function ec(h) {
		var G = Ms[h], S;
		if (G) return G;
		if (h >= Ms.length) S = Ms.length - 1;
		else for (S = h; !Ms[--S];);
		for (G = Ms[S], G = {
			line: G.line,
			column: G.column
		}; S < h;) e.charCodeAt(S) === 10 ? (G.line++, G.column = 1) : G.column++, S++;
		return Ms[h] = G, G;
	}
	function ta(h, G, S) {
		var N = ec(h), ce = ec(G);
	...
	function P5(h, G, S) {
		return new hs(hs.buildMessage(h, G), h, G, S);
	}
	function tc() {
		var h;
		return h = l9(), h;
	...
	function D5() {
		var h, G, S, N, ce;
		if (h = F, G = X5(), G !== n) {
			if (S = e.charAt(F), Pe.test(S) ? F++ : (S = n, oe === 0 && fe(Te)), S === n && (S = null), N = [], ce = Cs(), ce !== n) for (; ce !== n;) N.push(ce), ce = Cs();
			else N = n;
			N !== n ? (G = [
				G,
				S,
	...
	function S5() {
		var h, G, S, N;
		if (h = F, G = A5(), G !== n) {
			if (S = [], N = Cs(), N !== n) for (; N !== n;) S.push(N), N = Cs();
			else S = n;
	...
	function Yi() {
		var h, G, S, N;
		if (h = Z5(), h === n) if (h = F, G = F5(), G !== n) {
			for (S = [], N = Cs(); N !== n;) S.push(N), N = Cs();
			G = [G, S], h = G;
		} else F = h, h = n;
		return h;
	}
	...
	function ge() {
		var h, G;
		for (oe++, h = [], G = e.charAt(F), Le.test(G) ? F++ : (G = n, oe === 0 && fe(Xt)); G !== n;) h.push(G), G = e.charAt(F), Le.test(G) ? F++ : (G = n, oe === 0 && fe(Xt));
		return oe--, G = n, oe === 0 && fe(hn), h;
	}
	function xs() {
		var h, G, S, N;
		return h = F, G = ge(), e.charCodeAt(F) === 44 ? (S = c, F++) : (S = n, oe === 0 && fe(Fn)), S !== n ? (N = ge(), G = [
			G,
			S,
			N
		], h = G) : (F = h, h = n), h;
	...
	function nc() {
		var h, G, S, N;
		return h = F, G = ge(), e.charCodeAt(F) === 124 ? (S = l, F++) : (S = n, oe === 0 && fe(De)), S !== n ? (N = ge(), G = [
			G,
			S,
			N
		], h = G) : (F = h, h = n), h;
	...
	function sc() {
		var h, G, S, N;
		return h = F, G = ge(), e.charCodeAt(F) === 46 ? (S = a, F++) : (S = n, oe === 0 && fe(J)), S !== n ? (N = ge(), G = [
			G,
			S,
			N
		], h = G) : (F = h, h = n), h;
	...
	function ic() {
		var h, G, S, N;
		if (h = F, ge(), G = [], S = Hi(), S !== n) for (; S !== n;) G.push(S), S = Hi();
		else G = n;
	...
	function In() {
		var h, G, S, N;
		if (h = F, e.charCodeAt(F) === 94 ? (G = z, F++) : (G = n, oe === 0 && fe(d)), G === n && (G = null), S = [], N = ei(), N !== n) for (; N !== n;) S.push(N), N = ei();
		else S = n;
		return S !== n ? (Ae = h, h = $C(G, S)) : (F = h, h = n), h;
	}
	function ac() {
		var h, G, S, N, ce;
		if (h = F, G = [], S = F, N = xs(), N !== n ? (ce = In(), ce !== n ? S = ce : (F = S, S = n)) : (F = S, S = n), S !== n) for (; S !== n;) G.push(S), S = F, N = xs(), N !== n ? (ce = In(), ce !== n ? S = ce : (F = S, S = n)) : (F = S, S = n);
		else G = n;
		return G !== n && (Ae = h, G = e5(G)), h = G, h;
	}
	function Y5() {
		var h, G, S, N, ce;
		if (h = F, G = [], S = F, N = nc(), N !== n ? (ce = In(), ce !== n ? S = ce : (F = S, S = n)) : (F = S, S = n), S !== n) for (; S !== n;) G.push(S), S = F, N = nc(), N !== n ? (ce = In(), ce !== n ? S = ce : (F = S, S = n)) : (F = S, S = n);
		else G = n;
		return G !== n && (Ae = h, G = t5(G)), h = G, h;
	}
	function H5() {
		var h, G, S, N, ce;
		if (h = F, G = [], S = F, N = sc(), N !== n ? (ce = In(), ce !== n ? S = ce : (F = S, S = n)) : (F = S, S = n), S !== n) for (; S !== n;) G.push(S), S = F, N = sc(), N !== n ? (ce = In(), ce !== n ? S = ce : (F = S, S = n)) : (F = S, S = n);
		else G = n;
	...
	function t9() {
		var h, G, S, N, ce;
		if (h = F, e.substr(F, 5) === se ? (G = se, F += 5) : (G = n, oe === 0 && fe(te)), G !== n) if (ge(), S = Gs(), S !== n) {
			if (N = [], ce = Hi(), ce !== n) for (; ce !== n;) N.push(ce), ce = Hi();
			else N = n;
	...
	function na() {
		...
		if (h = F, e.substr(F, 2) === Ie ? (G = Ie, F += 2) : (G = n, oe === 0 && fe(Ze)), G !== n) {
			for (S = [], N = e.charAt(F), Mt.test(N) ? F++ : (N = n, oe === 0 && fe(ot)); N !== n;) S.push(N), N = e.charAt(F), Mt.test(N) ? F++ : (N = n, oe === 0 && fe(ot));
			G = [G, S], h = G;
		} else F = h, h = n;
		return h;
	}
	function n9() {
		...
		if (h = F, e.substr(F, 3) === rt ? (G = rt, F += 3) : (G = n, oe === 0 && fe(Xn)), G !== n) if (ge(), e.charCodeAt(F) === 91 ? (S = p, F++) : (S = n, oe === 0 && fe(Ke)), S !== n) if (ge(), N = Ps(), N !== n) {
			for (ce = [], nt = F, $t = xs(), $t !== n ? (As = Ps(), As !== n ? (Ae = nt, nt = qo(N, As)) : (F = nt, nt = n)) : (F = nt, nt = n); nt !== n;) ce.push(nt), nt = F, $t = xs(), $t !== n ? (As = Ps(), As !== n ? (Ae = nt, nt = qo(N, As)) : (F = nt, nt = n)) : (F = nt, nt = n);
	...
	function Ps() {
		var h, G, S, N, ce;
		if (h = F, G = s9(), G !== n) {
			for (ge(), S = [], N = na(); N !== n;) S.push(N), N = na();
			Ae = h, h = f5(G);
		} else F = h, h = n;
	...
	var d9 = function(h) {
		...
		this.type_ = "pattern", this.arguments_ = {
			alignment: G,
			_steps: N
		}, S !== void 0 && (this.arguments_.seed = S), this.source_ = h;
	}, h9 = function(h, G, S) {
	...
	if ($s !== n && F === e.length) return $s;
	throw $s !== n && F < e.length && fe(v5()), P5(_i, qt < e.length ? e.charAt(qt) : null, qt < e.length ? ta(qt, qt + 1) : ta(qt, qt));
}
var Dw = ["start"], ZM = 3e-4, Sw = (e, t) => (n, s) => {
	const a = e.source_[s].options_?.ops, u = n.__steps_source;
	if (a) for (const o of a) switch (o.type_) {
		case "stretch": {
			const c = ["fast", "slow"], { type: l, amount: p } = o.arguments_;
			if (!c.includes(l)) throw new Error(`mini: stretch: type must be one of ${c.join("|")} but got ${l}`);
			n = j(n)[l](t(p));
			break;
		}
		case "replicate": {
		...
		case "bjorklund":
			...
			break;
		case "degradeBy":
			n = j(n)._degradeByWith(St.early(ZM * o.arguments_.seed), o.arguments_.amount ?? .5);
			break;
		case "tail": {
		...
		case "range": {
			const c = t(o.arguments_.element);
			n = j(n);
			const l = (m, g, y = 1) => Array.from({ length: Math.abs(g - m) / y + 1 }, (x, v) => m < g ? m + v * y : m - v * y);
			n = ((m, g) => m.squeezeBind((y) => g.bind((x) => Ft(...l(y, x)))))(n, c);
			break;
		}
		default: console.warn(`operator "${o.type_}" not implemented`);
	}
		...
		case "pattern": {
			...
			switch (a) {
				...
				case "polymeter_slowcat":
					...
					break;
				case "polymeter": {
					const c = e.arguments_.stepsPerCycle ? i(e.arguments_.stepsPerCycle).fmap((p) => U(p)) : Ue(U(r.length > 0 ? r[0].__weight : 1));
					o = tt(...r.map((p) => p.fast(c.fmap((m) => m.div(p.__weight)))));
					break;
				}
				case "rand":
				...
				default:
					if (e.source_.some((l) => !!l.options_?.weight)) {
						const l = e.source_.reduce((p, m) => p.add(m.options_?.weight || U(1)), U(0));
						o = Su(...e.source_.map((p, m) => [p.options_?.weight || U(1), r[m]])), o.__weight = l, o._steps = l, u.length && (o._steps = o._steps.mul(rn(...u.map((p) => U(p._steps)))));
					} else o = on(...r), o._steps = r.length;
					e.arguments_._steps && (o.__steps_source = !0);
			}
			return u.length && (o.__steps_source = !0), o;
		}
		case "element": return i(e.source_);
		case "atom": {
			if (e.source_ === "~" || e.source_ === "-") return Ye;
			if (!e.location_) return console.warn("no location for", e), e.source_;
			const r = isNaN(Number(e.source_)) ? e.source_ : Number(e.source_);
			if (s === -1) return Ue(r);
			const [a, u] = po(t, e, s);
			return Ue(r).withLoc(a, u);
		}
		case "stretch": return i(e.source_).slow(i(e.arguments_.amount));
		default: return console.warn(`node type "${e.type_}" not implemented -> returning silence`), Ye;
	}
}
var po = (e, t, n = 0) => {
...
}, mo = (e, t = 0, n) => EM(e, t, n).map((s) => po(e, s, t)), fo = (...e) => {
	return on(...e.map((n) => {
		const s = `"${n}"`;
		return _s(Ri(s), s);
	}));
...
var Lw = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	StartRules: Dw,
	SyntaxError: hs,
	getLeafLocation: po,
...
var Rw = [
	...
	6,
	4191
], Bw = "‌‍·̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߽߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛ࢗ-࢟࣊-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯৾ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ૺ-૿ଁ-ଃ଼ା-ୄେୈୋ-୍୕-ୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఄ఼ా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ೳഀ-ഃ഻഼ാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ඁ-ඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ຼ່-໎໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜕ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠏-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᪿ-ᫎᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭᳴᳷-᳹᷀-᷿‌‍‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯・꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧ꠬ꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱ꣿ-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿･", BM = "ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙՠ-ֈא-תׯ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࡠ-ࡪࡰ-ࢇࢉ-ࢎࢠ-ࣉऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱৼਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚౝౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೝೞೠೡೱೲഄ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄຆ-ຊຌ-ຣລວ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜑᜟ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡸᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭌᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲊᲐ-ᲺᲽ-Ჿᳩ-ᳬᳮ-ᳳᳵᳶᳺᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄯㄱ-ㆎㆠ-ㆿㇰ-ㇿ㐀-䶿一-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-ꟍꟐꟑꟓꟕ-Ƛꟲ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꣾꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭩꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ", ha = {
	3: "abstract boolean byte char class double enum export extends final float goto implements import int interface long native package private protected public short static super synchronized throws transient volatile",
	5: "class enum extends super const export import",
	6: "enum",
	strict: "implements interface let package private protected public static yield",
	strictBind: "eval arguments"
}, pa = "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this", Vw = {
	5: pa,
	"5module": pa + " export import",
	6: pa + " const class extends export import super"
}, kw = /^in(stanceof)?$/, zw = new RegExp("[" + BM + "]"), Nw = new RegExp("[" + BM + Bw + "]");
function su(e, t) {
	for (var n = 65536, s = 0; s < t.length; s += 2) {
		if (n += t[s], n > e) return !1;
		if (n += t[s + 1], n >= e) return !0;
	}
	return !1;
}
function Bn(e, t) {
	return e < 65 ? e === 36 : e < 91 ? !0 : e < 97 ? e === 95 : e < 123 ? !0 : e <= 65535 ? e >= 170 && zw.test(String.fromCharCode(e)) : t === !1 ? !1 : su(e, RM);
}
function ks(e, t) {
	return e < 48 ? e === 36 : e < 58 ? !0 : e < 65 ? !1 : e < 91 ? !0 : e < 97 ? e === 95 : e < 123 ? !0 : e <= 65535 ? e >= 170 && Nw.test(String.fromCharCode(e)) : t === !1 ? !1 : su(e, RM) || su(e, Rw);
}
var ze = function(t, n) {
...
var Ht = { beforeExpr: !0 }, Et = { startsExpr: !0 }, yo = {};
function ke(e, t) {
...
function VM(e, t, n) {
	...
	for (var s = t; s < n; s++) {
		...
		if (Ys(i)) return s < n - 1 && i === 13 && e.charCodeAt(s + 1) === 10 ? s + 2 : s + 1;
	}
	return -1;
}
var kM = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, Kt = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, zM = Object.prototype, Tw = zM.hasOwnProperty, Iw = zM.toString, Hs = Object.hasOwn || function(e, t) {
	return Tw.call(e, t);
}, kc = Array.isArray || function(e) {
	return Iw.call(e) === "[object Array]";
}, zc = /* @__PURE__ */ Object.create(null);
function jn(e) {
...
function Yw(e) {
	var t = {};
	for (var n in iu) t[n] = e && Hs(e, n) ? e[n] : iu[n];
	if (t.ecmaVersion === "latest" ? t.ecmaVersion = 1e8 : t.ecmaVersion == null ? (!Nc && typeof console == "object" && console.warn && (Nc = !0, console.warn(`Since Acorn 8.0.0, options.ecmaVersion is required.
Defaulting to 2020, but this will stop working in the future.`)), t.ecmaVersion = 11) : t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), t.allowReserved ??= t.ecmaVersion < 5, (!e || e.allowHashBang == null) && (t.allowHashBang = t.ecmaVersion >= 14), kc(t.onToken)) {
		var s = t.onToken;
...
var Di = 1, Ks = 2, go = 4, WM = 8, TM = 16, IM = 32, bo = 64, _M = 128, Bi = 256, Mo = Di | Ks | Bi;
function Co(e, t) {
	return Ks | (e ? go : 0) | (t ? WM : 0);
}
var lr = 0, xo = 1, zn = 2, YM = 3, HM = 4, KM = 5, ht = function(t, n, s) {
	this.options = t = Yw(t), this.sourceFile = t.sourceFile, this.keywords = jn(Vw[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5]);
	var i = "";
	t.allowReserved !== !0 && (i = ha[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3], t.sourceType === "module" && (i += " await")), this.reservedWords = jn(i);
	var r = (i ? i + " " : "") + ha.strict;
	this.reservedWordsStrict = jn(r), this.reservedWordsStrictBind = jn(r + " " + ha.strictBind), this.input = String(n), this.containsEsc = !1, s ? (this.pos = s, this.lineStart = this.input.lastIndexOf(`
...
Pn.canAwait.get = function() {
	for (var e = this.scopeStack.length - 1; e >= 0; e--) {
		...
		if (t.inClassFieldInit || t.flags & Bi) return !1;
		if (t.flags & Ks) return (t.flags & go) > 0;
	}
...
ue.parseTopLevel = function(e) {
	...
	if (this.inModule) for (var s = 0, i = Object.keys(this.undefinedExports); s < i.length; s += 1) {
		var r = i[s];
		this.raiseRecoverable(this.undefinedExports[r].start, "Export '" + r + "' is not defined");
	}
	return this.adaptDirectivePrologue(e.body), this.next(), e.sourceType = this.options.sourceType, this.finishNode(e, "Program");
};
var Go = { kind: "loop" }, jw = { kind: "switch" };
ue.isLet = function(e) {
	...
	if (Bn(s, !0)) {
		for (var i = n + 1; ks(s = this.input.charCodeAt(i), !0);) ++i;
		if (s === 92 || s > 55295 && s < 56320) return !0;
		var r = this.input.slice(n, i);
		if (!kw.test(r)) return !0;
	}
	return !1;
};
...
ue.parseStatement = function(e, t, n) {
	...
	switch (this.isLet(e) && (s = C._var, r = "let"), s) {
		case C._break:
		case C._continue: return this.parseBreakContinueStatement(i, s.keyword);
		...
		case C._const:
		case C._var: return r = r || this.value, e && r !== "var" && this.unexpected(), this.parseVarStatement(i, r);
		...
		case C._import:
			if (this.options.ecmaVersion > 10 && s === C._import) {
				...
				if (o === 40 || o === 46) return this.parseExpressionStatement(i, this.parseExpression());
			}
...
ue.parseForStatement = function(e) {
	...
	if (this.labels.push(Go), this.enterScope(0), this.expect(C.parenL), this.type === C.semi) return t > -1 && this.unexpected(t), this.parseFor(e, null);
	var n = this.isLet();
	if (this.type === C._var || this.type === C._const || n) {
		var s = this.startNode(), i = n ? "let" : this.value;
		return this.next(), this.parseVar(s, !0, i), this.finishNode(s, "VariableDeclaration"), (this.type === C._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && s.declarations.length === 1 ? (this.options.ecmaVersion >= 9 && (this.type === C._in ? t > -1 && this.unexpected(t) : e.await = t > -1), this.parseForIn(e, s)) : (t > -1 && this.unexpected(t), this.parseFor(e, s));
	}
	var r = this.isContextual("let"), a = !1, u = this.containsEsc, o = new Zr(), c = this.start, l = t > -1 ? this.parseExprSubscripts(o, "await") : this.parseExpression(!0, o);
	return this.type === C._in || (a = this.options.ecmaVersion >= 6 && this.isContextual("of")) ? (t > -1 ? (this.type === C._in && this.unexpected(t), e.await = !0) : a && this.options.ecmaVersion >= 8 && (l.start === c && !u && l.type === "Identifier" && l.name === "async" ? this.unexpected() : this.options.ecmaVersion >= 9 && (e.await = !1)), r && a && this.raise(l.start, "The left-hand side of a for-of loop may not start with 'let'."), this.toAssignable(l, !1, o), this.checkLValPattern(l), this.parseForIn(e, l)) : (this.checkExpressionErrors(o, !0), t > -1 && this.unexpected(t), this.parseFor(e, l));
};
ue.parseFunctionStatement = function(e, t, n) {
	return this.next(), this.parseFunction(e, yi | (n ? 0 : ru), !1, t);
};
...
ue.parseSwitchStatement = function(e) {
	...
	for (var t, n = !1; this.type !== C.braceR;) if (this.type === C._case || this.type === C._default) {
		...
		t && this.finishNode(t, "SwitchCase"), e.cases.push(t = this.startNode()), t.consequent = [], this.next(), s ? t.test = this.parseExpression() : (n && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"), n = !0, t.test = null), this.expect(C.colon);
...
ue.parseLabeledStatement = function(e, t, n, s) {
	for (var i = 0, r = this.labels; i < r.length; i += 1) r[i].name === t && this.raise(n.start, "Label '" + t + "' is already declared");
	for (var u = this.type.isLoop ? "loop" : this.type === C._switch ? "switch" : null, o = this.labels.length - 1; o >= 0; o--) {
		var c = this.labels[o];
		if (c.statementStart === e.start) c.statementStart = this.start, c.kind = u;
		else break;
	}
	...
	}), e.body = this.parseStatement(s ? s.indexOf("label") === -1 ? s + "label" : s : "label"), this.labels.pop(), e.label = n, this.finishNode(e, "LabeledStatement");
};
...
ue.parseVar = function(e, t, n, s) {
	for (e.declarations = [], e.kind = n;;) {
		...
		if (this.parseVarId(i, n), this.eat(C.eq) ? i.init = this.parseMaybeAssign(t) : !s && n === "const" && !(this.type === C._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) ? this.unexpected() : !s && i.id.type !== "Identifier" && !(t && (this.type === C._in || this.isContextual("of"))) ? this.raise(this.lastTokEnd, "Complex binding patterns require an initialization value") : i.init = null, e.declarations.push(this.finishNode(i, "VariableDeclarator")), !this.eat(C.comma)) break;
	}
	return e;
};
ue.parseVarId = function(e, t) {
	e.id = this.parseBindingAtom(), this.checkLValPattern(e.id, t === "var" ? xo : zn, !1);
};
var yi = 1, ru = 2, jM = 4;
...
ue.parseClass = function(e, t) {
	...
	var s = this.enterClassBody(), i = this.startNode(), r = !1;
	for (i.body = [], this.expect(C.braceL); this.type !== C.braceR;) {
		var a = this.parseClassElement(e.superClass !== null);
		a && (i.body.push(a), a.type === "MethodDefinition" && a.kind === "constructor" ? (r && this.raiseRecoverable(a.start, "Duplicate constructor in the same class"), r = !0) : a.key && a.key.type === "PrivateIdentifier" && Ow(s, a) && this.raiseRecoverable(a.key.start, "Identifier '#" + a.key.name + "' has already been declared"));
	}
...
ue.parseClassElement = function(e) {
	...
	var t = this.options.ecmaVersion, n = this.startNode(), s = "", i = !1, r = !1, a = "method", u = !1;
	if (this.eatContextual("static")) {
		if (t >= 13 && this.eat(C.braceL)) return this.parseClassStaticBlock(n), n;
		this.isClassElementNameStart() || this.type === C.star ? u = !0 : s = "static";
	}
	if (n.static = u, !s && t >= 8 && this.eatContextual("async") && ((this.isClassElementNameStart() || this.type === C.star) && !this.canInsertSemicolon() ? r = !0 : s = "async"), !s && (t >= 9 || !r) && this.eat(C.star) && (i = !0), !s && !r && !i) {
		var o = this.value;
		(this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? a = o : s = o);
	}
	if (s ? (n.computed = !1, n.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), n.key.name = s, this.finishNode(n.key, "Identifier")) : this.parseClassElementName(n), t < 13 || this.type === C.parenL || a !== "method" || i || r) {
...
ue.parseClassId = function(e, t) {
	this.type === C.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, zn, !1)) : (t === !0 && this.unexpected(), e.id = null);
};
...
ue.exitClassBody = function() {
	...
	if (this.options.checkPrivateFields) for (var s = this.privateNameStack.length, i = s === 0 ? null : this.privateNameStack[s - 1], r = 0; r < n.length; ++r) {
		var a = n[r];
...
function Ow(e, t) {
	...
	return t.type === "MethodDefinition" && (t.kind === "get" || t.kind === "set") && (i = (t.static ? "s" : "i") + t.kind), s === "iget" && i === "iset" || s === "iset" && i === "iget" || s === "sget" && i === "sset" || s === "sset" && i === "sget" ? (e[n] = "true", !1) : s ? !0 : (e[n] = i, !1);
}
function dr(e, t) {
...
ue.parseExportDefaultDeclaration = function() {
	...
	if (this.type === C._function || (e = this.isAsyncFunction())) {
		var t = this.startNode();
		return this.next(), e && this.next(), this.parseFunction(t, yi | jM, !1, e);
...
ue.checkExport = function(e, t, n) {
	e && (typeof t != "string" && (t = t.type === "Identifier" ? t.name : t.value), Hs(e, t) && this.raiseRecoverable(n, "Duplicate export '" + t + "'"), e[t] = !0);
};
ue.checkPatternExport = function(e, t) {
	var n = t.type;
	if (n === "Identifier") this.checkExport(e, t, t.start);
	else if (n === "ObjectPattern") for (var s = 0, i = t.properties; s < i.length; s += 1) {
		var r = i[s];
		this.checkPatternExport(e, r);
	}
	else if (n === "ArrayPattern") for (var a = 0, u = t.elements; a < u.length; a += 1) {
		var o = u[a];
...
ue.parseWithClause = function() {
	...
	for (var t = {}, n = !0; !this.eat(C.braceR);) {
		...
		Hs(t, i) && this.raiseRecoverable(s.key.start, "Duplicate attribute key '" + i + "'"), t[i] = !0, e.push(s);
	}
	return e;
};
...
Qt.parseBindingList = function(e, t, n, s) {
	for (var i = [], r = !0; !this.eat(e);) if (r ? r = !1 : this.expect(C.comma), t && this.type === C.comma) i.push(null);
	else {
		...
		if (this.type === C.ellipsis) {
			...
			break;
		} else i.push(this.parseAssignableListItem(s));
	}
	return i;
};
...
Qt.parseMaybeDefault = function(e, t, n) {
	if (n = n || this.parseBindingAtom(), this.options.ecmaVersion < 6 || !this.eat(C.eq)) return n;
...
Qt.checkLValSimple = function(e, t, n) {
	...
	switch (e.type) {
		case "Identifier":
			this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (s ? "Binding " : "Assigning to ") + e.name + " in strict mode"), s && (t === zn && e.name === "let" && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), n && (Hs(n, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), n[e.name] = !0), t !== KM && this.declareName(e.name, t, e.start));
			break;
		case "ChainExpression":
			this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
			break;
...
var nn = function(t, n, s, i, r) {
	...
	p_stat: new nn("(", !1),
	p_expr: new nn("(", !0),
	q_tmpl: new nn("`", !0, !0, function(e) {
		return e.tryReadTemplateToken();
	}),
	f_stat: new nn("function", !1),
	f_expr: new nn("function", !0),
	f_expr_gen: new nn("function", !0, !1, null, !0),
	f_gen: new nn("function", !1, !1, null, !0)
}, js = ht.prototype;
...
js.braceIsBlock = function(e) {
	...
	return t === it.f_expr || t === it.f_stat ? !0 : e === C.colon && (t === it.b_stat || t === it.b_expr) ? !t.isExpr : e === C._return || e === C.name && this.exprAllowed ? Jt.test(this.input.slice(this.lastTokEnd, this.start)) : e === C._else || e === C.semi || e === C.eof || e === C.parenR || e === C.arrow ? !0 : e === C.braceL ? t === it.b_stat : e === C._var || e === C._const || e === C.name ? !1 : !this.exprAllowed;
};
...
C.braceL.updateContext = function(e) {
	this.context.push(this.braceIsBlock(e) ? it.b_stat : it.b_expr), this.exprAllowed = !0;
};
...
C.parenL.updateContext = function(e) {
	...
	this.context.push(t ? it.p_stat : it.p_expr), this.exprAllowed = !0;
};
C.incDec.updateContext = function() {};
C._function.updateContext = C._class.updateContext = function(e) {
	e.beforeExpr && e !== C._else && !(e === C.semi && this.curContext() !== it.p_stat) && !(e === C._return && Jt.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === C.colon || e === C.braceL) && this.curContext() === it.b_stat) ? this.context.push(it.f_expr) : this.context.push(it.f_stat), this.exprAllowed = !1;
};
...
xe.checkPropClash = function(e, t, n) {
	if (!(this.options.ecmaVersion >= 9 && e.type === "SpreadElement") && !(this.options.ecmaVersion >= 6 && (e.computed || e.method || e.shorthand))) {
		...
		if (this.options.ecmaVersion >= 6) {
			i === "__proto__" && r === "init" && (t.proto && (n ? n.doubleProto < 0 && (n.doubleProto = s.start) : this.raiseRecoverable(s.start, "Redefinition of __proto__ property")), t.proto = !0);
			return;
		}
		i = "$" + i;
		var a = t[i];
...
xe.parseExpression = function(e, t) {
	...
	if (this.type === C.comma) {
		...
		for (r.expressions = [i]; this.eat(C.comma);) r.expressions.push(this.parseMaybeAssign(e, t));
...
xe.parseMaybeAssign = function(e, t, n) {
	...
	var s = !1, i = -1, r = -1, a = -1;
	t ? (i = t.parenthesizedAssign, r = t.trailingComma, a = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new Zr(), s = !0);
	...
	if (n && (c = n.call(this, c, u, o)), this.type.isAssign) {
		...
		return l.operator = this.value, this.type === C.eq && (c = this.toAssignable(c, !1, t)), s || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= c.start && (t.shorthandAssign = -1), this.type === C.eq ? this.checkLValPattern(c) : this.checkLValSimple(c), l.left = c, this.next(), l.right = this.parseMaybeAssign(e), a > -1 && (t.doubleProto = a), this.finishNode(l, "AssignmentExpression");
...
xe.parseExprOps = function(e, t) {
	var n = this.start, s = this.startLoc, i = this.parseMaybeUnary(t, !1, !1, e);
...
xe.parseExprOp = function(e, t, n, s, i) {
	...
	if (r != null && (!i || this.type !== C._in) && r > s) {
		...
		var o = this.value;
		this.next();
		var c = this.start, l = this.startLoc, p = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, i), c, l, r, i), m = this.buildBinary(t, n, e, p, o, a || u);
...
xe.parseMaybeUnary = function(e, t, n, s) {
	...
	if (this.isContextual("await") && this.canAwait) a = this.parseAwait(s), t = !0;
		...
		u.operator = this.value, u.prefix = !0, this.next(), u.argument = this.parseMaybeUnary(null, !0, o, s), this.checkExpressionErrors(e, !0), o ? this.checkLValSimple(u.argument) : this.strict && u.operator === "delete" && UM(u.argument) ? this.raiseRecoverable(u.start, "Deleting local variable in strict mode") : u.operator === "delete" && au(u.argument) ? this.raiseRecoverable(u.start, "Private fields can not be deleted") : t = !0, a = this.finishNode(u, o ? "UpdateExpression" : "UnaryExpression");
	} else if (!t && this.type === C.privateId) (s || this.privateNameStack.length === 0) && this.options.checkPrivateFields && this.unexpected(), a = this.parsePrivateIdent(), this.type !== C._in && this.unexpected();
	else {
	...
	else return this.buildBinary(i, r, a, this.parseMaybeUnary(null, !1, !1, s), "**", !1);
	else return a;
};
function UM(e) {
...
xe.parseExprSubscripts = function(e, t) {
	...
	var r = this.parseSubscripts(i, n, s, !1, t);
...
xe.parseSubscripts = function(e, t, n, s, i) {
	for (var r = this.options.ecmaVersion >= 8 && e.type === "Identifier" && e.name === "async" && this.lastTokEnd === e.end && !this.canInsertSemicolon() && e.end - e.start === 5 && this.potentialArrowAt === e.start, a = !1;;) {
...
xe.parseSubscript = function(e, t, n, s, i, r, a) {
	...
	if (c || o && this.type !== C.parenL && this.type !== C.backQuote || this.eat(C.dot)) {
		...
		var x = this.parseExprList(C.parenR, this.options.ecmaVersion >= 8, !1, p);
		if (i && !o && this.shouldParseAsyncArrow()) return this.checkPatternErrors(p, !1), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = m, this.awaitPos = g, this.awaitIdentPos = y, this.parseSubscriptAsyncArrow(t, n, x, a);
		this.checkExpressionErrors(p, !0), this.yieldPos = m || this.yieldPos, this.awaitPos = g || this.awaitPos, this.awaitIdentPos = y || this.awaitIdentPos;
...
xe.parseExprAtom = function(e, t, n) {
	...
	switch (this.type) {
		...
		case C._this: return s = this.startNode(), this.next(), this.finishNode(s, "ThisExpression");
		case C.name:
			var r = this.start, a = this.startLoc, u = this.containsEsc, o = this.parseIdent(!1);
			if (this.options.ecmaVersion >= 8 && !u && o.name === "async" && !this.canInsertSemicolon() && this.eat(C._function)) return this.overrideContext(it.f_expr), this.parseFunction(this.startNodeAt(r, a), 0, !1, !0, t);
			if (i && !this.canInsertSemicolon()) {
				if (this.eat(C.arrow)) return this.parseArrowExpression(this.startNodeAt(r, a), [o], !1, t);
				if (this.options.ecmaVersion >= 8 && o.name === "async" && this.type === C.name && !u && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) return o = this.parseIdent(!1), (this.canInsertSemicolon() || !this.eat(C.arrow)) && this.unexpected(), this.parseArrowExpression(this.startNodeAt(r, a), [o], !0, t);
			}
			return o;
		case C.regexp:
			var c = this.value;
		...
		case C._null:
		case C._true:
		case C._false: return s = this.startNode(), s.value = this.type === C._null ? null : this.type === C._true, s.raw = this.type.keyword, this.next(), this.finishNode(s, "Literal");
		case C.parenL:
		...
		case C.bracketL: return s = this.startNode(), this.next(), s.elements = this.parseExprList(C.bracketR, !0, !0, e), this.finishNode(s, "ArrayExpression");
		case C.braceL: return this.overrideContext(it.b_expr), this.parseObj(!1, e);
		case C._function: return s = this.startNode(), this.next(), this.parseFunction(s, 0);
...
xe.parseParenAndDistinguishExpression = function(e, t) {
	...
	if (this.options.ecmaVersion >= 6) {
		this.next();
		var a = this.start, u = this.startLoc, o = [], c = !0, l = !1, p = new Zr(), m = this.yieldPos, g = this.awaitPos, y;
		for (this.yieldPos = 0, this.awaitPos = 0; this.type !== C.parenR;) if (c ? c = !1 : this.expect(C.comma), r && this.afterTrailingComma(C.parenR, !0)) {
			l = !0;
			break;
		} else if (this.type === C.ellipsis) {
			y = this.start, o.push(this.parseParenItem(this.parseRestBinding())), this.type === C.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element");
			break;
		} else o.push(this.parseMaybeAssign(!1, p, this.parseParenItem));
		var x = this.lastTokEnd, v = this.lastTokEndLoc;
		if (this.expect(C.parenR), e && this.shouldParseArrow(o) && this.eat(C.arrow)) return this.checkPatternErrors(p, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = m, this.awaitPos = g, this.parseParenArrowList(n, s, o, t);
		(!o.length || l) && this.unexpected(this.lastTokStart), y && this.unexpected(y), this.checkExpressionErrors(p, !0), this.yieldPos = m || this.yieldPos, this.awaitPos = g || this.awaitPos, o.length > 1 ? (i = this.startNodeAt(a, u), i.expressions = o, this.finishNodeAt(i, "SequenceExpression", x, v)) : i = o[0];
...
xe.parseNew = function() {
	...
	return e.callee = this.parseSubscripts(this.parseExprAtom(null, !1, !0), s, i, !0, !1), this.eat(C.parenL) ? e.arguments = this.parseExprList(C.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = Jw, this.finishNode(e, "NewExpression");
};
...
xe.parseTemplate = function(e) {
	...
	for (n.quasis = [s]; !s.tail;) this.type === C.eof && this.raise(this.pos, "Unterminated template literal"), this.expect(C.dollarBraceL), n.expressions.push(this.parseExpression()), this.expect(C.braceR), n.quasis.push(s = this.parseTemplateElement({ isTagged: t }));
...
xe.parseProperty = function(e, t) {
	...
	this.options.ecmaVersion >= 6 && (n.method = !1, n.shorthand = !1, (e || t) && (r = this.start, a = this.startLoc), e || (s = this.eat(C.star)));
	var u = this.containsEsc;
	return this.parsePropertyName(n), !e && !u && this.options.ecmaVersion >= 8 && !s && this.isAsyncProp(n) ? (i = !0, s = this.options.ecmaVersion >= 9 && this.eat(C.star), this.parsePropertyName(n)) : i = !1, this.parsePropertyValue(n, e, s, i, r, a, t, u), this.finishNode(n, "Property");
};
...
xe.parseMethod = function(e, t, n) {
	...
	return this.initFunction(s), this.options.ecmaVersion >= 6 && (s.generator = e), this.options.ecmaVersion >= 8 && (s.async = !!t), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(Co(t, s.generator) | bo | (n ? _M : 0)), this.expect(C.parenL), s.params = this.parseBindingList(C.parenR, !1, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(s, !1, !0, !1), this.yieldPos = i, this.awaitPos = r, this.awaitIdentPos = a, this.finishNode(s, "FunctionExpression");
};
xe.parseArrowExpression = function(e, t, n, s) {
	var i = this.yieldPos, r = this.awaitPos, a = this.awaitIdentPos;
	return this.enterScope(Co(n, !1) | TM), this.initFunction(e), this.options.ecmaVersion >= 8 && (e.async = !!n), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, e.params = this.toAssignableList(t, !0), this.parseFunctionBody(e, !0, !1, s), this.yieldPos = i, this.awaitPos = r, this.awaitIdentPos = a, this.finishNode(e, "ArrowFunctionExpression");
};
xe.parseFunctionBody = function(e, t, n, s) {
	var i = t && this.type !== C.braceL, r = this.strict, a = !1;
	if (i) e.body = this.parseMaybeAssign(s), e.expression = !0, this.checkParams(e, !1);
	else {
		...
		var o = this.labels;
		this.labels = [], a && (this.strict = !0), this.checkParams(e, !r && !a && !t && !n && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, KM), e.body = this.parseBlock(!1, void 0, a && !r), e.expression = !1, this.adaptDirectivePrologue(e.body.body), this.labels = o;
	}
	this.exitScope();
};
...
hr.curPosition = function() {
	if (this.options.locations) return new Xi(this.curLine, this.pos - this.lineStart);
};
var $n = ht.prototype, Qw = function(t) {
...
$n.declareName = function(e, t, n) {
	...
	if (t === zn) {
	...
	} else if (t === HM) this.currentScope().lexical.push(e);
	else if (t === YM) {
		...
		if (o.var.push(e), this.inModule && o.flags & Di && delete this.undefinedExports[e], o.flags & Mo) break;
	}
...
$n.currentVarScope = function() {
	for (var e = this.scopeStack.length - 1;; e--) {
		var t = this.scopeStack[e];
		if (t.flags & Mo) return t;
	}
};
$n.currentThisScope = function() {
	for (var e = this.scopeStack.length - 1;; e--) {
		var t = this.scopeStack[e];
		if (t.flags & Mo && !(t.flags & TM)) return t;
	}
};
...
var qw = "Gara Garay Gukh Gurung_Khema Hrkt Katakana_Or_Hiragana Kawi Kirat_Rai Krai Nag_Mundari Nagm Ol_Onal Onao Sunu Sunuwar Todhri Todr Tulu_Tigalari Tutg Unknown Zzzz", JM = "ASCII ASCII_Hex_Digit AHex Alphabetic Alpha Any Assigned Bidi_Control Bidi_C Bidi_Mirrored Bidi_M Case_Ignorable CI Cased Changes_When_Casefolded CWCF Changes_When_Casemapped CWCM Changes_When_Lowercased CWL Changes_When_NFKC_Casefolded CWKCF Changes_When_Titlecased CWT Changes_When_Uppercased CWU Dash Default_Ignorable_Code_Point DI Deprecated Dep Diacritic Dia Emoji Emoji_Component Emoji_Modifier Emoji_Modifier_Base Emoji_Presentation Extender Ext Grapheme_Base Gr_Base Grapheme_Extend Gr_Ext Hex_Digit Hex IDS_Binary_Operator IDSB IDS_Trinary_Operator IDST ID_Continue IDC ID_Start IDS Ideographic Ideo Join_Control Join_C Logical_Order_Exception LOE Lowercase Lower Math Noncharacter_Code_Point NChar Pattern_Syntax Pat_Syn Pattern_White_Space Pat_WS Quotation_Mark QMark Radical Regional_Indicator RI Sentence_Terminal STerm Soft_Dotted SD Terminal_Punctuation Term Unified_Ideograph UIdeo Uppercase Upper Variation_Selector VS White_Space space XID_Continue XIDC XID_Start XIDS", QM = JM + " Extended_Pictographic", qM = QM, $M = qM + " EBase EComp EMod EPres ExtPict", e3 = $M, eZ = {
	9: JM,
	10: QM,
	11: qM,
	12: $M,
...
var ne = ht.prototype, pr = function(t, n) {
	this.parent = t, this.base = n || this;
};
pr.prototype.separatedFrom = function(t) {
	for (var n = this; n; n = n.parent) for (var s = t; s; s = s.parent) if (n.base === s.base && n !== s) return !0;
	return !1;
};
...
An.prototype.reset = function(t, n, s) {
	...
	this.start = t | 0, this.source = n + "", this.flags = s, i && this.parser.options.ecmaVersion >= 15 ? (this.switchU = !0, this.switchV = !0, this.switchN = !0) : (this.switchU = r && this.parser.options.ecmaVersion >= 6, this.switchV = !1, this.switchN = r && this.parser.options.ecmaVersion >= 9);
};
...
An.prototype.at = function(t, n) {
	...
	if (!(n || this.switchU) || r <= 55295 || r >= 57344 || t + 1 >= i) return r;
...
ne.validateRegExpFlags = function(e) {
	for (var t = e.validFlags, n = e.flags, s = !1, i = !1, r = 0; r < n.length; r++) {
		var a = n.charAt(r);
		t.indexOf(a) === -1 && this.raise(e.start, "Invalid regular expression flag"), n.indexOf(a, r + 1) > -1 && this.raise(e.start, "Duplicate regular expression flag"), a === "u" && (s = !0), a === "v" && (i = !0);
	}
...
ne.validateRegExpPattern = function(e) {
	this.regexp_pattern(e), !e.switchN && this.options.ecmaVersion >= 9 && uZ(e.groupNames) && (e.switchN = !0, this.regexp_pattern(e));
};
...
ne.regexp_disjunction = function(e) {
	...
	for (t && (e.branchID = new pr(e.branchID, null)), this.regexp_alternative(e); e.eat(124);) t && (e.branchID = e.branchID.sibling()), this.regexp_alternative(e);
...
ne.regexp_eatBracedQuantifier = function(e, t) {
	...
	if (e.eat(123)) {
		var s = 0, i = -1;
		if (this.regexp_eatDecimalDigits(e) && (s = e.lastIntValue, e.eat(44) && this.regexp_eatDecimalDigits(e) && (i = e.lastIntValue), e.eat(125))) return i !== -1 && i < s && !t && e.raise("numbers out of order in {} quantifier"), !0;
...
ne.regexp_eatModifiers = function(e) {
	for (var t = "", n = 0; (n = e.current()) !== -1 && oZ(n);) t += Vn(n), e.advance();
	return t;
};
function oZ(e) {
...
ne.regexp_eatSyntaxCharacter = function(e) {
	var t = e.current();
	return u3(t) ? (e.lastIntValue = t, e.advance(), !0) : !1;
};
function u3(e) {
	return e === 36 || e >= 40 && e <= 43 || e === 46 || e === 63 || e >= 91 && e <= 94 || e >= 123 && e <= 125;
}
ne.regexp_eatPatternCharacters = function(e) {
	for (var t = e.pos, n = 0; (n = e.current()) !== -1 && !u3(n);) e.advance();
	return e.pos !== t;
};
...
ne.regexp_groupSpecifier = function(e) {
	if (e.eat(63)) {
		...
		if (n) if (t) for (var s = 0, i = n; s < i.length; s += 1) i[s].separatedFrom(e.branchID) || e.raise("Duplicate capture group name");
...
ne.regexp_eatRegExpIdentifierName = function(e) {
	if (e.lastStringValue = "", this.regexp_eatRegExpIdentifierStart(e)) {
		for (e.lastStringValue += Vn(e.lastIntValue); this.regexp_eatRegExpIdentifierPart(e);) e.lastStringValue += Vn(e.lastIntValue);
		return !0;
	}
	return !1;
};
ne.regexp_eatRegExpIdentifierStart = function(e) {
	...
	return e.advance(n), s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, n) && (s = e.lastIntValue), cZ(s) ? (e.lastIntValue = s, !0) : (e.pos = t, !1);
};
function cZ(e) {
...
ne.regexp_eatRegExpIdentifierPart = function(e) {
	var t = e.pos, n = this.options.ecmaVersion >= 11, s = e.current(n);
	return e.advance(n), s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, n) && (s = e.lastIntValue), lZ(s) ? (e.lastIntValue = s, !0) : (e.pos = t, !1);
};
function lZ(e) {
	return ks(e, !0) || e === 36 || e === 95 || e === 8204 || e === 8205;
}
...
ne.regexp_eatZero = function(e) {
	return e.current() === 48 && !Lr(e.lookahead()) ? (e.lastIntValue = 0, e.advance(), !0) : !1;
};
...
ne.regexp_eatControlLetter = function(e) {
	var t = e.current();
	return o3(t) ? (e.lastIntValue = t % 32, e.advance(), !0) : !1;
};
function o3(e) {
		...
		if (this.regexp_eatFixedHexDigits(e, 4)) {
			...
			if (s && i >= 55296 && i <= 56319) {
				...
				if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
					...
					if (a >= 56320 && a <= 57343) return e.lastIntValue = (i - 55296) * 1024 + (a - 56320) + 65536, !0;
				}
				e.pos = r, e.lastIntValue = i;
			}
			return !0;
		}
		if (s && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && dZ(e.lastIntValue)) return !0;
...
ne.regexp_eatCharacterClassEscape = function(e) {
	var t = e.current();
	if (hZ(t)) return e.lastIntValue = -1, e.advance(), kn;
	var n = !1;
	if (e.switchU && this.options.ecmaVersion >= 9 && ((n = t === 80) || t === 112)) {
		e.lastIntValue = -1, e.advance();
		var s;
		if (e.eat(123) && (s = this.regexp_eatUnicodePropertyValueExpression(e)) && e.eat(125)) return n && s === jt && e.raise("Invalid property name"), s;
...
ne.regexp_validateUnicodePropertyNameOrValue = function(e, t) {
	...
	if (e.switchV && e.unicodeProperties.binaryOfStrings.test(t)) return jt;
	e.raise("Invalid property name");
};
ne.regexp_eatUnicodePropertyName = function(e) {
	var t = 0;
	for (e.lastStringValue = ""; l3(t = e.current());) e.lastStringValue += Vn(t), e.advance();
...
ne.regexp_eatUnicodePropertyValue = function(e) {
	var t = 0;
	for (e.lastStringValue = ""; pZ(t = e.current());) e.lastStringValue += Vn(t), e.advance();
	return e.lastStringValue !== "";
};
function pZ(e) {
	return l3(e) || Lr(e);
...
ne.regexp_eatCharacterClass = function(e) {
	if (e.eat(91)) {
		...
		return e.eat(93) || e.raise("Unterminated character class"), t && n === jt && e.raise("Negated character class may contain strings"), !0;
	}
	return !1;
};
...
ne.regexp_eatClassSetRange = function(e) {
	...
	if (this.regexp_eatClassSetCharacter(e)) {
		...
		if (e.eat(45) && this.regexp_eatClassSetCharacter(e)) {
			...
			return n !== -1 && s !== -1 && n > s && e.raise("Range out of order in character class"), !0;
		}
		e.pos = t;
	}
	return !1;
...
ne.regexp_eatNestedClass = function(e) {
	...
	if (e.eat(91)) {
		...
		if (e.eat(93)) return n && s === jt && e.raise("Negated character class may contain strings"), s;
		e.pos = t;
	}
	if (e.eat(92)) {
...
ne.regexp_classStringDisjunctionContents = function(e) {
	for (var t = this.regexp_classString(e); e.eat(124);) this.regexp_classString(e) === jt && (t = jt);
	return t;
};
...
ne.regexp_eatClassSetCharacter = function(e) {
	...
	var n = e.current();
	return n < 0 || n === e.lookahead() && mZ(n) || fZ(n) ? !1 : (e.advance(), e.lastIntValue = n, !0);
};
function mZ(e) {
...
ne.regexp_eatClassSetReservedPunctuator = function(e) {
	var t = e.current();
	return yZ(t) ? (e.lastIntValue = t, e.advance(), !0) : !1;
};
function yZ(e) {
...
ne.regexp_eatClassControlLetter = function(e) {
	var t = e.current();
	return Lr(t) || t === 95 ? (e.lastIntValue = t % 32, e.advance(), !0) : !1;
};
...
ne.regexp_eatDecimalDigits = function(e) {
	var t = e.pos, n = 0;
	for (e.lastIntValue = 0; Lr(n = e.current());) e.lastIntValue = 10 * e.lastIntValue + (n - 48), e.advance();
	return e.pos !== t;
};
function Lr(e) {
	return e >= 48 && e <= 57;
...
ne.regexp_eatHexDigits = function(e) {
	var t = e.pos, n = 0;
	for (e.lastIntValue = 0; d3(n = e.current());) e.lastIntValue = 16 * e.lastIntValue + h3(n), e.advance();
	return e.pos !== t;
};
function d3(e) {
...
ne.regexp_eatOctalDigit = function(e) {
	var t = e.current();
	return p3(t) ? (e.lastIntValue = t - 48, e.advance(), !0) : (e.lastIntValue = 0, !1);
};
function p3(e) {
	return e >= 48 && e <= 55;
}
...
Be.skipBlockComment = function() {
	...
	if (n === -1 && this.raise(this.pos - 2, "Unterminated comment"), this.pos = n + 2, this.options.locations) for (var s = void 0, i = t; (s = VM(this.input, i, this.pos)) > -1;) ++this.curLine, i = this.lineStart = s;
...
Be.skipLineComment = function(e) {
	for (var t = this.pos, n = this.options.onComment && this.curPosition(), s = this.input.charCodeAt(this.pos += e); this.pos < this.input.length && !Ys(s);) s = this.input.charCodeAt(++this.pos);
	...
	e: for (; this.pos < this.input.length;) {
		...
		switch (e) {
			...
			case 47:
				...
				break;
			default: if (e > 8 && e < 14 || e >= 5760 && kM.test(String.fromCharCode(e))) ++this.pos;
			else break e;
		}
	}
};
...
Be.readToken_pipe_amp = function(e) {
	...
	if (t === e) {
		if (this.options.ecmaVersion >= 12) {
			if (this.input.charCodeAt(this.pos + 2) === 61) return this.finishOp(C.assign, 3);
		}
...
Be.readToken_numberSign = function() {
	...
	if (e >= 13 && (++this.pos, t = this.fullCharCodeAtPos(), Bn(t, !0) || t === 92)) return this.finishToken(C.privateId, this.readWord1());
...
Be.readRegexp = function() {
	for (var e, t, n = this.pos;;) {
		...
		if (Jt.test(s) && this.raise(n, "Unterminated regular expression"), e) e = !1;
		else {
			if (s === "[") t = !0;
			else if (s === "]" && t) t = !1;
			else if (s === "/" && !t) break;
...
Be.readInt = function(e, t, n) {
	for (var s = this.options.ecmaVersion >= 12 && t === void 0, i = n && this.input.charCodeAt(this.pos) === 48, r = this.pos, a = 0, u = 0, o = 0, c = t ?? Infinity; o < c; ++o, ++this.pos) {
		...
		if (l >= 97 ? p = l - 97 + 10 : l >= 65 ? p = l - 65 + 10 : l >= 48 && l <= 57 ? p = l - 48 : p = Infinity, p >= e) break;
		u = l, a = a * e + p;
	}
...
Be.readRadixNumber = function(e) {
	...
	return n ?? this.raise(this.start + 2, "Expected number in radix " + e), this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110 ? (n = m3(this.input.slice(t, this.pos)), ++this.pos) : Bn(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(C.num, n);
};
Be.readNumber = function(e) {
	...
	n && /[89]/.test(this.input.slice(t, this.pos)) && (n = !1), s === 46 && !n && (++this.pos, this.readInt(10), s = this.input.charCodeAt(this.pos)), (s === 69 || s === 101) && !n && (s = this.input.charCodeAt(++this.pos), (s === 43 || s === 45) && ++this.pos, this.readInt(10) === null && this.raise(t, "Invalid number")), Bn(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
...
Be.readString = function(e) {
	for (var t = "", n = ++this.pos;;) {
		...
		var s = this.input.charCodeAt(this.pos);
		if (s === e) break;
		s === 92 ? (t += this.input.slice(n, this.pos), t += this.readEscapedChar(!1), n = this.pos) : s === 8232 || s === 8233 ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (Ys(s) && this.raise(this.start, "Unterminated string constant"), ++this.pos);
	}
...
Be.tryReadTemplateToken = function() {
	...
	try {
		...
		if (e === f3) this.readInvalidTemplateToken();
		else throw e;
	}
	this.inTemplateElement = !1;
};
Be.invalidStringToken = function(e, t) {
	if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw f3;
	this.raise(e, t);
};
...
`;
		...
		case 117: return Vn(this.readCodePoint());
		case 116: return "	";
		case 98: return "\b";
		case 118: return "\v";
		case 102: return "\f";
		...
		default:
			if (t >= 48 && t <= 55) {
				...
				return i > 255 && (s = s.slice(0, -1), i = parseInt(s, 8)), this.pos += s.length - 1, t = this.input.charCodeAt(this.pos), (s !== "0" || t === 56 || t === 57) && (this.strict || e) && this.invalidStringToken(this.pos - 1 - s.length, e ? "Octal literal in template string" : "Octal literal in strict mode"), String.fromCharCode(i);
			}
...
Be.readWord1 = function() {
	...
	for (var e = "", t = !0, n = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
		...
		if (ks(i, s)) this.pos += i <= 65535 ? 1 : 2;
		else if (i === 92) {
...
function GZ() {
	return Ic || (Ic = 1, function(e) {
		(function t(n) {
			...
			function c(X) {
				var Z = {}, L, R;
				for (L in X) X.hasOwnProperty(L) && (R = X[L], typeof R == "object" && R !== null ? Z[L] = c(R) : Z[L] = R);
				return Z;
			}
			function l(X, Z) {
				var L, R, H, z;
				for (R = X.length, H = 0; R;) L = R >>> 1, z = H + L, Z(X[z]) ? R = L : (H = z + 1, R -= L + 1);
				return H;
			}
			s = {
			...
			g.prototype.path = function() {
				var Z, L, R, H, z, $;
				function I(Y, ee) {
					if (Array.isArray(ee)) for (R = 0, H = ee.length; R < H; ++R) Y.push(ee[R]);
					else Y.push(ee);
				}
				if (!this.__current.path) return null;
				for (z = [], Z = 2, L = this.__leavelist.length; Z < L; ++Z) $ = this.__leavelist[Z], I(z, $.path);
				return I(z, this.__current.path), z;
			}, g.prototype.type = function() {
				return this.current().type || this.__current.wrap;
			}, g.prototype.parents = function() {
				var Z, L, R;
				for (R = [], Z = 1, L = this.__leavelist.length; Z < L; ++Z) R.push(this.__leavelist[Z].node);
				return R;
			...
			function v(X, Z) {
				for (var L = X.length - 1; L >= 0; --L) if (X[L].node === Z) return !0;
				return !1;
			}
			g.prototype.traverse = function(Z, L) {
				...
				for (this.__initialize(Z, L), Ie = {}, R = this.__worklist, H = this.__leavelist, R.push(new m(Z, null, null, null)), H.push(new m(null, null, null, null)); R.length;) {
					if (z = R.pop(), z === Ie) {
						if (z = H.pop(), Y = this.__execute(L.leave, z), this.__state === a || Y === a) return;
						continue;
					}
					if (z.node) {
						if (Y = this.__execute(L.enter, z), this.__state === a || Y === a) return;
						if (R.push(Ie), H.push(z), this.__state === u || Y === u) continue;
						if ($ = z.node, I = $.type || z.wrap, de = this.__keys[I], !de) if (this.__fallback) de = this.__fallback($);
						else throw new Error("Unknown node type " + I + ".");
						for (Me = de.length; (Me -= 1) >= 0;) if (ee = de[Me], se = $[ee], !!se) {
							if (Array.isArray(se)) {
								for (re = se.length; (re -= 1) >= 0;) if (se[re] && !v(H, se[re])) {
									if (x(I, de[Me])) z = new m(se[re], [ee, re], "Property", null);
									else if (y(se[re])) z = new m(se[re], [ee, re], null, null);
									else continue;
									R.push(z);
								}
							} else if (y(se)) {
				...
				function dt(O) {
					var at, he, Ge, Ce;
					if (O.ref.remove()) {
						for (he = O.ref.key, Ce = O.ref.parent, at = R.length; at--;) if (Ge = R[at], Ge.ref && Ge.ref.parent === Ce) {
							if (Ge.ref.key < he) break;
							--Ge.ref.key;
						}
					}
				}
				for (this.__initialize(Z, L), se = {}, R = this.__worklist, H = this.__leavelist, Ie = { root: Z }, Y = new m(Z, null, null, new p(Ie, "root")), R.push(Y), H.push(Y); R.length;) {
					if (Y = R.pop(), Y === se) {
						if (Y = H.pop(), I = this.__execute(L.leave, Y), I !== void 0 && I !== a && I !== u && I !== o && Y.ref.replace(I), (this.__state === o || I === o) && dt(Y), this.__state === a || I === a) return Ie.root;
						continue;
					}
					if (I = this.__execute(L.enter, Y), I !== void 0 && I !== a && I !== u && I !== o && (Y.ref.replace(I), Y.node = I), (this.__state === o || I === o) && (dt(Y), Y.node = null), this.__state === a || I === a) return Ie.root;
					if (z = Y.node, !!z && (R.push(se), H.push(Y), !(this.__state === u || I === u))) {
						if ($ = z.type || Y.wrap, re = this.__keys[$], !re) if (this.__fallback) re = this.__fallback(z);
						else throw new Error("Unknown node type " + $ + ".");
						for (ee = re.length; (ee -= 1) >= 0;) if (rt = re[ee], de = z[rt], !!de) if (Array.isArray(de)) {
							for (Me = de.length; (Me -= 1) >= 0;) if (de[Me]) {
								if (x($, re[ee])) Y = new m(de[Me], [rt, Me], "Property", new p(de, Me));
								else if (y(de[Me])) Y = new m(de[Me], [rt, Me], null, new p(de, Me));
								else continue;
								R.push(Y);
							}
			...
			function E(X, Z) {
				return new g().traverse(X, Z);
			}
			function w(X, Z) {
				return new g().replace(X, Z);
			}
			function V(X, Z) {
				var L;
			...
			function D(X, Z, L) {
				...
				if (!L.length) {
					if (Z.length) {
						for ($ = 0, z = Z.length; $ < z; $ += 1) H = c(Z[$]), H.extendedRange = [0, X.range[0]], R.push(H);
						X.leadingComments = R;
					}
					return X;
				}
				for ($ = 0, z = Z.length; $ < z; $ += 1) R.push(V(c(Z[$]), L));
				return I = 0, E(X, { enter: function(Y) {
					for (var ee; I < R.length && (ee = R[I], !(ee.extendedRange[1] > Y.range[0]));) ee.extendedRange[1] === Y.range[0] ? (Y.leadingComments || (Y.leadingComments = []), Y.leadingComments.push(ee), R.splice(I, 1)) : I += 1;
					if (I === R.length) return i.Break;
					if (R[I].extendedRange[0] > Y.range[1]) return i.Skip;
				} }), I = 0, E(X, { leave: function(Y) {
					for (var ee; I < R.length && (ee = R[I], !(Y.range[1] < ee.extendedRange[0]));) Y.range[1] === ee.extendedRange[0] ? (Y.trailingComments || (Y.trailingComments = []), Y.trailingComments.push(ee), R.splice(I, 1)) : I += 1;
					if (I === R.length) return i.Break;
					if (R[I].extendedRange[0] > Y.range[1]) return i.Skip;
				} }), X;
			}
...
function vZ() {
	return _c || (_c = 1, function() {
		...
		function i(a) {
			switch (a.type) {
				case "IfStatement": return a.alternate != null ? a.alternate : a.consequent;
				case "LabeledStatement":
				case "ForStatement":
				case "ForInStatement":
				case "WhileStatement":
				case "WithStatement": return a.body;
			}
			return null;
		}
		function r(a) {
...
function g3() {
	return Yc || (Yc = 1, function() {
		...
		function p(v) {
			...
			return String.fromCharCode(Math.floor((v - 65536) / 1024) + 55296) + String.fromCharCode((v - 65536) % 1024 + 56320);
		}
		for (s = new Array(128), r = 0; r < 128; ++r) s[r] = r >= 97 && r <= 122 || r >= 65 && r <= 90 || r === 36 || r === 95;
		for (i = new Array(128), r = 0; r < 128; ++r) i[r] = r >= 97 && r <= 122 || r >= 65 && r <= 90 || r >= 48 && r <= 57 || r === 36 || r === 95;
		function m(v) {
...
function PZ() {
	return Hc || (Hc = 1, function() {
		...
		function n(m, g) {
			return !g && m === "yield" ? !1 : s(m, g);
		}
		function s(m, g) {
			if (g && t(m)) return !0;
			switch (m.length) {
				case 2: return m === "if" || m === "in" || m === "do";
				case 3: return m === "var" || m === "for" || m === "new" || m === "try";
				case 4: return m === "this" || m === "else" || m === "case" || m === "void" || m === "with" || m === "enum";
				case 5: return m === "while" || m === "break" || m === "catch" || m === "throw" || m === "const" || m === "yield" || m === "class" || m === "super";
				case 6: return m === "return" || m === "typeof" || m === "delete" || m === "switch" || m === "export" || m === "import";
				case 7: return m === "default" || m === "finally" || m === "extends";
				case 8: return m === "function" || m === "continue" || m === "debugger";
				case 10: return m === "instanceof";
				default: return !1;
			}
		}
		function i(m, g) {
		...
		function u(m) {
			var g, y, x;
			if (m.length === 0 || (x = m.charCodeAt(0), !e.isIdentifierStartES5(x))) return !1;
			for (g = 1, y = m.length; g < y; ++g) if (x = m.charCodeAt(g), !e.isIdentifierPartES5(x)) return !1;
			return !0;
		}
		function o(m, g) {
		...
		function c(m) {
			...
			for (E = e.isIdentifierStartES6, g = 0, y = m.length; g < y; ++g) {
				if (x = m.charCodeAt(g), 55296 <= x && x <= 56319) {
					if (++g, g >= y || (v = m.charCodeAt(g), !(56320 <= v && v <= 57343))) return !1;
					x = o(x, v);
				}
				if (!E(x)) return !1;
...
function FZ() {
	...
	return $i.encode = function(t) {
		...
		var n = 65, s = 90, i = 97, r = 122, a = 48;
		return n <= t && t <= s ? t - n : i <= t && t <= r ? t - i + 26 : a <= t && t <= 57 ? t - a + 52 : t == 43 ? 62 : t == 47 ? 63 : -1;
	}, $i;
}
var Uc;
function b3() {
	...
	return qi.encode = function(o) {
		...
		do {
			if (c >= p) throw new Error("Expected more digits in base 64 VLQ value.");
			if (x = e.decode(o.charCodeAt(c++)), x === -1) throw new Error("Invalid base64 digit: " + o.charAt(c - 1));
...
function ki() {
	return Oc || (Oc = 1, function(e) {
		function t(D, X, Z) {
			...
			if (arguments.length === 3) return Z;
		...
		function a(D) {
			...
			for (var L = e.isAbsolute(X), R = X.split(/\/+/), H, z = 0, $ = R.length - 1; $ >= 0; $--) H = R[$], H === "." ? R.splice($, 1) : H === ".." ? z++ : z > 0 && (H === "" ? (R.splice($ + 1, z), z = 0) : (R.splice($, 2), z--));
		...
		function u(D, X) {
			D === "" && (D = "."), X === "" && (X = ".");
			var Z = i(X), L = i(D);
			if (L && (D = L.path || "/"), Z && !Z.scheme) return L && (Z.scheme = L.scheme), r(Z);
			if (Z || X.match(s)) return X;
			if (L && !L.host && !L.path) return L.host = X, r(L);
		...
		function o(D, X) {
			...
			for (var Z = 0; X.indexOf(D + "/") !== 0;) {
				var L = D.lastIndexOf("/");
				if (L < 0 || (D = D.slice(0, L), D.match(/^([^\/]+:\/)?\/*$/))) return X;
				++Z;
			}
		...
		function g(D) {
			if (!D) return !1;
			var X = D.length;
			if (X < 9 || D.charCodeAt(X - 1) !== 95 || D.charCodeAt(X - 2) !== 95 || D.charCodeAt(X - 3) !== 111 || D.charCodeAt(X - 4) !== 116 || D.charCodeAt(X - 5) !== 111 || D.charCodeAt(X - 6) !== 114 || D.charCodeAt(X - 7) !== 112 || D.charCodeAt(X - 8) !== 95 || D.charCodeAt(X - 9) !== 95) return !1;
			for (var Z = X - 10; Z >= 0; Z--) if (D.charCodeAt(Z) !== 36) return !1;
			return !0;
		}
		function y(D, X, Z) {
		...
		function V(D, X, Z) {
			if (X = X || "", D && (D[D.length - 1] !== "/" && X[0] !== "/" && (D += "/"), X = D + X), Z) {
				var L = i(Z);
				if (!L) throw new Error("sourceMapURL could not be parsed");
				if (L.path) {
...
function M3() {
	...
	return s.fromArray = function(r, a) {
		for (var u = new s(), o = 0, c = r.length; o < c; o++) u.add(r[o], a);
		return u;
		...
		if (n) {
			...
			if (t.call(this._set, u)) return this._set[u];
		}
...
function C3() {
	...
	function i(r) {
		r || (r = {}), this._file = t.getArg(r, "file", null), this._sourceRoot = t.getArg(r, "sourceRoot", null), this._skipValidation = t.getArg(r, "skipValidation", !1), this._sources = new n(), this._names = new n(), this._mappings = new s(), this._sourcesContents = null;
	}
	return i.prototype._version = 3, i.fromSourceMap = function(a) {
		...
		var c = u;
		if (u == null) {
			if (a.file == null) throw new Error(`SourceMapGenerator.prototype.applySourceMap requires either an explicit source file, or the source map's "file" property. Both were omitted.`);
			c = a.file;
		}
		...
		if (u && typeof u.line != "number" && typeof u.column != "number") throw new Error("original.line and original.column are not numbers -- you probably meant to omit the original mapping entirely and only map the generated position. If so, pass null for the original mapping instead of an object with empty or null values.");
		if (!(a && "line" in a && "column" in a && a.line > 0 && a.column >= 0 && !u && !o && !c)) {
			if (a && "line" in a && "column" in a && u && "line" in u && "column" in u && a.line > 0 && a.column >= 0 && u.line > 0 && u.column >= 0 && o) return;
		...
		for (var a = 0, u = 1, o = 0, c = 0, l = 0, p = 0, m = "", g, y, x, v, E = this._mappings.toArray(), w = 0, V = E.length; w < V; w++) {
			if (y = E[w], g = "", y.generatedLine !== u) for (a = 0; y.generatedLine !== u;) g += ";", u++;
			else if (w > 0) {
				if (!t.compareByGeneratedPositionsInflated(y, E[w - 1])) continue;
				g += ",";
			}
...
function DZ() {
	return $c || ($c = 1, function(e) {
		...
		function t(n, s, i, r, a, u) {
			var o = Math.floor((s - n) / 2) + n, c = a(i, r[o], !0);
		...
		e.search = function(s, i, r, a) {
			...
			var u = t(-1, i.length, s, i, r, a || e.GREATEST_LOWER_BOUND);
			if (u < 0) return -1;
			for (; u - 1 >= 0 && r(i[u], i[u - 1], !0) === 0;) --u;
			return u;
		};
	}(Pa)), Pa;
}
...
function SZ() {
	...
	function n(s, i, r, a) {
		if (r < a) {
			var u = t(r, a), o = r - 1;
			e(s, u, a);
			for (var c = s[a], l = r; l < a; l++) i(s[l], c) <= 0 && (o += 1, e(s, o, l));
			e(s, o + 1, l);
			var p = o + 1;
...
function wZ() {
	...
	r.fromSourceMap = function(c, l) {
		...
		var g = [], y = this._findMapping(m, this._originalMappings, "originalLine", "originalColumn", e.compareByOriginalPositions, t.LEAST_UPPER_BOUND);
		if (y >= 0) {
			var x = this._originalMappings[y];
			if (l.column === void 0) for (var v = x.originalLine; x && x.originalLine === v;) g.push({
			...
			else for (var E = x.originalColumn; x && x.originalLine === p && x.originalColumn == E;) g.push({
				line: e.getArg(x, "generatedLine", null),
				column: e.getArg(x, "generatedColumn", null),
				lastColumn: e.getArg(x, "lastGeneratedColumn", null)
			}), x = this._originalMappings[++y];
	...
	function a(c, l) {
		...
		if (m != this._version) throw new Error("Unsupported version: " + m);
		x && (x = e.normalize(x)), g = g.map(String).map(e.normalize).map(function(V) {
			return x && e.isAbsolute(x) && e.isAbsolute(V) ? e.relative(x, V) : V;
		}), this._names = n.fromArray(y.map(String), !0), this._sources = n.fromArray(g, !0), this._absoluteSources = this._sources.toArray().map(function(V) {
	...
	a.prototype = Object.create(r.prototype), a.prototype.consumer = r, a.prototype._findSourceIndex = function(c) {
		var l = c;
		if (this.sourceRoot != null && (l = e.relative(this.sourceRoot, l)), this._sources.has(l)) return this._sources.indexOf(l);
		var p;
		for (p = 0; p < this._absoluteSources.length; ++p) if (this._absoluteSources[p] == c) return p;
		return -1;
	}, a.fromSourceMap = function(l, p) {
		var m = Object.create(a.prototype), g = m._names = n.fromArray(l._names.toArray(), !0), y = m._sources = n.fromArray(l._sources.toArray(), !0);
		m.sourceRoot = l._sourceRoot, m.sourcesContent = l._generateSourcesContent(m._sources.toArray(), m.sourceRoot), m.file = l._file, m._sourceMapURL = p, m._absoluteSources = m._sources.toArray().map(function(Z) {
	...
	}, a.prototype._version = 3, Object.defineProperty(a.prototype, "sources", { get: function() {
	...
	a.prototype._parseMappings = function(l, p) {
		for (var m = 1, g = 0, y = 0, x = 0, v = 0, E = 0, w = l.length, V = 0, D = {}, X = {}, Z = [], L = [], R, H, z, $, I; V < w;) if (l.charAt(V) === ";") m++, V++, g = 0;
		else if (l.charAt(V) === ",") V++;
		else {
			for (R = new u(), R.generatedLine = m, $ = V; $ < w && !this._charIsMappingSeparator(l, $); $++);
			if (H = l.slice(V, $), z = D[H], z) V += H.length;
			else {
				for (z = []; V < $;) s.decode(l, V, X), I = X.value, V = X.rest, z.push(I);
		...
		if (l[m] <= 0) throw new TypeError("Line must be greater than or equal to 1, got " + l[m]);
		if (l[g] < 0) throw new TypeError("Column must be greater than or equal to 0, got " + l[g]);
		...
		for (var l = 0; l < this._generatedMappings.length; ++l) {
			...
			p.lastGeneratedColumn = Infinity;
		}
	}, a.prototype.originalPositionFor = function(l) {
		var p = {
			generatedLine: e.getArg(l, "line"),
			generatedColumn: e.getArg(l, "column")
		}, m = this._findMapping(p, this._generatedMappings, "generatedLine", "generatedColumn", e.compareByGeneratedPositionsDeflated, e.getArg(l, "bias", r.GREATEST_LOWER_BOUND));
		if (m >= 0) {
		...
		if (this.sourceRoot != null && (y = e.urlParse(this.sourceRoot))) {
			...
			if (y.scheme == "file" && this._sources.has(x)) return this.sourcesContent[this._sources.indexOf(x)];
			if ((!y.path || y.path == "/") && this._sources.has("/" + g)) return this.sourcesContent[this._sources.indexOf("/" + g)];
		}
		if (p) return null;
		...
		}, g = this._findMapping(m, this._originalMappings, "originalLine", "originalColumn", e.compareByOriginalPositions, e.getArg(l, "bias", r.GREATEST_LOWER_BOUND));
		if (g >= 0) {
			var y = this._originalMappings[g];
			if (y.source === m.source) return {
	...
	function o(c, l) {
		...
		this._sections = g.map(function(x) {
			if (x.url) throw new Error("Support for url field in sections not implemented.");
	...
	return o.prototype = Object.create(r.prototype), o.prototype.constructor = r, o.prototype._version = 3, Object.defineProperty(o.prototype, "sources", { get: function() {
		for (var c = [], l = 0; l < this._sections.length; l++) for (var p = 0; p < this._sections[l].consumer.sources.length; p++) c.push(this._sections[l].consumer.sources[p]);
		return c;
	} }), o.prototype.originalPositionFor = function(l) {
		var p = {
			generatedLine: e.getArg(l, "line"),
			generatedColumn: e.getArg(l, "column")
		}, m = t.search(p, this._sections, function(y, x) {
			return y.generatedLine - x.generatedOffset.generatedLine || y.generatedColumn - x.generatedOffset.generatedColumn;
		}), g = this._sections[m];
		...
		for (var m = 0; m < this._sections.length; m++) {
			var y = this._sections[m].consumer.sourceContentFor(l, !0);
			if (y) return y;
		}
		if (p) return null;
		...
		for (var m = 0; m < this._sections.length; m++) for (var g = this._sections[m], y = g.consumer._generatedMappings, x = 0; x < y.length; x++) {
...
function ZZ() {
	...
	function r(a, u, o, c, l) {
		this.children = [], this.sourceContents = {}, this.line = a ?? null, this.column = u ?? null, this.source = o ?? null, this.name = l ?? null, this[i] = !0, c != null && this.add(c);
	}
	return r.fromStringWithSourceMap = function(u, o, c) {
		...
		function E(w, V) {
			if (w === null || w.source === void 0) l.add(V);
			else {
				var D = c ? t.join(c, w.source) : w.source;
				l.add(new r(w.originalLine, w.originalColumn, D, V, w.name));
			}
		}
	}, r.prototype.add = function(u) {
		if (Array.isArray(u)) u.forEach(function(o) {
			this.add(o);
		}, this);
		else if (u[i] || typeof u == "string") u && this.children.push(u);
		else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + u);
		return this;
	}, r.prototype.prepend = function(u) {
		if (Array.isArray(u)) for (var o = u.length - 1; o >= 0; o--) this.prepend(u[o]);
		else if (u[i] || typeof u == "string") this.children.unshift(u);
		else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + u);
		return this;
	}, r.prototype.walk = function(u) {
		for (var o, c = 0, l = this.children.length; c < l; c++) o = this.children[c], o[i] ? o.walk(u) : o !== "" && u(o, {
			source: this.source,
			line: this.line,
			column: this.column,
			name: this.name
		...
		if (l > 0) {
			for (o = [], c = 0; c < l - 1; c++) o.push(this.children[c]), o.push(u);
		...
		for (var o = 0, c = this.children.length; o < c; o++) this.children[o][i] && this.children[o].walkSourceContents(u);
		for (var l = Object.keys(this.sourceContents), o = 0, c = l.length; o < c; o++) u(t.fromSetString(l[o]), this.sourceContents[l[o]]);
		...
		var o = {
			...
			line: 1,
			column: 0
		}, c = new e(u), l = !1, p = null, m = null, g = null, y = null;
		return this.walk(function(x, v) {
			o.code += x, v.source !== null && v.line !== null && v.column !== null ? ((p !== v.source || m !== v.line || g !== v.column || y !== v.name) && c.addMapping({
				...
				name: v.name
			}), p = v.source, m = v.line, g = v.column, y = v.name, l = !0) : l && (c.addMapping({ generated: {
				line: o.line,
				column: o.column
			} }), p = null, l = !1);
			for (var E = 0, w = x.length; E < w; E++) x.charCodeAt(E) === s ? (o.line++, o.column = 0, E + 1 === w ? (p = null, l = !1) : l && c.addMapping({
				source: v.source,
				original: {
					line: v.line,
					column: v.column
...
function OZ() {
	return il || (il = 1, function(e) {
		(function() {
			var t, n, s, i, r = GZ(), a = AZ(), u, o, c, l, p, m, g, y, x, v, E, w, V, D, X, Z, L, R, H, z;
			t = r.Syntax;
			function $(d) {
...
`,
			...
			function He(d, b) {
				...
				for (f in b) b.hasOwnProperty(f) && (M = b[f], P(M) ? P(d[f]) ? He(d[f], M) : d[f] = He({}, M) : d[f] = M);
				return d;
			}
			function pe(d) {
				var b, f, M, P, k;
				if (d !== d) throw new Error("Numeric literal whose value is NaN");
				if (d < 0 || d === 0 && 1 / d < 0) throw new Error("Numeric literal whose value is negative");
				if (d === Infinity) return c ? "null" : l ? "1e400" : "1e+400";
				if (b = "" + d, !l || b.length < 3) return b;
				for (f = b.indexOf("."), !c && b.charCodeAt(0) === 48 && f === 1 && (f = 0, b = b.slice(1)), M = b, b = b.replace("e+", "e"), P = 0, (k = M.indexOf("e")) > 0 && (P = +M.slice(k + 1), M = M.slice(0, k)), f >= 0 && (P -= M.length - f - 1, M = +(M.slice(0, f) + M.slice(f + 1)) + ""), k = 0; M.charCodeAt(M.length + k - 1) === 48;) --k;
				return k !== 0 && (P -= k, M = M.slice(0, k)), P !== 0 && (M += "e" + P), (M.length < b.length || p && d > 0xe8d4a51000 && Math.floor(d) === d && (M = "0x" + d.toString(16)).length < b.length) && +M === d && (b = M), b;
			}
			function Te(d, b) {
			...
			function Ct(d) {
				...
				if (f = d.toString(), d.source) {
					if (b = f.match(/\/([^/]*)$/), !b) return f;
					for (M = b[1], f = "", K = !1, te = !1, P = 0, k = d.source.length; P < k; ++P) W = d.source.charCodeAt(P), te ? (f += Te(W, te), te = !1) : (K ? W === 93 && (K = !1) : W === 47 ? f += "\\" : W === 91 && (K = !0), f += Te(W, te), te = W === 92);
					return "/" + f + "/" + M;
				}
				return f;
			}
			...
			function hn(d) {
				var b, f, M, P;
				for (P = m === "double" ? "\"" : "'", b = 0, f = d.length; b < f; ++b) if (M = d.charCodeAt(b), M === 39) {
					P = "\"";
					break;
				} else if (M === 34) {
					P = "'";
			...
			function Xt(d) {
				...
				if (K = !(m === "double" || m === "auto" && W < k), te = K ? "'" : "\"", !(K ? k : W)) return te + b + te;
				for (d = b, b = te, f = 0, M = d.length; f < M; ++f) P = d.charCodeAt(f), (P === 39 && K || P === 34 && !K) && (b += "\\"), b += String.fromCharCode(P);
				return b + te;
			}
			function Fn(d) {
				var b, f, M, P = "";
				for (b = 0, f = d.length; b < f; ++b) M = d[b], P += Array.isArray(M) ? Fn(M) : M;
				return P;
			}
			function De(d, b) {
				if (!Z) return Array.isArray(d) ? Fn(d) : d;
				if (b == null) {
					if (d instanceof i) return d;
					b = {};
				}
				return b.loc == null ? new i(null, null, Z, d, b.name || null) : new i(b.loc.start.line, b.loc.start.column, Z === !0 ? b.loc.source || null : Z, d, b.name || null);
			}
			function Oe() {
				return x || " ";
			}
			function ye(d, b) {
				var f, M, P, k;
				return f = De(d).toString(), f.length === 0 ? [b] : (M = De(b).toString(), M.length === 0 ? [d] : (P = f.charCodeAt(f.length - 1), k = M.charCodeAt(0), (P === 43 || P === 45) && P === k || a.code.isIdentifierPartES5(P) && a.code.isIdentifierPartES5(k) || P === 47 && k === 105 ? [
					d,
					Oe(),
					b
				] : a.code.isWhiteSpace(P) || a.code.isLineTerminator(P) || a.code.isWhiteSpace(k) || a.code.isLineTerminator(k) ? [d, b] : [
					d,
					x,
					b
				]));
			...
			function ns(d, b) {
				...
				for (f = d.split(/\r\n|[\r\n]/), K = Number.MAX_VALUE, M = 1, P = f.length; M < P; ++M) {
					for (k = f[M], W = 0; W < k.length && a.code.isWhiteSpace(k.charCodeAt(W));) ++W;
					K > W && (K = W);
				}
				for (typeof b < "u" ? (te = u, f[1][K] === "*" && (b += " "), u = b) : (K & 1 && --K, te = u), M = 1, P = f.length; M < P; ++M) Ze = De(qe(f[M].slice(K))), f[M] = Z ? Ze.join("") : Ze;
				return u = te, f.join(`
`);
			}
			function mt(d, b) {
				if (d.type === "Line") {
					if (ie(d.value)) return "//" + d.value;
					var f = "//" + d.value;
					return R || (f += `
`), f;
				}
...
`, _t)), b.push(qe(mt(P)))) : (b.push(Tn), b.push(mt(P))), Xn = ot, f = 1, M = d.leadingComments.length; f < M; f++) P = d.leadingComments[f], ot = P.range, Ti = L.substring(Xn[1], ot[0]), _t = (Ti.match(/\n/g) || []).length, b.push(We(`
`, _t)), b.push(qe(mt(P))), Xn = ot;
						Ii = L.substring(ot[1], Ze[1]), _t = (Ii.match(/\n/g) || []).length, b.push(We(`
`, _t));
					} else for (P = d.leadingComments[0], b = [], w && d.type === t.Program && d.body.length === 0 && b.push(`
`), b.push(mt(P)), ie(De(b).toString()) || b.push(`
`), f = 1, M = d.leadingComments.length; f < M; ++f) P = d.leadingComments[f], te = [mt(P)], ie(De(te).toString()) || te.push(`
`), b.push(qe(te));
					b.push(qe(k));
				}
				if (d.trailingComments) if (R) P = d.trailingComments[0], Ze = P.extendedRange, ot = P.range, Tn = L.substring(Ze[0], ot[0]), _t = (Tn.match(/\n/g) || []).length, _t > 0 ? (b.push(We(`
`, _t)), b.push(qe(mt(P)))) : (b.push(Tn), b.push(mt(P)));
				else for (W = !ie(De(b).toString()), K = We(" ", ts(De([
					u,
					b,
					o
				]).toString())), f = 0, M = d.trailingComments.length; f < M; ++f) P = d.trailingComments[f], W ? (f === 0 ? b = [b, o] : b = [b, K], b.push(mt(P, K))) : b = [b, qe(mt(P))], f !== M - 1 && !ie(De(b).toString()) && (b = [b, `
`]);
				return b;
			}
			function me(d, b, f) {
...
` && P++;
			...
			function $e(d) {
				var b, f, M;
				for (M = d.split(/\r\n|\n/), b = 1, f = M.length; b < f; b++) M[b] = y + u + M[b];
				return M;
			}
			function Je(d, b) {
				var f, M, P;
			...
			we.prototype.maybeBlock = function(d, b) {
				...
				return M = !D.comment || !d.leadingComments, d.type === t.BlockStatement && M ? [x, this.generateStatement(d, b)] : d.type === t.EmptyStatement && M ? ";" : (Ke(function() {
					f = [y, qe(P.generateStatement(d, b))];
				}), f);
			}, we.prototype.maybeBlockSuffix = function(d, b) {
				var f = ie(De(b).toString());
				return d.type === t.BlockStatement && (!D.comment || !d.leadingComments) && !f ? [b, x] : f ? [b, u] : [
					b,
					y,
					u
				];
			...
			function Vt(d) {
				return d.generator && !D.moz.starlessGenerator ? "*" + x : "";
			}
			function Wi(d) {
				var b = d.value, f = "";
			...
			we.prototype.generatePattern = function(d, b, f) {
				...
				var b, f, M, P;
				if (P = !1, d.type === t.ArrowFunctionExpression && !d.rest && (!d.defaults || d.defaults.length === 0) && d.params.length === 1 && d.params[0].type === t.Identifier) M = [Bt(d, !0), _e(d.params[0])];
				else {
					for (M = d.type === t.ArrowFunctionExpression ? [Bt(d, !1)] : [], M.push("("), d.defaults && (P = !0), b = 0, f = d.params.length; b < f; ++b) P && d.defaults[b] ? M.push(this.generateAssignment(d.params[b], d.defaults[b], "=", n.Assignment, O)) : M.push(this.generatePattern(d.params[b], n.Assignment, O)), b + 1 < f && M.push("," + x);
					d.rest && (d.params.length && M.push("," + x), M.push("..."), M.push(_e(d.rest))), M.push(")");
				}
				return M;
			}, we.prototype.generateFunctionBody = function(d) {
				var b, f;
				return b = this.generateFunctionParams(d), d.type === t.ArrowFunctionExpression && (b.push(x), b.push("=>")), d.expression ? (b.push(x), f = this.generateExpression(d.body, n.Assignment, O), f.toString().charAt(0) === "{" && (f = [
					"(",
					f,
					")"
				]), b.push(f)) : b.push(this.maybeBlock(d.body, pt)), b;
				...
				return Ke(function() {
					...
					}) : M.push(P.generateExpression(b.left, n.Call, O)), M = ye(M, d), M = [ye(M, P.generateExpression(b.right, n.Assignment, O)), ")"];
...
` && (P = ["{"]), P.push(M)));
						var W, K, te, Ze;
						for (Ze = Ce, b & re && (Ze |= de), W = 0, K = d.body.length; W < K; ++W) R && (W === 0 && (d.body[0].leadingComments && (f = d.body[0].leadingComments[0].extendedRange, M = L.substring(f[0], f[1]), M[0] === `
` && (P = ["{"])), d.body[0].leadingComments || me(d.range[0], d.body[0].range[0], P)), W > 0 && !d.body[W - 1].trailingComments && !d.body[W].leadingComments && me(d.body[W - 1].range[1], d.body[W].range[0], P)), W === K - 1 && (Ze |= se), d.body[W].leadingComments && R ? te = k.generateStatement(d.body[W], Ze) : te = qe(k.generateStatement(d.body[W], Ze)), P.push(te), ie(De(te).toString()) || R && W < K - 1 && d.body[W + 1].leadingComments || P.push(y), R && W === K - 1 && (d.body[W].trailingComments || me(d.body[W].range[1], d.range[1], P));
				...
				ClassBody: function(d, b) {
					...
					return Ke(function(P) {
						var k, W;
						for (k = 0, W = d.body.length; k < W; ++k) f.push(P), f.push(M.generateExpression(d.body[k], n.Sequence, O)), k + 1 < W && f.push(y);
				...
				ExportNamedDeclaration: function(d, b) {
					...
					return M = b & se ? Pe : Ce, d.declaration ? ye(f, this.generateStatement(d.declaration, M)) : (d.specifiers && (d.specifiers.length === 0 ? f = ye(f, "{" + x + "}") : d.specifiers[0].type === t.ExportBatchSpecifier ? f = ye(f, this.generateExpression(d.specifiers[0], n.Sequence, O)) : (f = ye(f, "{"), Ke(function(k) {
						var W, K;
						for (f.push(y), W = 0, K = d.specifiers.length; W < K; ++W) f.push(k), f.push(P.generateExpression(d.specifiers[W], n.Sequence, O)), W + 1 < K && f.push("," + y);
				...
				ExpressionStatement: function(d, b) {
					...
					function P(K) {
						var te;
						return K.slice(0, 5) !== "class" ? !1 : (te = K.charCodeAt(5), te === 123 || a.code.isWhiteSpace(te) || a.code.isLineTerminator(te));
					}
					function k(K) {
						var te;
						return K.slice(0, 8) !== "function" ? !1 : (te = K.charCodeAt(8), te === 40 || a.code.isWhiteSpace(te) || te === 42 || a.code.isLineTerminator(te));
					}
					function W(K) {
						var te, Ze, ot;
						...
						return Ze === ot || K.slice(Ze, Ze + 8) !== "function" ? !1 : (te = K.charCodeAt(Ze + 8), te === 40 || a.code.isWhiteSpace(te) || te === 42 || a.code.isLineTerminator(te));
					}
					return f = [this.generateExpression(d.expression, n.Sequence, O)], M = De(f).toString(), M.charCodeAt(0) === 123 || P(M) || k(M) || W(M) || V && b & de && d.expression.type === t.Literal && typeof d.expression.value == "string" ? f = [
						"(",
						f,
						")" + this.semicolon(b)
					] : f.push(this.semicolon(b)), f;
				...
				ImportDeclaration: function(d, b) {
					...
					return d.specifiers.length === 0 ? [
						...
						this.generateExpression(d.source, n.Sequence, O),
						this.semicolon(b)
					] : (f = ["import"], M = 0, d.specifiers[M].type === t.ImportDefaultSpecifier && (f = ye(f, [this.generateExpression(d.specifiers[M], n.Sequence, O)]), ++M), d.specifiers[M] && (M !== 0 && f.push(","), d.specifiers[M].type === t.ImportNamespaceSpecifier ? f = ye(f, [x, this.generateExpression(d.specifiers[M], n.Sequence, O)]) : (f.push(x + "{"), d.specifiers.length - M === 1 ? (f.push(x), f.push(this.generateExpression(d.specifiers[M], n.Sequence, O)), f.push(x + "}" + x)) : (Ke(function(k) {
						var W, K;
						for (f.push(y), W = M, K = d.specifiers.length; W < K; ++W) f.push(k), f.push(P.generateExpression(d.specifiers[W], n.Sequence, O)), W + 1 < K && f.push("," + y);
...
`), f.push(qe(K.generateStatement(k, W)))) : (f.push(Oe()), f.push(K.generateStatement(k, W))), M = 1, P = d.declarations.length; M < P; ++M) k = d.declarations[M], D.comment && k.leadingComments ? (f.push("," + y), f.push(qe(K.generateStatement(k, W)))) : (f.push("," + x), f.push(K.generateStatement(k, W)));
					}
					return d.declarations.length > 1 ? Ke(te) : te(), f.push(this.semicolon(b)), f;
				},
				ThrowStatement: function(d, b) {
					return [ye("throw", this.generateExpression(d.argument, n.Sequence, O)), this.semicolon(b)];
				},
				TryStatement: function(d, b) {
					var f, M, P, k;
					if (f = ["try", this.maybeBlock(d.block, Ce)], f = this.maybeBlockSuffix(d.block, f), d.handlers) for (M = 0, P = d.handlers.length; M < P; ++M) f = ye(f, this.generateStatement(d.handlers[M], Ce)), (d.finalizer || M + 1 !== P) && (f = this.maybeBlockSuffix(d.handlers[M].body, f));
					else {
						for (k = d.guardedHandlers || [], M = 0, P = k.length; M < P; ++M) f = ye(f, this.generateStatement(k[M], Ce)), (d.finalizer || M + 1 !== P) && (f = this.maybeBlockSuffix(k[M].body, f));
						if (d.handler) if (Array.isArray(d.handler)) for (M = 0, P = d.handler.length; M < P; ++M) f = ye(f, this.generateStatement(d.handler[M], Ce)), (d.finalizer || M + 1 !== P) && (f = this.maybeBlockSuffix(d.handler[M].body, f));
						else f = ye(f, this.generateStatement(d.handler, Ce)), d.finalizer && (f = this.maybeBlockSuffix(d.handler.body, f));
					}
				...
				SwitchStatement: function(d, b) {
					...
					}), d.cases) for (W = Ce, P = 0, k = d.cases.length; P < k; ++P) P === k - 1 && (W |= se), M = qe(this.generateStatement(d.cases[P], W)), f.push(M), ie(De(M).toString()) || f.push(y);
					return f.push(qe("}")), f;
				},
				SwitchCase: function(d, b) {
					var f, M, P, k, W, K = this;
					return Ke(function() {
						for (d.test ? f = [ye("case", K.generateExpression(d.test, n.Sequence, O)), ":"] : f = ["default:"], P = 0, k = d.consequent.length, k && d.consequent[0].type === t.BlockStatement && (M = K.maybeBlock(d.consequent[0], Ce), f.push(M), P = 1), P !== k && !ie(De(f).toString()) && f.push(y), W = Ce; P < k; ++P) P === k - 1 && b & se && (W |= se), M = qe(K.generateStatement(d.consequent[P], W)), f.push(M), P + 1 !== k && !ie(De(M).toString()) && f.push(y);
					}), f;
				},
...
` : ""], W = Le, P = 0; P < k; ++P) !w && P === k - 1 && (W |= se), R && (P === 0 && (d.body[0].leadingComments || me(d.range[0], d.body[P].range[0], f)), P > 0 && !d.body[P - 1].trailingComments && !d.body[P].leadingComments && me(d.body[P - 1].range[1], d.body[P].range[0], f)), M = qe(this.generateStatement(d.body[P], W)), f.push(M), P + 1 < k && !ie(De(M).toString()) && (R && d.body[P + 1].leadingComments || f.push(y)), R && P === k - 1 && (d.body[P].trailingComments || me(d.body[P].range[1], d.range[1], f));
				...
				ReturnStatement: function(d, b) {
					return d.argument ? [ye("return", this.generateExpression(d.argument, n.Sequence, O)), this.semicolon(b)] : ["return" + this.semicolon(b)];
				},
				...
				SequenceExpression: function(d, b, f) {
					var M, P, k;
					for (n.Sequence < b && (f |= Y), M = [], P = 0, k = d.expressions.length; P < k; ++P) M.push(this.generateExpression(d.expressions[P], n.Assignment, f)), P + 1 < k && M.push("," + x);
				...
				BinaryExpression: function(d, b, f) {
					var M, P, k, W, K, te;
					return W = s[d.operator], P = d.operator === "**" ? n.Postfix : W, k = d.operator === "**" ? W : W + 1, W < b && (f |= Y), K = this.generateExpression(d.left, P, f), te = K.toString(), te.charCodeAt(te.length - 1) === 47 && a.code.isIdentifierPartES5(d.operator.charCodeAt(0)) ? M = [
						K,
						Oe(),
						d.operator
					] : M = ye(K, d.operator), K = this.generateExpression(d.right, k, f), d.operator === "/" && K.toString().charAt(0) === "/" || d.operator.slice(-1) === "<" && K.toString().slice(0, 3) === "!--" ? (M.push(Oe()), M.push(K)) : M = ye(M, K), d.operator === "in" && !(f & Y) ? [
						"(",
						M,
						")"
					] : (d.operator === "||" || d.operator === "&&") && f & Ie ? [
						"(",
						M,
						")"
					] : be(M, W, b);
				...
				CallExpression: function(d, b, f) {
					var M, P, k;
					for (M = [this.generateExpression(d.callee, n.Call, dt)], d.optional && M.push("?."), M.push("("), P = 0, k = d.arguments.length; P < k; ++P) M.push(this.generateExpression(d.arguments[P], n.Assignment, O)), P + 1 < k && M.push("," + x);
					return M.push(")"), f & ee ? be(M, n.Call, b) : [
						"(",
						M,
						")"
					];
				...
				ChainExpression: function(d, b, f) {
					...
					return be(this.generateExpression(d.expression, n.OptionalChaining, f), n.OptionalChaining, b);
				},
				NewExpression: function(d, b, f) {
					var M, P, k, W, K;
					if (P = d.arguments.length, K = f & Me && !v && P === 0 ? Ge : at, M = ye("new", this.generateExpression(d.callee, n.New, K)), !(f & Me) || v || P > 0) {
						for (M.push("("), k = 0, W = P; k < W; ++k) M.push(this.generateExpression(d.arguments[k], n.Assignment, O)), k + 1 < W && M.push("," + x);
						M.push(")");
					}
					return be(M, n.New, b);
				},
				...
				YieldExpression: function(d, b, f) {
					var M;
					return d.delegate ? M = "yield*" : M = "yield", d.argument && (M = ye(M, this.generateExpression(d.argument, n.Yield, O))), be(M, n.Yield, b);
				},
				AwaitExpression: function(d, b, f) {
					return be(ye(d.all ? "await*" : "await", this.generateExpression(d.argument, n.Await, O)), n.Await, b);
				},
				UpdateExpression: function(d, b, f) {
					return d.prefix ? be([d.operator, this.generateExpression(d.argument, n.Unary, O)], n.Unary, b) : be([this.generateExpression(d.argument, n.Postfix, O), d.operator], n.Postfix, b);
				},
				FunctionExpression: function(d, b, f) {
					var M = [Bt(d, !0), "function"];
					return d.id ? (M.push(Vt(d) || Oe()), M.push(_e(d.id))) : M.push(Vt(d) || x), M.push(this.generateFunctionBody(d)), M;
				},
				ArrayPattern: function(d, b, f) {
					return this.ArrayExpression(d, b, f, !0);
				},
				ArrayExpression: function(d, b, f, M) {
					var P, k, W = this;
					return d.elements.length ? (k = M ? !1 : d.elements.length > 1, P = ["[", k ? y : ""], Ke(function(K) {
						var te, Ze;
						for (te = 0, Ze = d.elements.length; te < Ze; ++te) d.elements[te] ? (P.push(k ? K : ""), P.push(W.generateExpression(d.elements[te], n.Assignment, O))) : (k && P.push(K), te + 1 === Ze && P.push(",")), te + 1 < Ze && P.push("," + (k ? y : x));
				...
				MethodDefinition: function(d, b, f) {
					var M, P;
					return d.static ? M = ["static" + x] : M = [], d.kind === "get" || d.kind === "set" ? P = [ye(d.kind, this.generatePropertyKey(d.key, d.computed)), this.generateFunctionBody(d.value)] : P = [
						Wi(d),
				...
				ObjectExpression: function(d, b, f) {
					...
					return d.properties.length ? (M = d.properties.length > 1, Ke(function() {
						...
						if (P = [
							...
							K,
							k
						], M) for (P.push("," + y), te = 1, Ze = d.properties.length; te < Ze; ++te) P.push(K), P.push(W.generateExpression(d.properties[te], n.Sequence, O)), te + 1 < Ze && P.push("," + y);
				...
				ObjectPattern: function(d, b, f) {
					...
					if (W = !1, d.properties.length === 1) K = d.properties[0], K.type === t.Property && K.value.type !== t.Identifier && (W = !0);
					else for (P = 0, k = d.properties.length; P < k; ++P) if (K = d.properties[P], K.type === t.Property && !K.shorthand) {
						W = !0;
						break;
					}
					return M = ["{", W ? y : ""], Ke(function(Ze) {
						var ot, Xn;
						for (ot = 0, Xn = d.properties.length; ot < Xn; ++ot) M.push(W ? Ze : ""), M.push(te.generateExpression(d.properties[ot], n.Sequence, O)), ot + 1 < Xn && M.push("," + (W ? y : x));
				...
				Literal: function(d, b, f) {
					var M;
					if (d.hasOwnProperty("raw") && X && D.raw) try {
						if (M = X(d.raw).body[0].expression, M.type === t.Literal && M.value === d.value) return d.raw;
					} catch {}
				...
				ComprehensionExpression: function(d, b, f) {
					...
					return M = d.type === t.GeneratorExpression ? ["("] : ["["], D.moz.comprehensionExpressionStartsWithAssignment && (W = this.generateExpression(d.body, n.Assignment, O), M.push(W)), d.blocks && Ke(function() {
						for (P = 0, k = d.blocks.length; P < k; ++P) W = K.generateExpression(d.blocks[P], n.Sequence, O), P > 0 || D.moz.comprehensionExpressionStartsWithAssignment ? M = ye(M, W) : M.push(W);
					}), d.filter && (M = ye(M, "if" + x), W = this.generateExpression(d.filter, n.Sequence, O), M = ye(M, [
						"(",
						W,
						")"
					])), D.moz.comprehensionExpressionStartsWithAssignment || (W = this.generateExpression(d.body, n.Assignment, O), M = ye(M, W)), M.push(d.type === t.GeneratorExpression ? ")" : "]"), M;
				},
				ComprehensionBlock: function(d, b, f) {
					...
					] : M = this.generateExpression(d.left, n.Call, O), M = ye(M, d.of ? "of" : "in"), M = ye(M, this.generateExpression(d.right, n.Sequence, O)), [
						"for" + x + "(",
						M,
						")"
					];
				...
				SpreadElement: function(d, b, f) {
					return ["...", this.generateExpression(d.argument, n.Assignment, O)];
				},
				TaggedTemplateExpression: function(d, b, f) {
					var M = dt;
					f & ee || (M = at);
					return be([this.generateExpression(d.tag, n.Call, M), this.generateExpression(d.quasi, n.Primary, he)], n.TaggedTemplate, b);
				},
				...
				TemplateLiteral: function(d, b, f) {
					var M, P, k;
					for (M = ["`"], P = 0, k = d.quasis.length; P < k; ++P) M.push(this.generateExpression(d.quasis[P], n.Primary, O)), P + 1 < k && (M.push("${" + x), M.push(this.generateExpression(d.expressions[P], n.Sequence, O)), M.push(x + "}"));
					return M.push("`"), M;
				},
...
` && (f = Z ? De(f).replaceRight(/\s+$/, "") : M.replace(/\s+$/, "")), De(f, d);
			...
			H = {
				...
				parentheses: !1,
				semicolons: !1
			}, z = ae().format, e.version = UZ.version, e.generate = $r, e.attachComments = r.attachComments, e.Precedence = He({}, n), e.browser = !1, e.FORMAT_MINIFY = H, e.FORMAT_DEFAULTS = z;
		})();
	}(fa)), fa;
}
var x3 = /* @__PURE__ */ y3(OZ());
var QZ = class {
	constructor() {
	...
	visit(t, n, s, i) {
		if (t) {
			if (this.enter) {
				...
				this.should_skip = !1, this.should_remove = !1, this.replacement = null, this.enter.call(this.context, t, n, s, i), this.replacement && (t = this.replacement, this.replace(n, s, i, t)), this.should_remove && this.remove(n, s, i);
			...
			for (r in t) {
				const a = t[r];
				if (a && typeof a == "object") if (Array.isArray(a)) {
					const u = a;
			...
			if (this.leave) {
				...
				this.replacement = null, this.should_remove = !1, this.leave.call(this.context, t, n, s, i), this.replacement && (t = this.replacement, this.replace(n, s, i, t)), this.should_remove && this.remove(n, s, i);
...
function $Z(e, t = {}) {
	const { wrapAsync: n = !1, addReturn: s = !0, emitMiniLocations: i = !0, emitWidgets: r = !0 } = t, a = [];
	let u = MZ(e, {
		ecmaVersion: 2022,
	...
	G3(u, {
		enter(y, x) {
			...
			if (f7(y, x)) return this.replace(y7(y));
			if (g7(y)) return this.replace(b7(y));
		},
		leave(y, x, v, E) {
			if (!e7(y)) return;
			let [w, ...V] = y.arguments;
	...
	let { body: m } = u;
	if (!m.length) console.warn("empty body -> fallback to silence"), m.push({
	...
	else if (!m?.[m.length - 1]?.expression) throw new Error("unexpected ast format without body expression");
	if (s) {
...
function uu(e) {
	return x3.generate(e, { format: { semicolons: !1 } });
}
function n7(e) {
	const t = ul(e), n = /* @__PURE__ */ new Map(), s = [];
	if (G3(t, { enter(u, o, c, l) {
		n.set(u, {
			parent: o,
			prop: c,
			index: l
...
function s7(e) {
	if (i7(e)) {
		...
		if (!t) throw new Error("S(...) requires an argument");
		return t;
	}
	return P3(e) ? e : null;
}
...
function P3(e) {
	if (e.type !== "CallExpression") return !1;
	const t = e.callee;
	if (t.type !== "Identifier" || t.name !== r7()) return !1;
...
function al(e) {
	...
	if (P3(e)) {
		...
		if (t?.type === "Literal" && typeof t.value == "number") return t.value;
	}
	return 0;
}
function a7(e) {
...
function u7(e, t, n, s) {
	const i = n.get(e);
	if (!i || !i.parent) return t;
	const { parent: r, prop: a, index: u } = i;
	return Array.isArray(r[a]) ? r[a][u] = t : r[a] = t, n.set(t, {
		parent: r,
		prop: a,
		index: u
	}), s;
...
function P7(e, t) {
	...
	for (const i of e) {
		...
		if (r.startsWith("mini-off")) s.push(i.start);
...
function ll(e, t) {
	for (const [n, s] of t) if (e >= n && e < s) return !0;
	return !1;
}
function Po(e) {
...
var A3 = [
	...
	3,
	5
], F3 = A3.map((e) => Math.floor(e * 7 / 12));
function X3(e) {
	const { step: t, alt: n, oct: s, dir: i = 1 } = e, r = A3[t] + 7 * n;
	if (s === void 0) return [i * r];
	const a = s - F3[t] - 4 * n;
	return [i * r, i * a];
}
var A7 = [
...
var dl = (e, t) => Array(Math.abs(t) + 1).join(e), ou = Object.freeze({
	empty: !0,
	name: "",
	num: NaN,
	q: "",
	...
	coord: [],
	oct: NaN
}), S7 = /* @__PURE__ */ new RegExp("^([-+]?\\d+)(d{1,4}|m|M|P|A{1,4})|(AA|A|P|M|m|d|dd)([-+]?\\d+)$");
function w7(e) {
	const t = S7.exec(`${e}`);
...
function Z7(e) {
	...
	if (r === "M" && s === "P") return ou;
	const a = r === "M" ? "majorable" : "perfectable", u = "" + n + s, o = n < 0 ? -1 : 1, c = n === 8 || n === -8 ? n : o * (i + 1), l = E7(a, s), p = Math.floor((Math.abs(n) - 1) / 7);
	return {
		empty: !1,
		name: u,
		num: n,
		...
		type: a,
		simple: c,
		semitones: o * (pl[i] + l + 12 * p),
		chroma: (o * (pl[i] + l) % 12 + 12) % 12,
		coord: X3({
			step: i,
			alt: l,
			oct: p,
...
var ml = (e, t) => Array(Math.abs(t) + 1).join(e), Z3 = Object.freeze({
	empty: !0,
	name: "",
	letter: "",
	acc: "",
	...
	midi: null,
	freq: null
}), fl = /* @__PURE__ */ new Map(), B7 = (e) => "CDEFGAB".charAt(e), Rr = (e) => e < 0 ? ml("b", -e) : ml("#", e), Fo = (e) => e[0] === "b" ? -e.length : e.length;
function Ne(e) {
...
function N7(e) {
	const t = Xo(e);
	if (t[0] === "" || t[3] !== "") return Z3;
	const n = t[0], s = t[1], i = t[2], r = (n.charCodeAt(0) + 3) % 7, a = Fo(s), u = i.length ? +i : void 0, o = X3({
		step: r,
		alt: a,
		oct: u
	}), c = n + s + i, l = n + s, p = (Xa[r] + a + 120) % 12, m = u === void 0 ? z7(Xa[r] + a, 12) - 1188 : Xa[r] + a + 12 * (u + 1), g = m >= 0 && m <= 127 ? m : null;
	return {
		empty: !1,
		acc: s,
		alt: a,
		chroma: p,
		coord: o,
		freq: u === void 0 ? null : Math.pow(2, (m - 69) / 12) * 440,
		height: m,
		letter: n,
		midi: g,
		name: c,
...
function cn(e, t) {
	...
	if (n.empty || !s || s.length < 2) return "";
	const i = n.coord;
	return k7(i.length === 1 ? [i[0] + s[0]] : [i[0] + s[0], i[1] + s[1]]).name;
}
function E3(e, t) {
	const n = e.length;
	return (s) => {
		if (!t) return "";
		const i = s < 0 ? (n - -s % n) % n : s % n;
		return cn(cn(t, [0, Math.floor(s / n)]), e[i]);
	};
}
function Br(e, t) {
	const n = Ne(e), s = Ne(t);
	if (n.empty || s.empty) return "";
...
var yl = (e, t) => Array(t + 1).join(e), T7 = /^(_{1,}|=|\^{1,}|)([abcdefgABCDEFG])([,']*)$/;
function L3(e) {
	const t = T7.exec(e);
	return t ? [
		t[1],
...
function Q7(e, t = Math.random) {
	let n, s, i = e.length;
	for (; i;) n = Math.floor(t() * i--), s = e[i], e[i] = e[n], e[n] = s;
	return e;
}
function V3(e) {
	return e.length === 0 ? [[]] : V3(e.slice(1)).reduce((t, n) => t.concat(e.map((s, i) => {
		const r = n.slice();
		return r.splice(i, 0, e[0]), r;
	})), []);
}
var q7 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	compact: O7,
	permutations: V3,
	range: j7,
...
function k3(e) {
	return e.length === 0 ? [[]] : k3(e.slice(1)).reduce((t, n) => t.concat(e.map((s, i) => {
		const r = n.slice();
		return r.splice(i, 0, e[0]), r;
	})), []);
}
var nE = {
	...
	intervals: []
}, So = (e) => Number(e).toString(2).padStart(12, "0"), gl = (e) => parseInt(e, 2), sE = /^[01]{12}$/;
function wo(e) {
	return sE.test(e);
}
var iE = (e) => typeof e == "number" && e >= 0 && e <= 4095, rE = (e) => e && wo(e.chroma), bl = { [On.chroma]: On };
function Gt(e) {
	const t = wo(e) ? e : iE(e) ? So(e) : Array.isArray(e) ? gE(e) : rE(e) ? e.chroma : On.chroma;
	return bl[t] = bl[t] || yE(t);
}
var aE = Gt, z3 = (e) => Gt(e).chroma, uE = (e) => Gt(e).intervals, oE = (e) => Gt(e).setNum, cE = [
	"1P",
	"2m",
	"2M",
	"3m",
...
function lE(e) {
	const t = [];
	for (let n = 0; n < 12; n++) e.charAt(n) === "1" && t.push(cE[n]);
	return t;
}
function dE(e) {
...
function yE(e) {
	const t = gl(e), n = fE(e).map(gl).filter((r) => r >= 2048).sort()[0];
	return {
		empty: !1,
		name: "",
		setNum: t,
...
function gE(e) {
	if (e.length === 0) return On.chroma;
	let t;
	const n = [
		0,
		0,
	...
	for (let s = 0; s < e.length; s++) t = Ne(e[s]), t.empty && (t = Mn(e[s])), t.empty || (n[t.chroma] = 1);
	return n.join("");
}
var ME = [
	[
...
ME.forEach(([e, t, n]) => CE(e.split(" "), n.split(" "), t));
...
var Nr = {
	...
	nonPerfectFifths: 40,
	anySeventh: 3
}, Wr = (e) => (t) => !!(t & e), AE = Wr(Nr.anyThirds), FE = Wr(Nr.perfectFifth), XE = Wr(Nr.anySeventh), DE = Wr(Nr.nonPerfectFifths);
function SE(e) {
...
function ZE(e, t, n) {
	const s = e[0], i = Ne(s).chroma, r = vE(e), a = Zo(e, !1), u = [];
...
var I3 = [
	...
	9,
	11
], _3 = ({ step: e, alt: t }) => (I3[e] + t + 120) % 12, Lo = ({ step: e, alt: t, oct: n, dir: s = 1 }) => s * (I3[e] + t + 12 * (n === void 0 ? -100 : n)), Y3 = (e) => {
	const t = Lo(e);
...
var Ml = (e, t) => Array(Math.abs(t) + 1).join(e), cu = {
	empty: !0,
	name: "",
	acc: ""
}, VE = /* @__PURE__ */ new RegExp("^([-+]?\\d+)(d{1,4}|m|M|P|A{1,4})|(AA|A|P|M|m|d|dd)([-+]?\\d+)$");
function Ro(e) {
	const t = VE.exec(`${e}`);
	return t === null ? ["", ""] : t[1] ? [t[1], t[2]] : [t[4], t[3]];
}
...
function kE(e) {
	...
	if (r === "M" && s === "P") return cu;
	const a = r === "M" ? "majorable" : "perfectable", u = "" + n + s, o = n < 0 ? -1 : 1, c = n === 8 || n === -8 ? n : o * (i + 1), l = zE(a, s), p = Math.floor((Math.abs(n) - 1) / 7);
	return {
		empty: !1,
		name: u,
		num: n,
		...
		type: a,
		simple: c,
		semitones: o * (xl[i] + l + 12 * p),
		chroma: (o * (xl[i] + l) % 12 + 12) % 12,
		coord: Ir({
			step: i,
			alt: l,
			oct: p,
...
var Gl = (e, t) => Array(Math.abs(t) + 1).join(e), U3 = {
	empty: !0,
	name: "",
	pc: "",
	acc: ""
}, vl = /* @__PURE__ */ new Map(), Bo = (e) => "CDEFGAB".charAt(e), Vo = (e) => e < 0 ? Gl("b", -e) : Gl("#", e), ko = (e) => e[0] === "b" ? -e.length : e.length;
function Cn(e) {
...
function _E(e) {
	const t = Yr(e);
	if (t[0] === "" || t[3] !== "") return U3;
	const n = t[0], s = t[1], i = t[2], r = (n.charCodeAt(0) + 3) % 7, a = ko(s), u = i.length ? +i : void 0, o = Ir({
		step: r,
		alt: a,
		oct: u
	}), c = n + s + i, l = n + s, p = (Da[r] + a + 120) % 12, m = u === void 0 ? IE(Da[r] + a, 12) - 1188 : Da[r] + a + 12 * (u + 1), g = m >= 0 && m <= 127 ? m : null;
	return {
		empty: !1,
		acc: s,
		alt: a,
...
function Ns(e, t) {
	...
	if (n.empty || !s || s.length < 2) return "";
	const i = n.coord;
	return zo(i.length === 1 ? [i[0] + s[0]] : [i[0] + s[0], i[1] + s[1]]).name;
}
function Hr(e, t) {
	const n = e.length;
	return (s) => {
		if (!t) return "";
		const i = s < 0 ? (n - -s % n) % n : s % n;
		return Ns(Ns(t, [0, Math.floor(s / n)]), e[i]);
	};
}
function No(e, t) {
	const n = Cn(e), s = Cn(t);
...
var Q3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	accToAlt: ko,
	altToAcc: Vo,
	chroma: _3,
...
KE.forEach(([e, t, n]) => q3(e.split(" "), n.split(" "), t));
...
sL.forEach(([e, t, ...n]) => tC(e.split(" "), t, n));
var nC = {
	names: eC,
	get: Ur,
	all: Qs,
...
function bs(e) {
	if (e === "") return lu;
	if (Array.isArray(e) && e.length === 2) return nr(e[1], e[0]);
	{
...
function nr(e, t, n) {
	...
	if (s.empty || t && i.empty || n && r.empty) return lu;
	const a = No(i.pc, r.pc), u = s.intervals.indexOf(a) + 1;
	if (!r.empty && !u) return lu;
...
var vL = /^([^.]+)(\.*)$/;
function Io(e) {
	const [t, n, s] = vL.exec(e) || [], i = Or.find((u) => u.shorthand === n || u.names.includes(n));
	if (!i) return CL;
...
var PL = (e) => Io(e).value, AL = (e) => Io(e).fraction, FL = {
	names: xL,
	shorthands: GL,
	get: Io,
	value: PL,
...
function DL(e, t) {
	...
	let s = e[0] * n, i = e[1] * n;
	const r = s;
	for (let a = 0; a < t; a++) s += r / Math.pow(2, a + 1);
	for (; s % 2 === 0 && i % 2 === 0;) s /= 2, i /= 2;
	return [s, i];
}
function SL() {
	return "1P 2M 3M 4P 5P 6m 7m".split(" ");
}
var sC = At, wL = (e) => At(e).name, ZL = (e) => At(e).semitones, EL = (e) => At(e).q, LL = (e) => At(e).num;
function RL(e) {
	const t = At(e);
...
function BL(e) {
	...
	return At({
		step: (7 - t.step) % 7,
		alt: t.type === "perfectable" ? -t.alt : -(t.alt + 1),
		oct: t.oct,
		dir: t.dir
	}).name;
}
var VL = [
	...
	7,
	7
], kL = "P m M m M P d P m M m M".split(" ");
function zL(e) {
	const t = e < 0 ? -1 : 1, n = Math.abs(e), s = n % 12, i = Math.floor(n / 12);
	return t * (VL[s] + 7 * i) + kL[s];
}
var NL = Br, iC = rC((e, t) => [e[0] + t[0], e[1] + t[1]]), WL = (e) => (t) => iC(e, t), TL = rC((e, t) => [e[0] - t[0], e[1] - t[1]]);
function IL(e, t) {
	const n = sC(e);
	if (n.empty) return "";
	const [s, i, r] = n.coord;
...
var YL = Math.log(2), HL = Math.log(440);
function _o(e) {
	const t = 12 * (Math.log(e) - HL) / YL + 69;
	return Math.round(t * 100) / 100;
}
var KL = "C C# D D# E F F# G G# A A# B".split(" "), jL = "C Db D Eb E F Gb G Ab A Bb B".split(" ");
function es(e, t = {}) {
	if (isNaN(e) || e === -Infinity || e === Infinity) return "";
	e = Math.round(e);
	const s = (t.sharps === !0 ? KL : jL)[e % 12];
	if (t.pitchClass) return s;
	return s + (Math.floor(e / 12) - 1);
}
function Yo(e) {
	return e % 12;
}
...
var qL = {
	...
	"A",
	"B"
], cC = (e) => e.name, lC = (e) => e.map(Ne).filter((t) => !t.empty);
function eR(e) {
	return e === void 0 ? $L.slice() : Array.isArray(e) ? lC(e).map(cC) : [];
}
var ln = Ne, tR = (e) => ln(e).name, nR = (e) => ln(e).pc, sR = (e) => ln(e).acc, iR = (e) => ln(e).oct, rR = (e) => ln(e).midi, aR = (e) => ln(e).freq, uR = (e) => ln(e).chroma;
function dC(e) {
	return es(e);
}
function oR(e) {
...
function cR(e) {
	return es(_o(e), { sharps: !0 });
}
function lR(e) {
	return es(e, { sharps: !0 });
}
var dR = Br, un = cn, hR = cn, hC = (e) => (t) => un(t, e), pR = hC, pC = (e) => (t) => un(e, t), mR = pC;
function fr(e, t) {
	return un(e, [t, 0]);
}
var fR = fr;
...
var Ko = (e, t) => e.height - t.height, gR = (e, t) => t.height - e.height;
function mC(e, t) {
	return t = t || Ko, lC(e).sort(t).map(cC);
}
function fC(e) {
	return mC(e, Ko).filter((t, n, s) => n === 0 || t !== s[n - 1]);
}
var bR = (e) => {
	const t = ln(e);
...
function yC(e, t) {
	const n = ln(e);
	if (n.empty) return "";
	const s = ln(t || es(n.midi || n.chroma, {
		sharps: n.alt < 0,
		pitchClass: !0
	}));
	if (s.empty || s.chroma !== n.chroma) return "";
	if (n.oct === void 0) return s.pc;
...
var bC = "I II III IV V VI VII", Jr = bC.split(" "), PR = bC.toLowerCase().split(" ");
function AR(e) {
	const [t, n, s, i] = vR(e);
	if (!s) return gC;
...
var FR = {
	...
	harmonic: sr,
	melodic: sr
}, Sa = (e, t, n = "") => t.map((s, i) => `${e[i]}${n}${s}`);
function Qr(e, t, n, s, i) {
	return (r) => {
		const a = e.map((g) => Jn(g).interval || ""), u = a.map((g) => un(r, g)), o = Sa(u, n), c = u.map((g) => un(g, "5P")).map((g) => u.includes(g) && !o.includes(g + "7") ? g + "7" : ""), l = Al(c, t), p = c.map((g) => {
			if (!g) return "";
			return un(g.slice(0, -1), "5d") + "7";
		}), m = Al(p, t);
		return {
			tonic: r,
			grades: e,
...
var Al = (e, t) => e.map((n, s) => {
	if (!n) return "";
	const r = un(n.slice(0, -1), "5P");
	return t[s].endsWith("m") ? r + "m7" : r + "m7b5";
}), CC = (e, t) => {
	const n = Ne(e), s = Ne(t);
	return n.empty || s.empty ? 0 : s.coord[0] - n.coord[0];
}, SR = Qr("I II III IV V VI VII".split(" "), " m m   m dim".split(" "), "maj7 m7 m7 maj7 7 m7 m7b5".split(" "), "T SD T SD D T D".split(" "), "major,dorian,phrygian,lydian,mixolydian,minor,locrian".split(",")), wR = Qr("I II bIII IV V bVI bVII".split(" "), "m dim  m m  ".split(" "), "m7 m7b5 maj7 m7 m7 maj7 7".split(" "), "T SD T SD D SD SD".split(" "), "minor,locrian,major,dorian,phrygian,lydian,mixolydian".split(",")), ZR = Qr("I II bIII IV V bVI VII".split(" "), "m dim aug m   dim".split(" "), "mMaj7 m7b5 +maj7 m7 7 maj7 o7".split(" "), "T SD T SD D SD D".split(" "), "harmonic minor,locrian 6,major augmented,lydian diminished,phrygian dominant,lydian #9,ultralocrian".split(",")), ER = Qr("I II bIII IV V VI VII".split(" "), "m m aug   dim dim".split(" "), "m6 m7 +maj7 7 7 m7b5 m7b5".split(" "), "T SD T SD D  ".split(" "), "melodic minor,dorian b2,lydian augmented,lydian dominant,mixolydian b6,locrian #2,altered".split(","));
function LR(e) {
	const t = Ne(e).pc;
	if (!t) return XR;
...
var HR = GC(jo.map((e) => e[4])), KR = GC(jo.map((e) => e[5]));
function vC(e, t) {
	const n = ms(t), s = ms(e);
...
function JR(e, t) {
	return t.map(Jn).map((s) => cn(e, Mn(s)) + s.chordType);
}
function QR(e, t) {
	return t.map((n) => {
		const [s, i] = OR(n);
		return Jn(Mn(Br(e, s))).name + i;
	});
}
var qR = {
	fromRomanNumerals: JR,
	toRomanNumerals: QR
};
function PC(e) {
	const t = Do(e.map((n) => typeof n == "number" ? n : uC(n)));
	return !e.length || t.length !== e.length ? [] : t.reduce((n, s) => {
...
function rB(e) {
	const n = kr(xn(e).chroma);
	return T3().filter((s) => n(s.chroma)).map((s) => s.aliases[0]);
}
function FC(e) {
	const n = zr(wo(e) ? e : xn(e).chroma);
	return Qs().filter((s) => n(s.chroma)).map((s) => s.name);
}
function aB(e) {
...
var fB = /^(\d*\d(?:\+\d)*)\/(\d+)$/, Xl = /* @__PURE__ */ new Map();
function yB(e) {
...
var gB = {
	...
	parse: Oo,
	get: yB
}, bB = (e) => Math.log(e) / Math.log(2) % 1 === 0;
function MB([e, t]) {
	const n = Array.isArray(e) ? e.reduce((u, o) => u + o, 0) : e, s = t;
	if (n === 0 || s === 0) return hB;
	const i = Array.isArray(e) ? `${e.join("+")}/${t}` : `${e}/${t}`, r = Array.isArray(e) ? e : [];
	return {
		empty: !1,
		name: i,
		type: s === 4 || s === 2 ? "simple" : s === 8 && n % 3 === 0 ? "compound" : bB(s) ? "irregular" : "irrational",
		upper: n,
		lower: s,
		additive: r
	};
}
var PB = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	AbcNotation: Y7,
	Array: q7,
	Chord: gL,
...
function LB(e, t, n, s) {
	...
	if (n) {
		n = pu(n, 3);
		const g = Ut(hu(n) - u, 12), y = SC(g, o, s);
		e = e + y, c = n - g;
	}
...
function RB({ chord: e, dictionary: t, offset: n = 0, n: s, mode: i = "below", anchor: r = "c5", octaves: a = 1 }) {
	...
	r = pu(r?.note || r, 4);
	const l = hu(r), p = t[o].map((Z) => (typeof Z == "string" ? Z.split(" ") : Z).map(DC));
	let m, g, y = p.map((Z, L) => {
		const H = Ut(l - Dl[i](Z) - c, 12);
...
function Jo(e) {
	...
	if (s && fs(e) || s && !n) throw new Error(`Scale name ${e} is incomplete. Make sure to use ":" instead of spaces, example: .scale("C:major")`);
	if (s) throw new Error(`Invalid scale name "${e}"`);
	return t;
}
function VB(e, t) {
	e = Math.ceil(e);
...
function Sl(e, t, n) {
	let { notes: s } = Jo(e);
	if (s = s.map((p) => fn.get(p).pc), t = Number(t), isNaN(t)) throw new Error(`scale offset "${t}" not a number`);
	const { pc: i, oct: r = 3 } = fn.get(n), a = s.indexOf(i);
	if (a === -1) throw new Error(`note "${n}" is not in scale "${e}"`);
	let u = a, o = r, c = i;
	const l = Math.sign(t);
...
var { transpose: kB, trans: zB } = B(["transpose", "trans"], function(t, n) {
	return n.withHap((s) => {
		...
		if (typeof i == "number") {
			...
			const o = i + u;
			return typeof s.value == "object" ? s.withValue(() => ({
				...s.value,
				note: o
			})) : s.withValue(() => o);
		}
		if (typeof i != "string" || !fs(i)) return gt(`[tonal] transpose: not a note "${i}"`, "warning"), s;
...
}), { scaleTranspose: NB, scaleTrans: WB, strans: TB } = B([
	"scaleTranspose",
	"scaleTrans",
	"strans"
], function(e, t) {
	return t.withHap((n) => {
		if (!n.context.scale) throw new Error("can only use scaleTranspose after .scale");
		if (typeof n.value == "object") return n.withValue(() => ({
			...n.value,
			note: Sl(n.context.scale, Number(e), n.value.note)
		}));
		if (typeof n.value != "string") throw new Error("can only use scaleTranspose with notes");
...
function IB(e) {
	...
	if (isNaN(t)) {
		...
		if (!s) throw new Error(`invalid scale step "${e}", expected number or integer with optional # b suffixes`);
		t = Number(s[1]);
		n = gu(s[2] || "");
	}
	return [t, n];
...
function _B(e, t, n = !0) {
	...
	if (Ea[e] === void 0) {
		const { intervals: p, tonic: m } = Jo(e), { pc: g } = fn.get(m), x = p.concat("8P").map((E) => fn.transpose(g + "0", E));
		Ea[e] = [x.map(yn), x];
	}
	const [i, r] = Ea[e], a = i[0], u = Math.floor((s - a) / 12), l = r[SC(s, i.map((p) => p + 12 * u), n)];
	return fn.transpose(l, ps.fromSemitones(12 * u));
}
var YB = B("scale", function(e, t) {
	return Array.isArray(e) && (e = e.flat().join(" ")), t.withHaps((n) => (n = n.map((s) => {
		let i = s.value;
		const r = typeof i == "object";
		i = r ? i : { n: i };
		const { note: a, n: u, value: o, ...c } = i, l = a ?? u ?? o;
		if (l === void 0) return gt(`[tonal] Invalid value format for 'scale'. Value must contain n, note, or value but received keys [${Object.keys(i).join(", ")}]`, "error"), s;
		let p;
		if (fs(l)) p = _B(e, l), s.value = {
			...c,
			note: p
		};
		else try {
...
function wC() {
	if (wl) return ci;
	wl = 1, ci.__esModule = !0, ci.getBestVoicing = void 0;
	function e(t) {
...
var li = {};
var ZC = /* @__PURE__ */ xZ(PB);
var di = {}, Zl;
function EC() {
	if (Zl) return di;
	Zl = 1, di.__esModule = !0, di.tokenizeChord = void 0;
	function e(t) {
...
function HB() {
	if (El) return li;
	El = 1, li.__esModule = !0, li.voicingsInRange = void 0;
	var e = ZC, t = LC(), n = EC();
	function s(i, r, a) {
		...
		return l.reduce(function(m, g) {
			...
			}), x = e.Note.transpose(o, g[0]), E = p.filter(function(w) {
...
function LC() {
	return Ll || (Ll = 1, function(e) {
		var t = oi.__assign || function() {
			...
			if (u != null && typeof Object.getOwnPropertySymbols == "function") for (var p = 0, l = Object.getOwnPropertySymbols(u); p < l.length; p++) o.indexOf(l[p]) < 0 && Object.prototype.propertyIsEnumerable.call(u, l[p]) && (c[l[p]] = u[l[p]]);
			return c;
		};
		...
		var a = function(u) {
			...
			return (0, s.getBestVoicing)(t(t({}, l), {
				range: c,
				finder: (0, e.dictionaryVoicingFinder)(o)
			}));
		};
...
function KB() {
	if (Rl) return hi;
	Rl = 1, hi.__esModule = !0, hi.minTopNoteDiff = void 0;
	var e = ZC;
	function t(n, s) {
		if (!s) return n[0];
		var i = function(r) {
...
function jB() {
	return Bl || (Bl = 1, function(e) {
		...
		var t = LC(), n = KB(), s = wC();
		e.default = {
			tokenizeChord: EC().tokenizeChord,
...
}, { dictionaryVoicing: OB, minTopNoteDiff: JB } = Vl.default || Vl, qs = {
	lefthand: {
		dictionary: {
			m7: ["3m 5P 7m 9M", "7m 9M 10m 12P"],
			7: ["3M 6M 7m 9M", "7m 9M 10M 13M"],
...
var RC = "ireal";
var BC = (e) => RC = e, tV = (e, t) => VC(e, qs[e].dictionary, t), VC = (e, t, n = ["F3", "A4"]) => {
	Object.assign(qs, { [e]: {
		dictionary: t,
		range: n
	} });
...
Object.keys(rs).forEach((e) => {
	if (e.includes("-")) gi(e, e.replace("-", "m"), [Zs, rs]);
	if (e.includes("^")) gi(e, e.replace("^", "M"), [Zs, rs]);
	if (e.includes("+")) gi(e, e.replace("+", "aug"), [Zs, rs]);
});
Qo("ireal", rs);
Qo("ireal-ext", Zs);
function aV() {
...
var uV = "@strudel/tonal", oV = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	addVoicings: VC,
	complex: Zs,
	packageName: uV,
...
async function cV() {
	const e = rr(rr, Promise.resolve().then(() => M2), Promise.resolve().then(() => Lw), Promise.resolve().then(() => oV), Promise.resolve().then(() => Fw), {
		hush: dV,
		evaluate: hV
	});
	await Promise.all([e, mM()]);
}
var mu, ls;
function lV(e = {}) {
	lM(), e.miniAllStrings !== !1 && LM();
	const { prebake: t, ...n } = e;
	return ls = PM({
		...n,
		transpiler: $Z
	}), mu = (async () => (await cV(), await t?.(), ls))(), ar(() => ls.scheduler.now()), mu;
}
window.initStrudel = lV;
_.prototype.play = function() {
	if (!ls) throw new Error(".play: no repl found. Have you called initStrudel?");
	return mu.then(() => {
		ls.setPattern(this, !0);
	}), this;
};
function dV() {
	ls.stop();
}
async function hV(e, t = !0) {
	return ls.evaluate(e, t);
}
//#endregion
export { Jl as ClockCollator, Db as Cyclist, ao as DEFAULT_MAX_POLYPHONY, vb as FXr, Gb as FXrel, xb as FXrelease, U as Fraction, et as Hap, _ as Pattern, Dw as StartRules, Es as State, hs as SyntaxError, ct as TimeSpan, Qa as Warpmode, Uu as __chooseWith, Ku as _brandBy, l0 as _fitslice, ju as _irand, Ou as _keyDown, d0 as _match, Ut as _mod, wu as _morph, p0 as _polymeterListSteps, za as _retime, Na as _slices, bd as accelerate, T1 as activeLabel, jg as ad, Mx as add, VC as addVoicings, Kg as adsr, NS as aliasBank, SD as almostAlways, DD as almostNever, ZD as always, vd as amp, vt as analysers, us as analysersData, kp as analyze, fy as anchor, zx as and, mG as apply, Fi as applyFM, pn as applyGainCurve, c0 as applyN, Oa as applyParameterModulators, Og as ar, q9 as arp, Q9 as arpWith, ix as arrange, fb as as, jv as asym, Ad as att, Pd as attack, Nl as averageArray, ND as backgroundImage, Ax as band, Kp as bandf, Op as bandq, Bp as bank, Ul as base64ToUnicode, Mm as bbexpr, xm as bbst, Tv as beat, Qp as begin, yD as berlin, ty as bgain, QX as binary, qX as binaryL, c2 as binaryN, l2 as binaryNL, lx as bind, bg as binshift, CG as bite, oP as bjork, Bu as bjorklund, Dx as blshift, Mb as bmod, Fx as bor, Up as bp, ef as bpa, $m as bpattack, uf as bpd, Vf as bpdc, af as bpdecay, Ef as bpdepth, Rf as bpdepthfreq, Lf as bpdepthfrequency, Um as bpe, jm as bpenv, jp as bpf, Jp as bpq, Mf as bpr, wf as bprate, bf as bprelease, pf as bps, Bf as bpshape, kf as bpskew, hf as bpsustain, Zf as bpsync, wG as brak, rD as brand, iD as brandBy, Sx as brshift, $1 as bus, ey as busgain, Xx as bxor, uv as bypass, bm as byteBeatExpression, Cm as byteBeatStartTime, U9 as calculateSteps, Mi as cat, tb as ccn, nb as ccv, _x as ceil, vm as ch, km as channel, Gm as channels, Jv as chebyshev, m2 as choose, f2 as chooseCycles, uD as chooseIn, Ar as chooseInWith, oD as chooseOut, Pr as chooseWith, Zv as chop, hy as chord, Vp as chorus, JG as chunk, $G as chunkBack, av as chunkBackInto, iv as chunkInto, ev as chunkback, rv as chunkbackinto, sv as chunkinto, br as clamp, k2 as cleanupOnEnd, WD as cleanupUi, wg as clip, rm as coarse, W9 as code2hash, Yg as color, Hg as colour, fg as comb, Zs as complex, D9 as compose, Jx as compress, Qx as compressSpan, Ny as compressor, Iy as compressorAttack, Wy as compressorKnee, Ty as compressorRatio, _y as compressorRelease, qx as compressspan, W2 as connectBusModulator, N2 as connectEnvelope, z2 as connectLFO, dM as connectToDestination, S9 as constant, M0 as contract, eb as control, iP as controls, wX as cosine, ZX as cosine2, fG as cpm, Sg as cps, Xb as createClock, Z2 as createFilter, xr as createParam, Lu as createParams, im as crush, Wm as ctf, sb as ctlNum, H1 as ctranspose, Hv as cubic, Xe as curry, Bg as curve, zm as cut, Nm as cutoff, Ba as cycleToSeconds, RD as cyclesPer, Wp as dec, Np as decay, cV as defaultPrebake, MD as degrade, bD as degradeBy, gD as degradeByWith, _1 as degree, a1 as delay, o1 as delayfb, u1 as delayfeedback, l1 as delayspeed, m1 as delaysync, h1 as delayt, d1 as delaytime, Vg as deltaSlide, g1 as det, y1 as detune, c1 as dfb, my as dict, py as dictionary, Kv as diode, Vy as dist, By as distort, eo as distortionAlgorithms, zy as distorttype, ky as distortvol, Gx as div, r1 as djf, nw as dough, CM as doughTrigger, xM as doughsamples, DM as drawFrequencyScope, $l as drawLine, XM as drawTimeScope, pm as drive, y0 as drop, C1 as dry, E2 as drywet, Ug as ds, bM as dspWorklet, p1 as dt, mm as duck, gm as duckattack, fm as duckdepth, ym as duckonset, Lg as dur, Eg as duration, yG as early, IG as echo, zG as echoWith, NG as echowith, Ai as effectSend, mP as eish, qp as end, mg as enhance, bb as env, Rx as eq, Bx as eqt, uP as euclid, dP as euclidLegato, hP as euclidLegatoRot, lP as euclidRot, pP as euclidish, cP as euclidrot, rr as evalScope, hV as evaluate, pG as every, b0 as expand, Oy as expression, g0 as extend, v1 as fadeInTime, G1 as fadeOutTime, x1 as fadeTime, xf as fanchor, rG as fast, nv as fastChunk, $x as fastGap, Ft as fastcat, tv as fastchunk, eG as fastgap, zp as fft, hv as filter, pv as filterWhen, hG as firstOf, Vv as fit, En as flatten, Ix as floor, Yd as fm, Hd as fm1, Kd as fm2, jd as fm3, Ud as fm4, Od as fm5, Jd as fm6, Qd as fm7, qd as fm8, gh as fmatt, bh as fmatt1, Mh as fmatt2, Ch as fmatt3, xh as fmatt4, Gh as fmatt5, vh as fmatt6, Ph as fmatt7, Ah as fmatt8, oh as fmattack, ch as fmattack1, lh as fmattack2, dh as fmattack3, hh as fmattack4, ph as fmattack5, mh as fmattack6, fh as fmattack7, yh as fmattack8, Yh as fmdec, Hh as fmdec1, Kh as fmdec2, jh as fmdec3, Uh as fmdec4, Oh as fmdec5, Jh as fmdec6, Qh as fmdec7, qh as fmdec8, Bh as fmdecay, Vh as fmdecay1, kh as fmdecay2, zh as fmdecay3, Nh as fmdecay4, Wh as fmdecay5, Th as fmdecay6, Ih as fmdecay7, _h as fmdecay8, $d as fmenv, eh as fmenv1, th as fmenv2, nh as fmenv3, sh as fmenv4, ih as fmenv5, rh as fmenv6, ah as fmenv7, uh as fmenv8, Fd as fmh, Xd as fmh1, Dd as fmh2, Sd as fmh3, wd as fmh4, Zd as fmh5, Ed as fmh6, Ld as fmh7, Rd as fmh8, Bd as fmi, Vd as fmi1, kd as fmi2, zd as fmi3, Nd as fmi4, Wd as fmi5, Td as fmi6, Id as fmi7, _d as fmi8, Fp as fmrel, Xp as fmrel1, Dp as fmrel2, Sp as fmrel3, wp as fmrel4, Zp as fmrel5, Ep as fmrel6, Lp as fmrel7, Rp as fmrel8, gp as fmrelease, bp as fmrelease1, Mp as fmrelease2, Cp as fmrelease3, xp as fmrelease4, Gp as fmrelease5, vp as fmrelease6, Pp as fmrelease7, Ap as fmrelease8, op as fmsus, cp as fmsus1, lp as fmsus2, dp as fmsus3, hp as fmsus4, pp as fmsus5, mp as fmsus6, fp as fmsus7, yp as fmsus8, $h as fmsustain, ep as fmsustain1, tp as fmsustain2, np as fmsustain3, sp as fmsustain4, ip as fmsustain5, rp as fmsustain6, ap as fmsustain7, up as fmsustain8, Fh as fmwave, Xh as fmwave1, Dh as fmwave2, Sh as fmwave3, wh as fmwave4, Zh as fmwave5, Eh as fmwave6, Lh as fmwave7, Rh as fmwave8, tG as focus, nG as focusSpan, sG as focusspan, Uv as fold, w9 as fractionalArgs, xg as frameRate, Gg as frames, cg as freeze, P1 as freq, bu as freqToMidi, Hx as fromBipolar, Qy as fshift, qy as fshiftnote, $y as fshiftphase, Cf as ftype, Wx as func, Pb as fxr, xd as gain, je as gainNode, Ws as gap, k1 as gat, V1 as gate, Nt as getADSRValues, gu as getAccidentalsOffset, hM as getAnalyserById, Dr as getAnalyzerData, ve as getAudioContext, TD as getAudioContextCurrentTime, rM as getAudioDevices, GS as getCachedBuffer, w2 as getCompressor, xi as getControlName, ZP as getCps, ql as getCurrentKeyboardState, ut as getDefaultValue, V2 as getDistortion, lS as getDistortionAlgorithm, S2 as getEnvelope, v9 as getEventOffsetMs, zl as getFreq, Tl as getFrequency, Kn as getFrequencyFromValue, RP as getIsStarted, po as getLeafLocation, mo as getLeafLocations, EM as getLeaves, Is as getLfo, PS as getLoadedBuffer, yM as getOscillator, zt as getParamADSR, $u as getParamLfo, EP as getPattern, I9 as getPerformanceTimeSeconds, Bs as getPitchEnvelope, X9 as getPlayableNoteValue, Un as getRandsAtTime, I2 as getSampleBuffer, _2 as getSampleBufferSource, T2 as getSampleInfo, is as getSound, F9 as getSoundIndex, Xr as getSuperdoughAudioController, Ia as getTime, s2 as getTrigger, LP as getTriggerFunc, Vs as getVibratoOscillator, p7 as getWidgetID, Dt as getWorklet, gM as getZZFX, yv as grow, Zx as gt, Lx as gte, Zw as h, Yv as hard, K1 as harmonic, T9 as hash2code, Mg as hbrick, qf as hcutoff, Hp as hold, vg as hours, e1 as hp, qm as hpa, Qm as hpattack, rf as hpd, Yf as hpdc, sf as hpdecay, Wf as hpdepth, If as hpdepthfreq, Tf as hpdepthfrequency, Km as hpe, Hm as hpenv, $f as hpf, n1 as hpq, gf as hpr, zf as hprate, yf as hprelease, df as hps, _f as hpshape, Hf as hpskew, lf as hpsustain, Nf as hpsync, t1 as hresonance, dv as hsl, lv as hsla, aG as hurry, dV as hush, Ds as id, pg as imag, AP as inhabit, XP as inhabitmod, ho as initAudio, lM as initAudioOnFirstClick, lV as initStrudel, dx as innerBind, cG as inside, XG as inv, FG as invert, Fy as ir, aD as irand, Sy as irbegin, Xy as iresponse, Dy as irspeed, X0 as isControlName, fs as isNote, M9 as isNoteWithOctave, Pu as isPattern, vr as isaw, Iu as isaw2, KG as iter, jG as iterBack, UG as iterback, BX as itri, VX as itri2, kG as jux, BG as juxBy, VG as juxby, ng as kcutoff, gx as keep, bx as keepif, Ql as keyAlias, LD as keyDown, tg as krush, I1 as label, dG as lastOf, u0 as late, Cg as lbrick, Zg as legato, z1 as leslie, gb as lfo, xG as linger, wi as listRange, cr as loadBuffer, cM as loadWorklets, f1 as lock, fu as logKey, $p as loop, Rv as loopAt, kv as loopAtCps, em as loopBegin, nm as loopEnd, Bv as loopat, zv as loopatcps, tm as loopb, sm as loope, Im as lp, Jm as lpa, Om as lpattack, nf as lpd, Df as lpdc, tf as lpdecay, Pf as lpdepth, Ff as lpdepthfreq, Af as lpdepthfrequency, Ym as lpe, _m as lpenv, Tm as lpf, i1 as lpq, ff as lpr, Gf as lprate, mf as lprelease, cf as lps, Xf as lpshape, Sf as lpskew, of as lpsustain, vf as lpsync, N1 as lrate, W1 as lsize, wx as lt, Ex as lte, ww as m, Cu as mapArgs, ax as mask, uo as maxPolyphony, A9 as midi2note, ds as midiToFreq, lb as midibend, Jg as midichan, $g as midicmd, Qg as midimap, qg as midiport, db as miditouch, fo as mini, Ri as mini2ast, LM as miniAllStrings, Ew as minify, Pg as minutes, vx as mod, by as mode, Iv as morph, TX as mouseX, NX as mouseY, WX as mousex, zX as mousey, Y1 as mtranspose, xx as mul, oo as multiChannelOrbits, yd as n, Wl as nanFallback, Vx as ne, kx as net, wD as never, Of as noise, qu as noises, gd as note, yn as noteToMidi, Wt as nothing, ib as nrpnn, rb as nrpv, O1 as nudge, kt as numeralArgs, Ol as objectMap, Q1 as oct, J1 as octave, U1 as octaveR, gy as octaves, sg as octer, ig as octersub, rg as octersubsub, SG as off, yy as offset, FD as often, J2 as onTriggerSample, tM as onTriggerSynth, bn as onceEnded, Nx as or, q1 as orbit, pb as oschost, mb as oscport, hx as outerBind, lG as outside, ny as overgain, sy as overshape, h0 as pace, uV as packageName, Hl as pairs, RG as palindrome, iy as pan, B1 as panchor, oy as panorient, ry as panspan, ay as pansplay, uy as panwidth, Zu as parray, wM as parse, Yl as parseFractional, Mu as parseNumeral, Qv as partials, F1 as patt, A1 as pattack, _s as patternifyAST, R1 as pcurve, D1 as pdec, X1 as pdecay, L1 as penv, b2 as per, BD as perCycle, fD as perlin, VD as perx, Dm as ph, Vm as phasdp, Sm as phaser, Em as phasercenter, Rm as phaserdepth, Xm as phaserrate, wm as phasersweep, qv as phases, Lm as phc, Bm as phd, Zm as phs, Zb as pick, gP as pickF, MP as pickOut, vP as pickReset, xP as pickRestart, FP as pickSqueeze, Eb as pickmod, bP as pickmodF, CP as pickmodOut, PP as pickmodReset, GP as pickmodRestart, DP as pickmodSqueeze, _l as pipe, kg as pitchJump, zg as pitchJumpTime, iG as ply, HG as plyForEach, YG as plyWith, nx as pm, fx as polyBind, hb as polyTouch, Mr as polymeter, ex as polyrhythm, Gd as postgain, Px as pow, tx as pr, E1 as prel, Z1 as prelease, LG as press, EG as pressBy, j2 as processSampleMap, ab as progNum, w1 as psus, S1 as psustain, Ue as pure, Pm as pw, Am as pwrate, Fm as pwsweep, St as rand, sD as rand2, $X as randL, cD as randcat, d2 as randrun, Kx as range, Ux as range2, jx as rangex, XD as rarely, Ox as ratio, vy as rdim, hg as real, Nv as ref, B as register, A as registerControl, vV as registerLanguage, Gn as registerMultiControl, Q2 as registerSampleSource, AS as registerSamplesPrefix, sn as registerSound, mM as registerSynthSounds, Qo as registerVoicings, ro as registerWaveTable, GV as registerWidgetType, oM as registerWorklet, tw as registerZZFXSounds, j as reify, Yp as rel, _p as release, Re as releaseAudioNode, ys as removeUndefineds, dw as renderPatternAudio, OG as repeatCycles, DX as repl, fv as replicate, aM as resetDefaultValues, _S as resetDefaults, pM as resetGlobalEffects, KS as resetLoadedSounds, $2 as resetSeenKeys, aV as resetVoicings, Sb as reset_state, wb as reset_timelines, s1 as resonance, o0 as rev, Y2 as reverseBuffer, ZG as revv, Ay as rfade, cv as rib, ov as ribbon, ag as ring, og as ringdf, ug as ringf, xy as rlp, My as room, Gy as roomdim, Py as roomfade, Cy as roomlp, wy as roomsize, iV as rootNotes, Il as rotate, Tx as round, Ly as rsize, o2 as run, D0 as s, vv as s_add, Mv as s_alt, bv as s_cat, Xv as s_contract, Av as s_expand, Fv as s_extend, Cv as s_polymeter, Pv as s_sub, xv as s_taper, Gv as s_taperlist, Dv as s_tour, Sv as s_zip, O2 as samples, Zi as saw, Tu as saw2, YB as scale, WB as scaleTrans, NB as scaleTranspose, eS as scheduleAtTime, gg as scram, tD as scramble, yb as scrub, Ag as seconds, nD as seed, vG as seg, GG as segment, ly as semitone, a0 as seq, rx as seqPLoop, on as sequence, n0 as sequenceP, yx as set, or as setAudioContext, kb as setCpsFunc, IS as setDefault, C2 as setDefaultAudioContext, lo as setDefaultValue, YS as setDefaultValues, BC as setDefaultVoicings, kS as setGainCurve, Wb as setIsStarted, G2 as setLogger, nM as setMaxPolyphony, sM as setMultiChannelOrbits, zb as setPattern, t0 as setStringParser, tu as setSuperdoughAudioController, ar as setTime, Nb as setTriggerFunc, HS as setVersionDefaults, tV as setVoicingRange, Ry as shape, x0 as shrink, C0 as shrinklist, eD as shuffle, wt as signal, Ye as silence, rs as simple, i2 as sine, _u as sine2, Ov as sinefold, Zy as size, A0 as slice, cy as slide, uG as slow, qG as slowChunk, Qn as slowcat, Fu as slowcatPrime, QG as slowchunk, yg as smear, _v as soft, k9 as sol2note, AD as someCycles, PD as someCyclesBy, vD as sometimes, GD as sometimesBy, Fg as songPtr, S0 as sound, WS as soundAlias, an as soundMap, md as source, oG as sparsity, zD as speak, Eu as speed, Lv as splice, xu as splitAt, M1 as spread, r2 as square, EX as square2, SP as squeeze, px as squeezeBind, Ky as squiz, fd as src, tt as stack, sx as stackBy, r0 as stackCentre, s0 as stackLeft, i0 as stackRight, SX as steady, mx as stepBind, m0 as stepalt, Rt as stepcat, wv as steps, j1 as stepsPerOctave, TB as strans, Yy as stretch, Ev as striate, Gu as stringifyValues, ux as struct, vu as strudelScope, _G as stut, WG as stutWith, TG as stutwith, Cx as sub, Sr as superdough, JS as superdoughTrigger, ox as superimpose, Ip as sus, Tp as sustain, Jy as sustainpedal, AG as swing, PG as swingBy, ub as sysex, cb as sysexdata, ob as sysexid, Ey as sz, VS as tables, f0 as take, kX as time, Su as timeCat, gv as timecat, fP as timeline, Yx as toBipolar, kl as tokenizeNote, G0 as tour, zB as trans, Cb as transient, $Z as transpiler, kB as transpose, um as trem, am as tremolo, cm as tremolodepth, dm as tremolophase, hm as tremoloshape, lm as tremoloskew, om as tremolosync, LX as tri, RX as tri2, eg as triode, dg as tsdelay, Xg as uid, xD as undegrade, CD as undegradeBy, jl as unicodeToBase64, z9 as uniq, N9 as uniqsort, Kl as uniqsortr, b1 as unison, Hy as unit, JX as useRNG, Uf as v, Dg as val, G9 as valueToMidi, Cd as vel, Md as velocity, Kf as vib, Jf as vibmod, jf as vibrato, Qf as vmod, dy as voice, rV as voicing, gi as voicingAlias, qs as voicingRegistry, sV as voicings, jy as vowel, j0 as warp, J0 as warpatt, O0 as warpattack, ad as warpdc, q0 as warpdec, Q0 as warpdecay, id as warpdepth, hd as warpenv, od as warpmode, sd as warprate, nd as warprel, td as warprelease, rd as warpshape, ud as warpskew, ed as warpsus, $0 as warpsustain, pd as warpsync, fM as waveformN, Uy as waveloss, dd as wavetablePhaseRand, Z0 as wavetablePosition, U0 as wavetableWarp, cd as wavetableWarpMode, dD as wchoose, g2 as wchooseCycles, mn as webAudioTimeout, vM as webaudioOutput, PM as webaudioRepl, DG as when, ED as whenKey, p2 as withSeed, cx as withValue, mv as within, eP as worklet, hD as wrandcat, w0 as wt, R0 as wtatt, L0 as wtattack, H0 as wtdc, V0 as wtdec, B0 as wtdecay, _0 as wtdepth, E0 as wtenv, ld as wtphaserand, T0 as wtrate, W0 as wtrel, N0 as wtrelease, Y0 as wtshape, K0 as wtskew, z0 as wtsus, k0 as wtsustain, I0 as wtsync, F0 as xfade, lg as xsdelay, Tg as zcrush, Ig as zdelay, v0 as zip, gr as zipWith, Wg as zmod, Ng as znoise, gG as zoom, bG as zoomArc, MG as zoomarc, Rg as zrand, _g as zzfx };
